...
namespace Tools1
{
    ...
    public class EndyVCode : WebControl
    {
        ...
        protected override void Render(HtmlTextWriter output)
        {
            ...
            {
                str = HttpContext.Current.Request.Url + "&";
            }
            output.Write("<span id=\"spcode\" style=\"border:1px solid #CCCCCC;font-size:12px;padding:1px;\">生成中..</span><img id=\"img1\" onload=\"document.getElementById('spcode').style.display='none';\" src=\"" + str + "vcadd=" + SecurityEncryption.ConvertDateTimeInt(DateTime.Now) + "\" onclick=\"this.src='" + str + "vcadd='+new Date();\" style=\"cursor:pointer;\" alt=\"点击切换\" border=\"0\" align=\"absmiddle\" width=\"" + this.Width + "\" height=\"" + this.Height + "\"/>");
        }
        ...
        public bool IsPass(string code)
        {
            if (HttpContext.Current.Session["VNum"] == null
                || EConvert.ToString(HttpContext.Current.Session["VNum"])
