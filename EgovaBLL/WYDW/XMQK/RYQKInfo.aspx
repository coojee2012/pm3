...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function ShowAppPage(sUrl, fType, width, height) {
                ...
                <table class="m_table" width="98%" align="center">
                    ...
                    <tr>
                        ...
                        <td colspan="1">
                            ...
                            <input id="BYZSUpload" type="button" value="上传文件(0)" class="m_btn_w6" onclick="ShowAppPage('../Common/upload/FileManage.aspx?Ftype=3002&ReadOnly=0&IsSingle=0', '3002', '800', '600')" runat="server" />
                    ...
                    <tr>
                        ...
                        <td colspan="1">
                            <input id="XWZSUpload" type="button" value="上传文件(0)" class="m_btn_w6" onclick="ShowAppPage('../Common/upload/FileManage.aspx?Ftype=3003&ReadOnly=0&IsSingle=0', '3003', '800', '600')" runat="server" />
                    ...
                    <tr>
                        ...
                        <td colspan="1">
                            <input id="ZCZSUpload" type="button" value="上传文件(0)" class="m_btn_w6" onclick="ShowAppPage('../Common/upload/FileManage.aspx?Ftype=3004&ReadOnly=0&IsSingle=0', '3004', '800', '600')" runat="server" />
