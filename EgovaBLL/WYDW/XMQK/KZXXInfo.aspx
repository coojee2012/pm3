                ...
                <table class="m_table" width="98%" align="center">
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="t_HSTypeID" runat="server" CssClass="m_txt" Width="120px">
                                ...
                                <asp:ListItem Value="01">非保障住房</asp:ListItem>
                                <asp:ListItem Value="02">廉租房</asp:ListItem>
                                <asp:ListItem Value="03">限价房</asp:ListItem>
                                <asp:ListItem Value="04">公共租赁房</asp:ListItem>
                                <asp:ListItem Value="05">经济适用房</asp:ListItem>
                            </asp:DropDownList>
                        </td>
                        <td></td>
                        <td></td>
                    ...
                    <tr>
                        ...
                        <td colspan="1" width="25%">
                            <asp:TextBox ID="t_ZDMJ" ReadOnly="True" runat="server" CssClass="m_txt" Width="80px"></asp:TextBox>
                            <tt>*</tt>
                        </td>
                        ...
                        <td colspan="1">
                            <asp:TextBox ID="t_KFDW" ReadOnly="True" runat="server" CssClass="m_txt" Width="80px"></asp:TextBox>
                        </td>
                        <td colspan="1"></td>
                    </tr>
                    <tr>
