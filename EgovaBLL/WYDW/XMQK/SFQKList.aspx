<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SFQKList.aspx.cs" Inherits="WYDW_XMQK_SFQKList" %>
            ...
            <div id="divSetup2" runat="server">
                <asp:DataGrid ID="dg_List" runat="server" AutoGenerateColumns="False" CssClass="m_dg1"
                    ...
                    <Columns>
                        ...
                        <asp:BoundColumn DataField="DC_MJ" HeaderText="多层住宅面积">
                            <ItemStyle CssClass="t_l" />
                        </asp:BoundColumn>
                        <asp:BoundColumn DataField="GC_MJ" HeaderText="高层住宅面积">
                            <ItemStyle CssClass="t_l" HorizontalAlign="Center" />
                        </asp:BoundColumn>
                        <asp:BoundColumn DataField="SY_MJ" HeaderText="商业面积">
                            <ItemStyle CssClass="t_l" HorizontalAlign="Center" />
                        </asp:BoundColumn>
