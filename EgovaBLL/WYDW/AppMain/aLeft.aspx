<%@ Page Language="C#" AutoEventWireup="true" CodeFile="aLeft.aspx.cs" Inherits="WYDW_Project_Main_aLeft" %>
            ...
            <tr>
                <td class="l_main" valign="top" align="left">
                    <div class="l_main_bg" style="height: 100%; overflow: auto; width: 180px; text-align: center;"
                        ...
                        <asp:Panel runat="server" ID="pnlJBXX">
                            <div id="dv1" runat="server" class="o_menu" style="">
                                <a id="a1" class="o_m01_1" href='../ApplyJBXX/JBXXInfo.aspx' target="appMain"><span>项目基本信息</span></a>
                            </div>
                        </asp:Panel>
                        <asp:Panel runat="server" ID="pnlKZXX">
                            <div class="o_menu">
                                <a id="a2" class="o_m01_1" href='../ApplyKZXX/KZXXInfo.aspx' target="appMain"><span>项目扩展信息</span></a>
                            </div>
                        </asp:Panel>
                        <asp:Panel runat="server" ID="pnlHTBZ">
                            <div class="o_menu">
                                <a id="a4" class="o_m01_1" href='../ApplyHTBA/HTBAInfo.aspx' style="cursor: pointer" target="appMain"><span>项目合同备案</span></a>
                            </div>
                        </asp:Panel>
                        <asp:Panel runat="server" ID="pnlYWH">
                            <div class="o_menu">
                                <a id="a6" class="o_m01_1" href='../ApplyYWH/YWHInfo.aspx' style="cursor: pointer" target="appMain"><span>项目业委会备案</span></a>
                            </div>
                        </asp:Panel>
                        <asp:Panel runat="server" ID="pnlRYQK">
                            <div class="o_menu">
                                <a id="a11" class="o_m01_1" href='../ApplyRYQK/RYQKList.aspx' style="cursor: pointer" target="appMain"><span>项目人员情况</span></a>
                            </div>
                        </asp:Panel>
                        <asp:Panel runat="server" ID="pnlSFQK">
                            <div class="o_menu">
                                <a id="a8" class="o_m01_1" href='../ApplySFQK/SFQKInfo.aspx' style="cursor: pointer" target="appMain"><span>人员配置及收费</span></a>
                            </div>
                        </asp:Panel>
                        <asp:Panel runat="server" ID="pnlCWQK">
                            <div class="o_menu">
                                <a id="a3" class="o_m01_1" href='../ApplyCWQK/CWQKInfo.aspx' target="appMain"><span>项目财务年报</span></a>
                            </div>
                        </asp:Panel>
                        <asp:Panel runat="server" ID="pnlLPB">
                            <div class="o_menu">
                                <a id="a12" class="o_m01_1" href='../ApplyLPB/LPBList.aspx' style="cursor: pointer" target="appMain"><span>项目楼盘表</span></a>
                            </div>
                        </asp:Panel>
                        <asp:Panel runat="server" ID="pnlXMSQ">
                            <div class="o_menu">
                                <a id="a5" class="o_m01_1" href='../ApplyXMSQ/XMSQInfo.aspx' style="cursor: pointer" target="appMain"><span>项目失去申请</span></a>
                            </div>
                        </asp:Panel>
                        <%--  <div class="o_menu">
