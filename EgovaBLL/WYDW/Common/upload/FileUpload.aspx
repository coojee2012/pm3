        ...
        <table class="tdCenter" align="center" width="98%">
            ...
            <tr>
                <td valign="middle" class=" td5" style="height: 30px">
                    ...
                    <div style="margin-top: 5px;">附件名称：<input id="txtTitle" name="txtTitle" type="text" style="width: 280px;" runat="server" /></div>
                </td>
            </tr>
            <tr>
                <td>
                    <asp:Button ID="btnUp" runat="server" Text="上传" OnClick="btnUp_Click" CssClass="cBtn7" Height="19px" />
                    <input id="Button1" class="cBtn7" type="button" value="返回" onclick="Exit(); window.close();" />
                </td>
            </tr>
        </table>
    </form>
