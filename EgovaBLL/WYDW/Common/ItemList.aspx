<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ItemList.aspx.cs" Inherits="WYDW_Common_ItemList" %>
...
<ItemStyle HorizontalAlign="Left" Width="260px"></ItemStyle>
            </asp:BoundColumn>
            <asp:BoundColumn DataField="XMDZ" HeaderText="项目地址"><ItemStyle HorizontalAlign="Left" Width="350px"></ItemStyle></asp:BoundColumn>
