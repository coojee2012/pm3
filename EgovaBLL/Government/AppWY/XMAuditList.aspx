...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function app() {
            ...
            obj.name = '';
            obj.id = tmpVal;
            ShowWindow('SHAuditInfo.aspx?fManagetypeid=' + fManagetypeid + '&ftype=5&FLinkId=' + tmpVal + '&fSubFlowId=' + fsubid + '&fBaseInfoId=' + fbaseInfoid
                + '&fpid=' + fpid
...
<body>
    <form id="form1" runat="server">
        <table width="98%" align="center" class="m_title">
            <tr>
                <th colspan="7">
                    <asp:Literal ID="lPostion" runat="server">项目失去申请</asp:Literal>
                </th>
            </tr>
            <tr>
                <td class="t_r">项目名称：
