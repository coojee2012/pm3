...
<body>
    ...
    <div>
        ...
        <tr>
            <td class="t_l t_bg" colspan="1">
                &nbsp;&nbsp;当前部门：&nbsp;&nbsp;<asp:Label ID="t_DeptName" runat="server" Text="Label"></asp:Label>
            </td>
        ...
        <asp:Repeater runat="server" ID="DG_List" OnItemDataBound="DG_List_ItemDataBound"
            ...
            <HeaderTemplate>
                <table class="m_dg1" width="98%" align="Center" border="1px">
                    <tr class="m_dg1_h">
                        ...
                        <td colspan="8" class="t_c" style="text-align:center">
                            项目个数
                        </td>
                        <td rowspan="3" colspan="1" class="t_c">
                            建筑面积
                        </td>
                        <td rowspan="3" colspan="1" class="t_c">
                            占地面积
            ...
            <ItemTemplate>
                <tr class="m_dg1_i">
                    ...
                    <td class="t_c">
                        <asp:LinkButton ID="ltName" runat="server" Text='<%#Eval("DeptName")  %>' CommandArgument='<%#Eval("DeptName") %>'
