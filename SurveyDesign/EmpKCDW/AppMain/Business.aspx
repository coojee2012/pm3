<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Business.aspx.cs" Inherits="EmpJZDW_AppMain_Business" %>
                        ...
                        <Columns>
                            ...
                            <asp:TemplateColumn HeaderText="工程名称">
                                ...
                                <ItemTemplate>
                                    ...
                                    <a href='javascript:showAddWindow("ApplyBaseInfo.aspx?FDataID=<%#Eval("FLinkId") %>",800,700);'>
                                        <%#Eval("FPrjName")%>
                                    </a>
                            ...
                            <asp:ButtonColumn CommandName="Delete" HeaderText="操作"></asp:ButtonColumn>
