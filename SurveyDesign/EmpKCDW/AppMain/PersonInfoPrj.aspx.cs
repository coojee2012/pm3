...
public partial class KC_appmain_PersonInfoPrj : System.Web.UI.Page
{
    ...
    int fMType = 283;//勘察项目备案 
    int fMType_0 = 28301;//人员意见
    int fMType_3 = 284;//成果移交
    ...
    void showInfo()
    {
        ...
        var App = from l1 in db.CF_App_List
                  ...
                  && (iResult > 0 ? db.CF_App_Idea.Count(i => i.FResultInt == iResult && i.FUserId == empId && i.FLinkId == l2.FId) > 0 : true)
                  && l3.FTime.Value.Year == FYear
                  && (FMonth > 0 ? l3.FTime.Value.Month == FMonth : true)
    ...
    protected void App_List_ItemDataBound(object sender, DataGridItemEventArgs e)
    {
        if (e.Item.ItemIndex > -1)
        {
            ...
            e.Item.Cells[e.Item.Cells.Count - 2].Text = "<a href='javascript:showAddWindow(\"../ApplyRYYJ/" + sUrl + "\",700,650);'>查看意见</a>";
        }
    }
    //分页面控件翻页事件
