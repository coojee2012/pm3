<%@ Page Language="C#" AutoEventWireup="true" CodeFile="aTop.aspx.cs" Inherits="EvaluateEntApp_main_top" %>

<%@ Register Src="../../Common/ValidateEmpUserId.ascx" TagName="ValidateUserId" TagPrefix="uc1" %>
...
<body>
    ...
    <div class="top_back02">
        <div id="div_BG" runat="server" class="top_backimg_emp">
            <div class="top_r">
                <div class="top_menu" id="adminTd1" runat="server">
                    <div>
                        <a class="top_btn" href="#" id="lit_back" runat="server" target="_parent">
