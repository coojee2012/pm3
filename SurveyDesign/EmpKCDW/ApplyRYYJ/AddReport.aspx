...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function checkInfo() {
            ...
            if (!getLength(document.getElementById("t_FContent"), 50, '“人员意见”')) {
                return false;
            }
            return true;
        }
        ...
        <tr>
            ...
            <td>
                <asp:DropDownList ID="t_FResultInt" runat="server">
                    ...
                    <asp:ListItem Value="2" Text="未完成"></asp:ListItem>
                </asp:DropDownList>
                <tt>*</tt>
            </td>--%>
            <td class="t_r t_bg">
            ...
            <td colspan="3">
                <asp:TextBox ID="t_FAppTime" runat="server" CssClass="m_txt" onfocus="WdatePicker();"  TabIndex="2"></asp:TextBox><tt>*</tt>
            </td>
        </tr>
        <tr>
            <td class="t_r t_bg">
            ...
            <td class="m_txt_M" colspan="3">
                <asp:TextBox ID="t_FContent" runat="server" CssClass="m_txt" Width="320px" MaxLength="50"
                    TextMode="MultiLine" Height="60" TabIndex="1"></asp:TextBox>
                <tt>* 50字。</tt>
            </td>
        </tr>
        <tr>
