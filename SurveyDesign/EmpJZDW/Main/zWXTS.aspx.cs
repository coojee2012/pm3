...
public partial class KC_Main_zWXTS : System.Web.UI.Page
{
    ...
    public int fMType_o = 28002;//见证人员安排
    public int fMType = 28004;//勘察项目见证人员意见
    ...
    private void showAppList()
    {
        ...
        var v = from t in db.CF_App_List
                ...
                {
                    t.FId,
                    FOldAppId = ot.FId,//见证人员安排的FAppId
                    t.FName,
                    t.FManageTypeId,
                    t.FReportDate,
                    t.FUpDeptId,
                    ...
                    d.FPriItemId,
                    t.FCreateTime,
                    app = db.CF_App_List.Where(a => a.FLinkId == t.FLinkId && a.FManageTypeId == 280).FirstOrDefault(),//勘察单位
                    t.FState,
    ...
    protected void App_List_ItemDataBound(object sender, DataGridItemEventArgs e)
    {
        if (e.Item.ItemIndex > -1)
        {
            ...
            { //变更后有职务
                ...
                string o = "showAddWindow(\"../ApplyXMJZ/" + sUrl + "\",700,500);";
                ((LinkButton)e.Item.FindControl("btnItemSee")).Attributes["onclick"] = o + "return false;";
            }
            else
            {//变更后没有职务了 
                fStateDsec = "<font color='#888888'>人员安排变更后无职责，<br/>无需办理</font>";
                e.Item.Cells[4].Text = "--";
            ...
            {
                if (app.FState == 2)
                    fStateDsec += "<br /><font color='red'>勘察单位打回</font>";
                else if (app.FState == 7)
                    fStateDsec += "<br /><font color='red'>勘察单位不予受理</font>";
                ...
                {
                    //查询出不合格的意见
                    var vv = db.CF_App_List.Where(a => a.FLinkId == FPriItemId && a.FManageTypeId == 28803).FirstOrDefault();
                    if (vv != null)
                    {
                        string txt = "<a style=\"text-decoration:underline;\" ";
                        txt += "href=\"javascript:showAddWindow('../../KcsjSgt/ApplyKCJSXSC/Report.aspx?FAppId=" + vv.FId + "',700,680);\">";
                        txt += "查看审图机构意见</a>";
