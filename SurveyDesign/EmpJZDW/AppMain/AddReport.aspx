<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddReport.aspx.cs" Inherits="EmpJZDW_appmain_AddReport" %>
    ...
    <table class="m_table" width="98%" align="center">
        ...
        <tr>
            <td colspan="4" class="t_bg" align="center">
                ...
                <asp:Button ID="btnReport" runat="server" Text="见证完毕" OnClick="btnAdd_Click" CssClass="m_btn_w4"
                    OnClientClick="return checkInfo();" />
            </td>
        </tr>
    </table>
        ...
        <table class="m_dg1" width="100%" align="center">
            ...
            <asp:Repeater ID="rep_List" runat="server" OnItemDataBound="rep_List_ItemDataBound">
                <ItemTemplate>
                    ...
                    <asp:Repeater ID="rep_File" runat="server" OnItemCommand="rep_File_ItemCommand" OnItemDataBound="rep_File_ItemDataBound">
                        <ItemTemplate>
                            <tr class="m_dg1_i">
