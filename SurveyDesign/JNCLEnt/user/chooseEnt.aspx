    ...
    <form id="form1" runat="server">
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="t_FSystemId" runat="server">
                        ...
                        <asp:ListItem Value="125">监理</asp:ListItem>
                        <asp:ListItem Value="1550">勘察</asp:ListItem>
                        <asp:ListItem Value="155">设计</asp:ListItem>
                        <asp:ListItem Value="196">设计施工一体化</asp:ListItem>
                        <asp:ListItem Value="180">入川施工</asp:ListItem>
                        <asp:ListItem Value="190">入川监理</asp:ListItem>
                        <asp:ListItem Value="141">入川勘察</asp:ListItem>
                        <asp:ListItem Value="140">入川设计</asp:ListItem>
                        <asp:ListItem Value="129">入川设计施工一体化</asp:ListItem>
                    </asp:DropDownList>
                </td>
        ...
        <asp:DataGrid ID="DG_List" runat="server" HorizontalAlign="Center" Width="98%" CssClass="m_dg1"
            ...
            <Columns>
                ...
                <asp:BoundColumn DataField="FName" HeaderText="企业名称" HeaderStyle-Width="80px">
