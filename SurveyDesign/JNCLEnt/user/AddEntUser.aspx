    ...
    <form id="form1" runat="server">
        ...
        <table class="m_table" width="98%" align="center">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="t_FEntType" Width="150px" runat="server" CssClass="m_txt" Enabled="False">建筑节能材料和产品</asp:TextBox>
                </td>
            </tr>
            <tr>
                ...
                <td class="auto-style1">
                    <asp:TextBox ID="t_FMenuRoleId" Width="150px" runat="server" CssClass="m_txt" Enabled="False">建筑节能材料和产品</asp:TextBox>
                </td>
            </tr>
            <tr>
