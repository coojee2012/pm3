...
public partial class JNCLEnt_main_firstBA : System.Web.UI.Page
{
    ...
    protected void DG_List_ItemCommand(object source, DataGridCommandEventArgs e)
    {
        if (e.Item.ItemIndex > -1)
        {
            ...
            else if (e.CommandName == "Del")
            {
                ...
                sb.Append("delete YW_JN_EntJJ where fappid='" + FId + "';");
                sb.Append("delete YW_JN_Equipment where fappid='" + FId + "';");
