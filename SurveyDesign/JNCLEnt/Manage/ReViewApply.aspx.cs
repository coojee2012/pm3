...
public partial class JNCLEnt_Manage_ReViewApply : System.Web.UI.Page
{
    RCenter rc = new RCenter(); 
    Share sh = new Share();
    public int fMType = 4001;
    ...
    public void showInfo()
    {
        ...
        string sql = "select l.*,a.SQCPMC,a.CPLBMC,a.BSDJMC from CF_App_List l,YW_JNCL_PRODUCT a where l.fid=a.ywbm and a.FType=1 and l.FBaseinfoId='"
            + FBaseinfoID + "'";
    ...
    protected void btnOk_Click(object sender, EventArgs e)
    {
        ...
        list.Add(new SqlParameter() { ParameterName = "@FType", Value = 1, SqlDbType = SqlDbType.VarChar });
        ...
        this.RegisterStartupScript(new Guid().ToString(), "<script>parent.parent.document.location='../AuditAppMain/aIndex.aspx?YWBM=" + fAppId + "';</script>");
    }
