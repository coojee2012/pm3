<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FileList.aspx.cs" Inherits="JNCLEnt_AppJNCL_FileList" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        function UpadLoadFile(typeId, $obj) {
            ...
            var url = "fileUpadload.aspx?typeId=" + typeId + "&typeName=" + typeName + "&FIsApprove=" + $("#hfFIsApprove").val() + "&YWBM=" + $("#hfYWBM").val();
