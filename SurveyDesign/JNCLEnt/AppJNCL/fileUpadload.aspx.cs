...
public partial class JNCLEnt_AppJNCL_fileUpadload : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            var url = "FileAdd.aspx?typeId=" + TypeId + "&typeName=" + HttpUtility.UrlEncode(TypeName, System.Text.Encoding.Default) + "&FIsApprove=" + FIsApprove + "&YWBM=" + YWBM;
