...
<head runat="server">
    ...
    <script type="text/javascript">
        function checkInfo() {
            ...
            if ($("#t_JJTypeID").val().trim() == "") {
                alert("请选择经济类型");
                return false;
            }
            if ($("#t_CLTime").val().trim() == "") {
                alert("请选择成立时间");
                return false;
            }
            if ($("#t_ZCZJ").val().trim() == "") {
            ...
            if ($("#t_ZJType").val().trim() == "") {
                alert("请选择证件类型");
                return false;
            }
            if ($("#t_ZJCode").val().trim() == "") {
                alert("请填写证件号码");
                return false;
            }
            if ($("#t_linkMan").val().trim() == "") {
                alert("请填写联系人姓名");
                return false;
            }
            if ($("#t_linkZW").val().trim() == "") {
                alert("请填写联系人职务");
                return false;
            }
            if ($("#t_linkPho").val().trim() == "") {
                alert("请填写联系人手机");
                return false;
            }
            if ($("#t_linkFax").val().trim() == "") {
                alert("请填写联系人传真");
                return false;
            }
            if ($("#t_JYFW").val().trim() == "") {
