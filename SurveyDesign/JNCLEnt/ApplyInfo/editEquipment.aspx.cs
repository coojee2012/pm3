...
public partial class JNCLEnt_mangeInfo_editWquipment : System.Web.UI.Page
{
    ...
    public void showInfo()
    {
        if (!string.IsNullOrEmpty(FID))
        {
            ...
            string sql = "select top 1* from YW_JN_AppEquipment where fid='" + FID + "' ";
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            sql = @"INSERT INTO [dbo].[YW_JN_AppEquipment]
                               ...
                               ,[ZT]
                               ,[type])
                         VALUES(NEWID(),@YWBM,@fbaseid,GETDATE(),GETDATE(),@SBMC,@XH,@GL,@NU,@DW,@SFZY,@YZ,@JZ,@ZT,0)";//type 0为生产设备 1位检测设备
