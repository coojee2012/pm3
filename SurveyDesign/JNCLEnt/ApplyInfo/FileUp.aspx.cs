...
public partial class KC_AppMain_FileUp : System.Web.UI.Page
{
    ...
    private void ShowFileType()
    {
        switch (t_type.Value)
        {
            ...
            case "2001":
                ...
                break;
            case "2002":
                lType.Text = "有效期内产品的型式检验报告";
                break;
            case "2003":
                lType.Text = "产品质量保证体系和管理制度";
                break;
            case "3000":
                lType.Text = "企业营业执照";
                break;
            case "3001":
                ...
                break;
            case "3002":
                lType.Text = "设计施工验收技术规程";
                break;
            case "3003":
                lType.Text = "法定检测机构出具的有效期内的产品型式检验报告";
                break;
            case "3004":
                lType.Text = "质量保证体系认证证书";
                break;
        }
        string sql = string.Format(@"select f.FFileName,f.FFilePath,f.FID from YW_FileList l 
    ...
    private void saveInfo()
    {
        ...
        {
            string sql = string.Format(@"insert YW_FileList (FID,FAppid,FType,FFileID,FTypeName)
