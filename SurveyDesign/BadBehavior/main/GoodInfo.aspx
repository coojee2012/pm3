<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GoodInfo.aspx.cs" Inherits="BadBehavior_main_GoodInfo" %>
    ...
    <table class="m_table" width="98%" align="center">
        ...
        <tr>
            ...
            <td class="m_txt_M" colspan="3">
                <asp:TextBox ID="t_FTxt11" runat="server" CssClass="m_txt" Width="287px" MaxLength="30"
