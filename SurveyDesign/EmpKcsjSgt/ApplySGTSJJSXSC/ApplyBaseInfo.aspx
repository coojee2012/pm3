<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ApplyBaseInfo.aspx.cs" Inherits="KcsjSgt_ApplySGTSJWJSCWTSL_ApplyBaseInfo" %>
...
<body>
    ...
    <table class="m_table" width="98%" align="center">
        <tr>
            ...
            <td colspan="3">
                <asp:TextBox ID="t_FTxt10" runat="server" CssClass="m_txt" Width="400px" Height="30px"
        ...
        <tr>
            ...
            <td colspan="3">
                <asp:TextBox ID="t_FTxt11" runat="server" CssClass="m_txt" Width="400px" Height="80px"
                    TextMode="MultiLine" ReadOnly="true"></asp:TextBox>
            </td>
        </tr>
    </table>
