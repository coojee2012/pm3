<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LookIdea.aspx.cs" Inherits="KcsjSgt_AppMain_LookIdea" %>
...
<body>
    ...
    <table class="m_table" width="98%" align="center">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="t_FAppTime" runat="server" CssClass="m_txt"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="t_r t_bg">
            ...
            <td>
                <asp:TextBox ID="t_FResult" runat="server" CssClass="m_txt"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="t_r t_bg">
