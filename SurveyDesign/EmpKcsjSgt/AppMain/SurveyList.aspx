<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SurveyList.aspx.cs" Inherits="EmpKcsjSgt_AppMain_SurveyList" %>
    ...
    <table height="95%" width="98%" align="center" style="margin-top: 10px; margin-bottom: 10px;">
        ...
        <tr>
            ...
            <td class=" wxts_m">
                        ...
                        <Columns>
                            ...
                            <asp:TemplateColumn HeaderText="工程名称">
                                ...
                                <ItemTemplate>
                                    ...
                                    <a href='javascript:showAddWindow("../ApplySGTSJJSXSC/ApplyBaseInfo.aspx?FDataID=<%#Eval("FLinkId") %>",800,700);'>
                                        <%#Eval("FPrjName")%>
                                    </a>
                ...
                <div style="width: 98%; margin: 4px auto;">
                    提示：<tt>点击‘操作’列，填写各审查人员意见。</tt><img src="../../image/info.jpg" /><tt>表示人员安排有变化</tt>
                </div>
            </td>
            <td class="wxts_r">
            </td>
