<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Business.aspx.cs" Inherits="EmpKcsjSgt_AppMain_Business" %>
                        ...
                        <Columns>
                            ...
                            <asp:TemplateColumn HeaderText="工程名称">
                                ...
                                <ItemTemplate>
                                    ...
                                    <a href='javascript:showAddWindow("../ApplyKCJSXSC/ApplyBaseInfo.aspx?FDataID=<%#Eval("FLinkId") %>",800,700);'>
                                        <%#Eval("FPrjName")%>
                                    </a>
