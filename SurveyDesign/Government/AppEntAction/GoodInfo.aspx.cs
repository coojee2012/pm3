...
public partial class Government_AppEntAction_GoodInfo : System.Web.UI.Page
{
    ...
    private void saveInfo(int state)
    {
        ...
        db.SubmitChanges();
        tool.showMessageAndRunFunction((state == 1 ? "审核成功。" : "审核成功。"), "window.returnValue='1';");
