<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LandPlanList.aspx.cs" Inherits="JSDW_ApplyYDGH_AuditMain_LandPlanList" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function app(url) {
            ...
            var YD_Id = $(items[0]).parent("span").attr("name");
            ...
            url = url + '?ftype=1&YD_Id=' + YD_Id + '&fSubFlowId=' + fsubid;
            if (audit == "1")//已受理
                url = "PrintAccept.aspx?YD_Id=" + YD_Id + "&fSubFlowId=" + fsubid + "&audit=1";
            else if (audit == "0")
                url = "PrintAccept.aspx?YD_Id=" + YD_Id + "&fSubFlowId=" + fsubid + "&audit=0";
    ...
    <form id="form1" runat="server">
        ...
        <table width="98%" align="center" class="m_bar">
            <tr>
                ...
                <input type="button" value="审核" class="m_btn_w2" onclick="return app('AuditLandPlan.aspx')" />
    ...
    <asp:DataGrid ID="DG_List" runat="server" HorizontalAlign="Center" Width="98%" CssClass="m_dg1"
        ...
        <Columns>
           <asp:TemplateColumn>
                ...
                <asp:BoundColumn DataField="YDMJ" HeaderText="用地面积"></asp:BoundColumn>
                <asp:BoundColumn DataField="ZJZMJ" HeaderText="建筑总面积"></asp:BoundColumn>
