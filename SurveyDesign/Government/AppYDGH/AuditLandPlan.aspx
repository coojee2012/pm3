<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AuditLandPlan.aspx.cs" Inherits="JSDW_ApplyYDGH_AuditMain_AuditLandPlan" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        function ChooseFile(typeId, YD_Id, typeName) {
            var url = "../AppXZYJS/file.aspx?typeId=" + typeId + "&YJS_ID=" + YD_Id + "&typeName=" + typeName;
...
<body id="body1">
    ...
    <div>
        ...
        <div style="text-align: center; margin-top: 2PX">
            ...
            &nbsp;&nbsp;<asp:Button ID="btnNoAccept" runat="server" Text="不予受理" 
                class="m_btn_w4" onclick="btnNoAccept_Click" />
            &nbsp;&nbsp;<asp:Button ID="btnBack" runat="server" Text="打回企业"  OnClientClick="return confirm('确认打回？')" 
                class="m_btn_w4" onclick="btnBack_Click" />
