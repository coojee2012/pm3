<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QueryEnd.aspx.cs" Inherits="JSDW_ApplyYDGH_AuditMain_QueryEnd" %>
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="ddlAuditType" Width="120px" CssClass="m_txt" runat="server">
                        ...
                        <asp:ListItem Value="5050">房建</asp:ListItem>
                        <asp:ListItem Value="5060">市政</asp:ListItem>
                    </asp:DropDownList>
                </td>
