<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PrjBASQAppPager1.aspx.cs"
    Inherits="Government_AppPage_PrjBASQAppPager1" %>
...
<body>
    ...
    <table width="98%" align="center" class="m_title">
        ...
        <tr>
            <td class="t_r"><asp:Literal ID="liJsEnt" runat="server">建设单位</asp:Literal>
    ...
    <div class="tabBar" style="width: 98%; margin: 2px auto;">
        ...
        <a name="a_2" class="tab_btn" id="btnDHQY" runat="server"><strong>打&nbsp;&nbsp;回</strong></a> <a
            class="tab_btn" runat="server" id="HSeeReportInfo"><strong>上报资料</strong></a>
    ...
    <div id="diva_1" style="display: none; margin-top: 4px">
            ...
            <tr>
                ...
                <td colspan="3">
                    <asp:DropDownList ID="t_FResult" runat="server" Width="90px" 
                        AutoPostBack="True" onselectedindexchanged="t_FResult_SelectedIndexChanged">
                        <asp:ListItem Value="1">通过</asp:ListItem>
                            <asp:ListItem Value="3">不通过</asp:ListItem>
                    </asp:DropDownList>
                </td>
        ...
        <table align="center" width="98%" class="m_title" runat="server" id="tab_BJ" visible="false">
            <tr>
                <th colspan="4">
                    <asp:Label ID="txtTitle" runat="server" Text="备案编号"></asp:Label>：<asp:Label ID="liTechnical" runat="server" ForeColor="Red"></asp:Label>
                </th>
            </tr>
            <tr>
                <td class="t_l" style='padding-left: 90px'>
                    <asp:Label ID="txtBABH" runat="server" Text="备案编号"></asp:Label>
                    <asp:TextBox ID="txtFPrjItemNo" runat="server" CssClass="m_txt" Width="200px" MaxLength="20"></asp:TextBox><tt>*</tt>
                    <input id="txtFManageDeptId" runat="server" type="hidden" />
                    <input id="txtFDepartment" runat="server" type="hidden" />
    ...
    <div id="diva_3" style="display: none;">
        <table align="center" style="margin-top: 5px;" width="98%">
            <asp:Repeater ID="repSubFlow" runat="server">
                <HeaderTemplate>
                    <tr>
                        <td style="background: center url(../../image/Start.jpg) no-repeat; height: 60px; text-align: center">
                            开始
                        </td>
                    </tr>
                    <tr>
                ...
                <FooterTemplate>
                    <tr>
                        <td style="background: url(../../image/end.jpg) center  no-repeat; height: 60px; text-align: center">
                            结束
                        </td>
                    </tr>
                </FooterTemplate>
