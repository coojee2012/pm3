<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QueryEnd.aspx.cs" Inherits="JSDW_ApplyJGYS_AuditMain_QueryEnd" %>
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="ddlAuditType" Width="120px" CssClass="m_txt" runat="server">
                        ...
                        <asp:ListItem Value="7070">房建</asp:ListItem>
                        <asp:ListItem Value="7080">市政</asp:ListItem>
                    </asp:DropDownList>
                </td>
