...
public partial class JSDW_ApplyYDGH_AuditMain_BackAccept : System.Web.UI.Page
{
    private RCenter rc = new RCenter();
    private RCenter rq = new RCenter();
    private RApp ra = new RApp();
    private ArrayList arrCon = new ArrayList();
    ...
    private void ShowInfo()
    {
        ...
        sb.AppendFormat(" and er.FtypeId={0} and isnull(er.FMeasure,0) in (0,4) ", TypeId); //存子流程类别 
    ...
    private void BatchEndApp()
    {
        ...
        else
        {
            ...
            for (int i = 0; i < iCount; i++)
            {
                ...
                //龚成龙【2010-03-16】
                rc.PExcute("update CF_App_ProcessRecord set FAppTime=getdate() where fprocessInstanceId='" + strs[i] + "' and FTypeId=5");//修改退件的时间
            }
