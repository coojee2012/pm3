<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CheckPuthList.aspx.cs" Inherits="JSDW_ApplyJGYS_AuditMain_CheckPuthList" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        function showWindow() {
            showAddWindow("IDeaBookApply.aspx?anc=1", 1000, 500);
        }
        function app(url) {
...
//                url = "../../ApplyJGYSSZ/AuditMain/" + url;
            showAddWindow(url + '?typeId=1&JG_Id=' + JG_Id + '&fSubFlowId=' + fsubid + '&YWBM=' + YWBM, 700, 600);
            return true;
        }
