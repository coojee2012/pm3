<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AuditProjectPlan.aspx.cs" Inherits="JSDW_ApplyGCGH_AuditMain_AuditProjectPlan" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function ShowForm(url) {
            var tmpVal = $("#hfJGId").val();
            showAddWindow(url + '?JG_Id=' + tmpVal+'&audit=1', 900, 500);
            return true;
        }
        function FindUpStuff()
        {
            ...
            if ($("#hfProjectType").val()=="1")//房建
                url = "../../JSDW/ApplyJGYS/AppMain/index.aspx?JG_Id=" + JGId + "&fAppId=" + YWBM + "&audit=1";
            else
                url = "../../JSDW/ApplyJGYSSZ/AppMain/index.aspx?JG_Id=" + JGId + "&fAppId=" + YWBM + "&audit=1";
...
<body id="body1">
    <form id="form1" runat="server">
        ...
        <asp:HiddenField ID="hfJGId" runat="server" />
    ...
    <table width="98%" align="center" class="m_title">
        <tr>
            <th colspan="5">竣工验收备案办理
            </th>
        </tr>
        <tr>
            <td class="t_r t_bg">工程名称</td>
            <td colspan="3"><asp:TextBox ID="txtGCMC" Enabled="false" runat="server" Width="400"></asp:TextBox></td>
        </tr>
        <tr>
             <td class="t_r t_bg">工程地点</td>
            <td colspan="3"><asp:TextBox ID="txtGCDD" Enabled="false" runat="server" Width="400"></asp:TextBox></td>
        </tr>
        <tr>
            <td class="t_r t_bg">结构类型</td>
            <td><asp:TextBox ID="txtJGLXMC" Enabled="false" runat="server" width="200"></asp:TextBox></td>
            <td class="t_r t_bg">建筑面积</td>
            <td><asp:TextBox ID="txtJZMJ" Enabled="false" runat="server"></asp:TextBox>(㎡)</td>
        </tr>
         <tr>
            <td class="t_r t_bg">用地性质</td>
            <td><asp:TextBox ID="txtYDXZMC" Enabled="false" width="200" runat="server"></asp:TextBox></td>
            <td class="t_r t_bg">工程造价</td>
            <td><asp:TextBox ID="txtGCZJ" Enabled="false" runat="server"></asp:TextBox>(万元)</td>
        </tr>
         <tr>
            <td class="t_r t_bg">开工日期</td>
            <td><asp:TextBox ID="txtKGRQ" Enabled="false" width="200" runat="server"></asp:TextBox></td>
            <td class="t_r t_bg">竣工验收日期</td>
            <td><asp:TextBox ID="txtJGYSRQ" Enabled="false" runat="server"></asp:TextBox></td>
        </tr>
    </table>
    <table width="98%" align="center" class="m_title">
        <tr>
            <td>
                <%--<input type="button" value="竣工验收备案表" class="m_btn_w12" onclick="ShowForm('../CheckPutForm.aspx')" />&nbsp;&nbsp;
                <input type="button" value="参与项目建设单位情况" class="m_btn_w12" onclick="ShowForm('formIndex.aspx')" />
                <input type="button" value="项目材料情况" class="m_btn_w12" onclick="ShowForm('../ProjectFile/formIndex.aspx')" />&nbsp;&nbsp;--%>
    ...
    <div id="divSetup2">
        ...
        <div style="text-align: center; margin-top: 2PX">
            ...
            &nbsp;&nbsp;<asp:Button ID="btnAccept" runat="server"  class="m_btn_w4" Text="办结" OnClick="btnAccept_Click" OnClientClick="return Save();" />
            <asp:Button ID="btnExit" runat="server" Text="打回企业" CssClass="m_btn_w4" OnClick="btnExit_Click" OnClientClick="return confirm('确认打回？')" />
            &nbsp;&nbsp;<input id="btnReturn" type="button" class="m_btn_w2" value="返回" onclick="javascript:window.returnValue='1';window.close();" />
        </div>
        </div>
    </form>
</body>
