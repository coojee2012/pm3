...
public partial class Government_statis_statisByJSXZ : System.Web.UI.Page
{
    ...
    private void showInfo()
    {
        ...
        sb.Append("where FNumber like '" + ViewState["FNumber"] + "%' ");
        sb.Append("and FNumber like '" + ComFunction.GetDefaultDept() + "%' and FName not like'%市辖区%' ");
        ...
        string sUrl = "<a href='javascript:void(0)' onclick=\"showAddWindow('statisByPrjList.aspx?FYear=" + iYear + "&FMType={0}&FMonth={1}&FType={2}&col=JSXZ&sWhere=" + sWhere + "&sTag=" + stag + "&cityCode={4}&sSCType=" + iSCType + "',700,550);\">{3}</a>";
    ...
    protected void DG_List_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        ...
        else if (e.Item.ItemType == ListItemType.Footer)
        {
            ...
            string sUrl = "<a href='javascript:void(0)' onclick=\"showAddWindow('statisByPrjList.aspx?FYear=" + dr_Year.SelectedValue + "&FMType={0}&FType={1}&col=JSXZ&sWhere=" + drop_CountWay.SelectedValue + "&sTag=" + stag + "&sSCType=" + ddlFType.SelectedValue + "',700,550);\">{2}</a>";
    ...
    protected void btnOut_Click(object sender, EventArgs e)
    {
        ...
        sab.SaveAsExc("审查项目统计-按建设性质统计", this.Response, h_div.Value);
    }
