<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReportQuery.aspx.cs" Inherits="Government_AppMain_ReportQuery" %>
...
<body onload="init()">
    ...
    <table width="98%" align="center" class="m_title">
        <tr>
            <th colspan="5">
                <asp:Literal ID="lPostion" runat="server">上报查询</asp:Literal>
            </th>
        </tr>
        <tr>
            <td class="t_r">
    ...
    <asp:DataGrid ID="JustAppInfo_List" runat="server" AutoGenerateColumns="False" CssClass="m_dg1"
        ...
        <Columns>
            ...
            <asp:BoundColumn HeaderText="上报时间" >
