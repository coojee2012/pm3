...
public partial class Government_statis_SCXMBB_KC : System.Web.UI.Page
{
    ...
    {
        //参与项目（查询技术性审查已经通过的。）
        var v = (from t in db.CF_App_List.Where(a => (a.FManageTypeId == 28803) && a.FState == 6)
        ...
        {
            v = v.Where(t => t.a.kc.FBaseName.Contains(t_jsBaseName.Text)).ToList();
        }
        //勘察单位
