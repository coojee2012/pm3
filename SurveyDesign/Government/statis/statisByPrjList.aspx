<%@ Page Language="C#" AutoEventWireup="true" CodeFile="statisByPrjList.aspx.cs"
    Inherits="KC_appmain_statisByPrjList" %>
    ...
    <asp:DataGrid ID="dg_List" runat="server" AutoGenerateColumns="False" CssClass="m_dg1"
        ...
        <Columns>
            ...
            <asp:TemplateColumn HeaderText="工程名称">
                ...
                <ItemTemplate>
                    <a href="javascript:doShow('<%#Eval("FPrjId") %>');">
                        <%#Eval("FPrjName")%>
                    </a>
                </ItemTemplate>
            </asp:TemplateColumn>
            ...
            <asp:BoundColumn DataField="FSTEnt" HeaderText="审图机构">
                <ItemStyle CssClass="t_l" Wrap="false" />
            </asp:BoundColumn>
