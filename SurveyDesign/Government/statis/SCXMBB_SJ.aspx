<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SCXMBB_SJ.aspx.cs" Inherits="Government_statis_SCXMBB_SJ" %>
...
<body>
    ...
    <table width="98%" align="center" class="m_title">
        <tr>
            <th colspan="7">
                <asp:Literal ID="lit_Title" runat="server" Text="施工图设计文件审查项目报表统计"></asp:Literal>
            </th>
        </tr>
        <tr>
            <td class="t_r t_bg">
        ...
        <tr>
            ...
            <td>
                <asp:DropDownList ID="t_FKind" runat="server">
                </asp:DropDownList>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <asp:TextBox ID="t_FAllMoney1" runat="server" CssClass="m_txt t_r" Width="50px" onblur="isFloat(this);"></asp:TextBox>
                至
                <asp:TextBox ID="t_FAllMoney2" runat="server" CssClass="m_txt t_r" Width="50px" onblur="isFloat(this);"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="t_r t_bg">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="t_kcBaseName" runat="server" CssClass="m_txt"></asp:TextBox>
            </td>
            <td class="t_r t_bg">
                设计单位：
            </td>
            <td>
                <asp:TextBox ID="t_sjBaseName" runat="server" CssClass="m_txt"></asp:TextBox>
            </td>
            <td class="t_r t_bg">
                审图机构：
            </td>
            <td>
                <asp:TextBox ID="t_stBaseName" runat="server" CssClass="m_txt "></asp:TextBox>
            </td>
        </tr>
        <tr>
    ...
    <asp:DataGrid ID="DG_List" runat="server" AutoGenerateColumns="False" CssClass="m_dg1"
        ...
        <Columns>
            ...
            <asp:BoundColumn HeaderText="设计单位">
                <ItemStyle HorizontalAlign="Left" />
            </asp:BoundColumn>
            <asp:BoundColumn HeaderText="审查机构">
                <ItemStyle HorizontalAlign="Left" />
            </asp:BoundColumn>
            ...
            <asp:BoundColumn HeaderText="勘察收费(万元)">
                <HeaderStyle Width="60" />
                <ItemStyle HorizontalAlign="Right" />
            </asp:BoundColumn>
            <asp:BoundColumn HeaderText="设计收费(万元)">
                <HeaderStyle Width="60" />
                <ItemStyle HorizontalAlign="Right" />
            </asp:BoundColumn>
