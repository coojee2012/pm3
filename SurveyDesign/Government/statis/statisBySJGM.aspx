<%@ Page Language="C#" AutoEventWireup="true" CodeFile="statisBySJGM.aspx.cs" Inherits="Government_statis_statisBySJGM"
...
<body>
    ...
    <table width="98%" align="center" class="m_title">
        <tr>
            <th colspan="7">
                <asp:Literal ID="lit_Title" runat="server" Text="按设计规模统计"></asp:Literal>
            </th>
        </tr>
        <tr>
            <td class="t_r t_bg">
