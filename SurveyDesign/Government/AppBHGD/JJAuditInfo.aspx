<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JJAuditInfo.aspx.cs" Inherits="Government_AppBZGD_JJAuditInfo" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function disableButton() {
            ...
            //document.getElementById("bthEndApp").disabled = true;
            //document.getElementById("btnBackToEnt").disabled = true;
        }
        function app(url) {
            var obj = new Object();
             ShowWindow(url, 1200, 800, obj);
            return false
        }
        function ShowWindow(url, width, hieght, obj) {
            ...
            var idvalue = window.showModalDialog(url , obj, sFeatures);
...
<body>
    <form id="form1" runat="server">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="t_ProjectName" ReadOnly="true" runat="server" CssClass="m_txt" Width="394px"></asp:TextBox>
               
                <asp:Button ID="Button1" runat="server" OnClientClick="return app('../../JSDW/ApplyBHGD/BHGDInfo.aspx')" Text="查看申报信息" />
