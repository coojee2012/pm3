<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OneAuditList.aspx.cs" Inherits="Government_AppBZGD_OneAuditList" %>
...
<body>
    ...
    <table width="98%" align="center" class="m_title">
        <tr>
            <th colspan="5">
                <asp:Literal ID="lPostion" runat="server" Text="初审"></asp:Literal>
            </th>
        </tr>
        <tr>
            <td class="t_r">
