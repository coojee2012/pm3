<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AcceptList.aspx.cs" Inherits="Government_AppBHGD_AcceptList" %>
...
<body>
    ...
    <table width="98%" align="center" class="m_title">
        <tr>
            <th colspan="7">
                <asp:Literal ID="lPostion" runat="server" Text="标准化工地接件"></asp:Literal>
            </th>
        </tr>
        <tr>
            <td class="t_r">
