<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CSAuditInfo.aspx.cs" Inherits="Government_AppZLJDBA_CSAuditInfo" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function disableButton() {
            alert("aaa");
            //btnUPCS.disabled = true;
            //$("#btnSave").attr("disabled", "true");
            $("#btnSave").hide();
            //bthEndApp.disabled = true;
            //btnBackToEnt.disabled = true;
        }
    </script>
    <style type="text/css">
        .cBtn7 {
