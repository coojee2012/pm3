...
public partial class Government_AppZLJDBA_OneAuditInfo : System.Web.UI.Page
{
    ...
    private void ShowInfo()
    {
        ...
        sb.Remove(0, sb.Length);
        sb.Append(" select FId,FAppPerson,FCompany,FFunction,FIdea,FRoleDesc,case FResult when 1 then '通过' when 3 then '不通过' end as FResultStr from CF_App_ProcessRecord where FTypeID = 1 and FLinkId = '" + ViewState["FAppId"] + "'");
        dt = rc.GetTable(sb.ToString());
