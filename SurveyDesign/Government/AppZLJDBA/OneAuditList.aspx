<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OneAuditList.aspx.cs" Inherits="Government_AppZLJDBA_OneAuditList" %>
...
<body>
    ...
    <table width="98%" align="center" class="m_title">
        <tr>
            <th colspan="7">
                <asp:Literal ID="lPostion" runat="server">质量监督备案初审</asp:Literal>
            </th>
        </tr>
        <tr>
            <td class="t_r">
