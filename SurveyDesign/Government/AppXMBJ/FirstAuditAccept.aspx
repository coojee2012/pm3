<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FirstAuditAccept.aspx.cs" Inherits="JSDW_ApplyGCGH_AuditMain_FirstAuditAccept" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function app(url) {
            ...
            showAddWindow(url + '?typeId=10&XM_Id=' + XM_Id + '&fSubFlowId=' + fsubid, 850, 600);
            return true;
        }
        function BackApp(url) {
            ...
            var fsubid = $(items[0]).parent("span").attr("fSubFlowId");
            showAddWindow(url + '?typeId=10&FLinkId=' + tmpVal + '&fSubFlowId=' + fsubid, 700, 600);
            return true;
        }
    </script>
    ...
    <asp:DataGrid ID="DG_List" runat="server" HorizontalAlign="Center" Width="98%" CssClass="m_dg1"
        ...
        <Columns>
           <asp:TemplateColumn>
                ...
                <asp:BoundColumn DataField="XMMC" HeaderText="项目名称" HeaderStyle-Wrap="false" HeaderStyle-Width="300"></asp:BoundColumn>
                <%--<asp:BoundColumn DataField="FEmpName" HeaderText="工程名称">
                    <ItemStyle HorizontalAlign="Left" />
                </asp:BoundColumn>
                <asp:BoundColumn DataField="FEntName" HeaderText="企业名称"></asp:BoundColumn>--%>
