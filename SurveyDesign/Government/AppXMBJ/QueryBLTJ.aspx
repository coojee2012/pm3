<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QueryBLTJ.aspx.cs" Inherits="Government_AppXMBJ_QueryBLTJ" %>
...
<body>
    <form id="form1" runat="server">
        <table width="98%" align="center" class="m_title">
            ...
            <tr>
                ...
                <td class="t_r">申请日期：</td>
                <td><asp:TextBox ID="txtSQRQ" runat="server" CssClass="m_txt Wdate" Width="150px" onfocus="WdatePicker({skin:'whyGreen' })"></asp:TextBox></td>--%>
            </tr>
        </table>
    <asp:DataGrid ID="DG_List" runat="server" HorizontalAlign="Center" Width="98%" CssClass="m_dg1"
        ...
        <Columns>
                ...
                <asp:BoundColumn DataField="CreateTime" DataFormatString="{0:yyyy-MM-dd}" HeaderText="申请日期"></asp:BoundColumn>
