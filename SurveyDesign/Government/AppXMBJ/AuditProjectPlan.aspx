...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        function ChooseFile(typeId, XM_Id, typeName) {
            var url = "../AppXZYJS/file.aspx?typeId=" + typeId + "&YJS_ID=" + XM_Id + "&typeName=" + typeName;
        ...
        function FindUpStuff() {
            ...
            var Id = $("#hfId").val();
            var url = "../../JSDW/ApplyXMBJ/AppMain/index.aspx?XM_Id=" + Id + "&fAppId=" + YWBM + "&audit=1";
...
<body id="body1">
    ...
    <table width="98%" align="center" class="m_title">
        ...
        <tr>
            ...
            <td colspan="3"><asp:TextBox ID="txtJSDW" runat="server" Enabled="false" Width="280"></asp:TextBox></td>
        </tr>
        <tr>
    ...
    <div>
        ...
        <div style="text-align: center; margin-top: 2PX">
            <asp:Button ID="btnSaveYJ" runat="server" CssClass="m_btn_w2" Text="保存" OnClientClick="return Save(this);" OnClick="btnSaveYJ_Click" />
            &nbsp;&nbsp;<asp:Button ID="btnAccept" runat="server"  class="m_btn_w4" Text="办结" OnClick="btnAccept_Click" OnClientClick="return Save(this);" />
            &nbsp;&nbsp;<asp:Button ID="btnNoAccept" Visible="false" runat="server" 
                CssClass="m_btn_w4" Text="不予受理" onclick="btnNoAccept_Click" />
            &nbsp;&nbsp;<asp:Button ID="btnBack" Visible="false" runat="server" CssClass="m_btn_w4" Text="打回企业"  OnClientClick="return confirm('确认打回？')" onclick="btnBack_Click" />
            &nbsp;&nbsp;<asp:Button ID="btnYes" runat="server" Text="受理通知书打印" Visible="false" CssClass="m_btn_w8" OnClientClick='javascript:document.getElementById("SLDY").click();' />
             <asp:Literal ID="ltrTZSText" runat="server"></asp:Literal>
              &nbsp;&nbsp;<asp:Button ID="btnNoYes" runat="server" Text="不受理通知书打印" Visible="false" CssClass="m_btn_w8" OnClientClick='javascript:document.getElementById("NOSLDY").click();' />
