<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SGwaitForAppList.aspx.cs"
    Inherits="Government_AppMain_SGwaitForAppList" %>
...
<body>
    ...
    <table width="98%" align="center" class="m_title">
        ...
        <tr>
            <td class="t_r">
                <asp:Literal ID="liEntType" runat="server"> 单位名称：</asp:Literal>
            </td>
            <td>
            ...
            <td>
                <asp:DropDownList ID="dbSelfAppState" runat="server" CssClass="m_txt">
    ...
    <asp:DataGrid ID="JustAppInfo_List" runat="server" AutoGenerateColumns="False" CssClass="m_dg1"
        ...
        <Columns>
            ...
            <asp:BoundColumn HeaderText="勘察单位" DataField="FEntName">
                <ItemStyle Font-Underline="False" Wrap="False" HorizontalAlign="left" />
                <HeaderStyle Font-Underline="False" Wrap="False" />
            </asp:BoundColumn>
