<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GFOneAuditList.aspx.cs" Inherits="Government_AppMain_GFwaitForApllList" %>
...
<body>
    <form id="form1" runat="server">
        <table align="center" class="m_title" style="width: 98%;">
            <tr>
                <th colspan="7">
                    <asp:Literal ID="lPostion" runat="server">工法初审</asp:Literal>
                </th>
            </tr>
            <tr>
                ...
                <td colspan="3" rowspan="3" style="text-align: left; padding-right: 10px; width: 50px;">
        ...
        <table width="98%" align="center" class="m_bar">
            <tr>
                ...
                <td class="t_r">
                    ...
                    &nbsp;<asp:Button ID="Button1" runat="server" CssClass="m_btn_w4" Text="专家选择" OnClientClick="return app('chooseExpert.aspx')" />
        ...
        <asp:DataGrid ID="JustAppInfo_List" runat="server" AutoGenerateColumns="False" CssClass="m_dg1"
            ...
            <Columns>
                ...
                <asp:BoundColumn HeaderText="接件时间" HeaderStyle-Width="100px" DataField="FReportTime" DataFormatString="{0:yyyy-MM-dd}">
                    <ItemStyle Font-Underline="False" Wrap="False" HorizontalAlign="Left" />
                    <HeaderStyle Font-Underline="False" Wrap="False" />
                </asp:BoundColumn>
                ...
                <asp:BoundColumn HeaderText="专家意见" HeaderStyle-Width="80px" DataField="">
                    <ItemStyle Font-Underline="False" Wrap="False" HorizontalAlign="Left" />
                    <HeaderStyle Font-Underline="False" Wrap="False" />
                </asp:BoundColumn>
