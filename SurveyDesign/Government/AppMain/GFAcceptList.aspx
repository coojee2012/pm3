<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GFAcceptList.aspx.cs" Inherits="Government_AppMain_GFseeAppList" %>
    ...
    <form id="form1" runat="server">
        ...
        <table width="98%" align="center" class="m_bar">
            <tr>
                <td class="m_bar_l"></td>
                <td class="t_r">
                    <asp:Button ID="btnAccept" runat="server" CssClass="m_btn_w2" Text="接件" OnClientClick="return app('AcceptInfoGF.aspx')" />
        ...
        <asp:DataGrid ID="JustAppInfo_List" runat="server" AutoGenerateColumns="False" CssClass="m_dg1"
            ...
            <Columns>
                ...
                <asp:BoundColumn HeaderText="工法名称" HeaderStyle-Width="200px" DataField="FEmpName">
