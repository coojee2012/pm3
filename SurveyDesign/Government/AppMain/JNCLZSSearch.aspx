<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JNCLZSSearch.aspx.cs" Inherits="Government_AppMain_JNCLZSSearch" %>
<!DOCTYPE html>
...
<body>
    <form id="form1" runat="server">
        <table width="98%" align="center" class="m_title">
            ...
            <tr>
                <td class="t_r">标签编号：</td>
                <td>
                    <asp:TextBox ID="txtBQBH" runat="server" CssClass="m_txt" Width="150px"></asp:TextBox>
                </td>
                <td class="t_r">打印状态：</td>
                <td>
                    <asp:DropDownList ID="ddlPrintState" runat="server" CssClass="m_txt" Width="150px">
                        <asp:ListItem Value="0">--全部--</asp:ListItem>
                        <asp:ListItem Value="1">未打印</asp:ListItem>
                        <asp:ListItem Value="2">已打印</asp:ListItem>
                    </asp:DropDownList>
                </td>
            </tr>
        </table>
        ...
        <asp:DataGrid ID="JustAppInfo_List" runat="server" AutoGenerateColumns="False" CssClass="m_dg1"
            ...
            <Columns>
                ...
                <asp:BoundColumn HeaderText="标签编号" HeaderStyle-Width="100px">
                    <ItemStyle Font-Underline="False" Wrap="False" HorizontalAlign="Left" />
                    <HeaderStyle Font-Underline="False" Wrap="False" />
                </asp:BoundColumn>
                <asp:BoundColumn HeaderText="发证日期" HeaderStyle-Width="100px" DataField="FReportDate" DataFormatString="{0:yyyy-MM-dd}">
                    <ItemStyle Font-Underline="False" Wrap="False" HorizontalAlign="Left" />
                    <HeaderStyle Font-Underline="False" Wrap="False" />
                </asp:BoundColumn>
                <asp:BoundColumn HeaderText="有效期至" HeaderStyle-Width="100px" DataField="FTime" DataFormatString="{0:yyyy-MM-dd}">
                    <ItemStyle Font-Underline="False" Wrap="False" HorizontalAlign="Left" />
                    <HeaderStyle Font-Underline="False" Wrap="False" />
                </asp:BoundColumn>
                ...
                <asp:BoundColumn HeaderText="打印状态" HeaderStyle-Width="80px">
                    <ItemStyle Font-Underline="False" Wrap="False" HorizontalAlign="Left" />
                    <HeaderStyle Font-Underline="False" Wrap="False" />
                </asp:BoundColumn>
