<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GFTwoAuditList.aspx.cs" Inherits="Government_AppMain_GFTwoAuditList" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function app(url) {
            ...
            obj.name = '';
            obj.id = tmpVal;
            ShowWindow(url + '?ftype=15&FLinkId=' + tmpVal + '&fSubFlowId=' + fsubid, 700, 600, obj);
            return false
        }

        function appExpert() {
            var tmpVal = ''; var cou = 0;
            var chkColl = document.getElementsByTagName("input");
            for (var i = 0; i < chkColl.length; i++) {
                if (chkColl[i].type == "checkbox" && chkColl[i].id.indexOf("CheckItem") > -1) {
                    if (!chkColl[i].disabled && chkColl[i].checked == true) {
            ...
            obj.name = '';
            obj.id = tmpVal;
            ShowWindow(url + '?1=1', 700, 600, obj);
        }
    </script>
</head>
<body>
    <form id="form1" runat="server">
        <table align="center" class="m_title" style="width: 98%;">
            <tr>
                <th colspan="7">
                    <asp:Literal ID="lPostion" runat="server">工法复审</asp:Literal>
                </th>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="7" style="text-align: right;">&nbsp;公示时间：                
                    <asp:TextBox ID="tStime" runat="server" Width="150px" onfocus="WdatePicker()" CssClass="m_txt"></asp:TextBox>
                    至<asp:TextBox ID="tEtime" Width="150px" runat="server" onfocus="WdatePicker()" CssClass="m_txt"></asp:TextBox>
                    &nbsp;&nbsp;批次：<asp:DropDownList ID="ddBatchTime" runat="server" CssClass="m_txt" Width="100px">
                    </asp:DropDownList>
                    &nbsp;<asp:Button ID="btnPCTime" runat="server" CssClass="m_btn_w2" OnClick="btnPCTime_Click"
                        Text="设定" />
                    &nbsp;<asp:Button ID="btnCancel" runat="server" CssClass="m_btn_w2" OnClick="btnCancel_Click"
                        Text="取消" />
                </td>
            </tr>
        </table>
        <table width="98%" align="center" class="m_bar">
            <tr>
                ...
                <td class="t_r">
                    ...
                    &nbsp;<asp:Button ID="btnBackNext" Visible="false" runat="server" CssClass="m_btn_w2" Text="打回" OnClick="btnBackNext_Click" />
                    &nbsp;<asp:Button ID="btnExpert" runat="server" CssClass="m_btn_w4" Text="专家选择" OnClientClick="return app('chooseExpert.aspx')" />
        ...
        <asp:DataGrid ID="JustAppInfo_List" runat="server" AutoGenerateColumns="False" CssClass="m_dg1"
            ...
            <Columns>
                ...
                <asp:BoundColumn HeaderText="本级状态" DataField="FStatedesc">
                    <ItemStyle Font-Underline="False" Wrap="False" HorizontalAlign="Left" />
                    <HeaderStyle Font-Underline="False" Wrap="False" />
                </asp:BoundColumn>
                ...
                <asp:BoundColumn HeaderText="公示开始时间" HeaderStyle-Width="100px" DataField="" DataFormatString="{0:yyyy-MM-dd}">
                    <ItemStyle Font-Underline="False" Wrap="False " HorizontalAlign="Left" />
                    <HeaderStyle Font-Underline="False" Wrap="False" />
                </asp:BoundColumn>
                <asp:BoundColumn HeaderText="公示结束时间" HeaderStyle-Width="100px" DataField="" DataFormatString="{0:yyyy-MM-dd}">
                    <ItemStyle Font-Underline="False" Wrap="False" HorizontalAlign="Left" />
                    <HeaderStyle Font-Underline="False" Wrap="False" />
                </asp:BoundColumn>
                <asp:BoundColumn HeaderText="批次" HeaderStyle-Width="100px" DataField="">
                    <ItemStyle Font-Underline="False" Wrap="False" HorizontalAlign="Left" />
                    <HeaderStyle Font-Underline="False" Wrap="False" />
                </asp:BoundColumn>
                <asp:BoundColumn HeaderText="专家意见" HeaderStyle-Width="100px">
                    <ItemStyle Font-Underline="False" Wrap="False" HorizontalAlign="Left" />
                    <HeaderStyle Font-Underline="False" Wrap="False" />
                </asp:BoundColumn>
