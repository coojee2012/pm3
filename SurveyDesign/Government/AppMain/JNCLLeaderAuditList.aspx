<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JNCLLeaderAuditList.aspx.cs" Inherits="Government_AppMain_JNCLLeaderAuditList" %>
<!DOCTYPE html>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function BackApp(url) {
            ...
            obj.name = '';
            obj.id = tmpVal;
            ShowWindow(url + '?ftype=20&FLinkId=' + tmpVal + '&fSubFlowId=' + fsubid, 700, 600, obj);
            return false;
        }
        function app(url) {
            var items = $("#JustAppInfo_List").find(".checkboxItem > input[type=checkbox][checked]");
            ...
            ShowWindow(url + '?typeId=20&FLinkId=' + tmpVal + '&fSubFlowId=' + fsubid + "&YWBM=" + YWBM, 700, 600);
            return false;
        }
    </script>
</head>
    ...
    <form id="form1" runat="server">
        <table align="center" class="m_title" style="width: 98%;">
            ...
            <tr>
                ...
                <td colspan="3" rowspan="3" style="text-align: left; padding-right: 10px; width: 150px;">
