<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JNCLTwoAuditList.aspx.cs" Inherits="Government_AppMain_JNCLTwoAuditList" %>
<!DOCTYPE html>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function app(url) {
            ...
            ShowWindow(url + '?typeId=5&FLinkId=' + tmpVal + '&fSubFlowId=' + fsubid + "&YWBM=" + YWBM, 700, 600);
            return false;
        }
    </script>
</head>
    ...
    <form id="form1" runat="server">
        <table align="center" class="m_title" style="width: 98%;">
            ...
            <tr>
                ...
                <td colspan="3" rowspan="2" style="text-align: left; padding-right: 10px; width: 150px;">
        ...
        <asp:DataGrid ID="JustAppInfo_List" runat="server" AutoGenerateColumns="False" CssClass="m_dg1"
            ...
            <Columns>
                ...
                <asp:BoundColumn HeaderText="审核意见" HeaderStyle-Width="100px" DataField="FIdea" Visible="false">
                    <ItemStyle Font-Underline="False" Wrap="False" HorizontalAlign="Left" />
                    <HeaderStyle Font-Underline="False" Wrap="False" />
                </asp:BoundColumn>
                <asp:BoundColumn HeaderText="公示开始日期" HeaderStyle-Width="80px" DataField="">
                    <ItemStyle Font-Underline="False" Wrap="False" HorizontalAlign="Left" />
                    <HeaderStyle Font-Underline="False" Wrap="False" />
                </asp:BoundColumn>
                <asp:BoundColumn HeaderText="公示结束日期" HeaderStyle-Width="80px" DataField="">
                    <ItemStyle Font-Underline="False" Wrap="False" HorizontalAlign="Left" />
                    <HeaderStyle Font-Underline="False" Wrap="False" />
                </asp:BoundColumn>
