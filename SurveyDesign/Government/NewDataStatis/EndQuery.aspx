<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EndQuery.aspx.cs" Inherits="Government_AppMain_EndQuery" %>
...
<body onload="init()">
    ...
    <table width="98%" align="center" class="m_title">
        <tr>
            <th colspan="5">
                <asp:Literal ID="lPostion" runat="server">办结查询</asp:Literal>
            </th>
        </tr>
        <tr>
            <td class="t_r">
    ...
    <asp:DataGrid ID="JustAppInfo_List" runat="server" AutoGenerateColumns="False" CssClass="m_dg1"
        ...
        <Columns>
            ...
            <asp:BoundColumn HeaderText="上报时间" DataField="FEntName">
                <ItemStyle Font-Underline="False" Wrap="False" HorizontalAlign="left" />
                <HeaderStyle Font-Underline="False" Wrap="False" />
            </asp:BoundColumn>
            <asp:BoundColumn HeaderText="审核时间">
                <ItemStyle Font-Underline="False" Wrap="False" CssClass="padLeft" />
                <HeaderStyle Font-Underline="False" Wrap="False" />
            </asp:BoundColumn>
