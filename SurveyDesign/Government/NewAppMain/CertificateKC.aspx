<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CertificateKC.aspx.cs" Inherits="Government_NewAppMain_CertificateKC" %>
    ...
    <asp:DataGrid ID="DG_List" runat="server" CssClass="m_dg1" Width="98%" HorizontalAlign="Center"
        ...
        <Columns>
            ...
            <asp:TemplateColumn HeaderText="工程名称">
                ...
                <ItemTemplate>
                    <a href='javascript:showAddWindow("../../kcsjsgt/ApplySGTSJWJSCWTSL/ApplyBaseInfo.aspx?FDataID=<%#Eval("FLinkId") %>",800,700);'>
                        <%#Eval("FPrjName")%>
                    </a>
