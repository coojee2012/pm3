<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CCBLJJAuditInfo.aspx.cs" Inherits="Government_AppSGXKZGL_CCBLJJAuditInfo" %>
    ...
    <form id="form1" runat="server">
        ...
        <tr>
            ...
            <td>
                ...
                &nbsp;&nbsp;<input id="seeLockPerson" type="button" runat="server" style="margin-left: 5px;" class="m_btn_w6" onclick="LockPersonList();"  value="查看锁定人员"   /></td>
            <td class="t_r">
                工程类别：
            </td>
            <td>
