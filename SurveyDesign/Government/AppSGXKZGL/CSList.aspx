<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CSList.aspx.cs" Inherits="Government_AppSGXKZGL_CSList" %>
<%@ Register Src="../../common/govdeptid2.ascx" TagName="govdeptid" TagPrefix="uc1" %>
<%@ Register Src="../../Common/pager.ascx" TagName="pager" TagPrefix="uc1" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>施工许可证管理初审</title>
    ...
    <script type="text/javascript">
        ...
        function app(url) {
            ...
            if (fManageTypeId == 11223) {
                url = "CCBLCSAuditInfo.aspx";
            }
            if (fManageTypeId == 11224) {
                url = "YQBLCSAuditInfo.aspx";
            }
            if (fManageTypeId == 11225) {
                url = "BGBLCSAuditInfo.aspx";
            }
...
<body>
    ...
    <table width="98%" align="center" class="m_title">
        <tr>
            <th colspan="7">
                <asp:Literal ID="lPostion" runat="server">施工许可证管理初审</asp:Literal>
            </th>
        </tr>
        <tr>
            <td class="t_r">
    ...
    <table width="98%" align="center" class="m_bar">
        <tr>
            ...
            <td class="t_r">
                <asp:Button ID="btnAccept" runat="server" CssClass="m_btn_w2" Text="审核" OnClientClick="return app('CCBLCSAuditInfo.aspx')" />
