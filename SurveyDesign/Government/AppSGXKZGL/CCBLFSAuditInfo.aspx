<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CCBLFSAuditInfo.aspx.cs" Inherits="Government_AppSGXKZGL_CCBLFSAuditInfo" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <webdiyer:AspNetPager ID="Pager_YZ" runat="server" AlwaysShow="True" CssClass="pages"
            CurrentPageButtonClass="cpb" CustomInfoClass="pagescount" CustomInfoHTML="&lt;b&gt;共%RecordCount%条 第%CurrentPageIndex%/%PageCount%页&lt;/b&gt;"
            CustomInfoSectionWidth="150px" FirstPageText="首页" LastPageText="尾页" layouttype="Table"
            NextPageText="下一页" NumericButtonCount="6" OnPageChanging="Pager_YZ_PageChanging"
            pageindexboxtype="TextBox" PageSize="3" PrevPageText="上一页" ShowCustomInfoSection="Right"
            showpageindexbox="Always" SubmitButtonText="Go" textafterpageindexbox="页" textbeforepageindexbox="转到">
        </webdiyer:AspNetPager>
        </div>
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server" RenderMode="Inline">
                <ContentTemplate>
                 ...
                 <asp:Button ID="btnSave" runat="server" CssClass="m_btn_w2" Text="保存" OnClick="btnSave_Click" />
                    &nbsp;&nbsp;<asp:Button id="btnUPFS" runat="server" class="m_btn_w4"  type="button" Text="提交打证" OnClick="btnUPFS_Click" />
