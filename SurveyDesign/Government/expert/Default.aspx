<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="Government_expert_Default" %>
        ...
        <table height="95%" width="98%" align="center">
            ...
            <tr>
                ...
                <td class="wxts_m">
                    ...
                    <div class="wxts_msg" style="display:none;">
                    ...
                    <div class="wxts_Ts">
                        待审批业务有：<font color="black"><asp:Literal ID="lit_App" runat="server"></asp:Literal></font>
                        ...
                        <asp:DataGrid ID="App_List" runat="server" AutoGenerateColumns="False" CssClass="m_dg1"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateColumn HeaderText="工法名称" HeaderStyle-Width="200px">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="btnItemSee" runat="server" CommandName="See" Text='<%#Eval("GFMC") %>'>
                                        </asp:LinkButton>
                                ...
                                <asp:BoundColumn HeaderText="类别" DataField="FListName" HeaderStyle-Width="90px"></asp:BoundColumn>
                                ...
                                <asp:BoundColumn HeaderText="状态" HeaderStyle-Width="80px"></asp:BoundColumn>
                                <asp:BoundColumn HeaderText="办理结果" HeaderStyle-Width="80px"></asp:BoundColumn>
