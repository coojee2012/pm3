<%@ Page Language="C#" AutoEventWireup="true" CodeFile="XMZGAuditList.aspx.cs" Inherits="Government_AppWY_XMZGAuditList" %>
    ...
    <script type="text/javascript">
        ...
        function app() {
            ...
            if (tmpVal.length > 1) {
                ...
                alert("请选择一条项目失去申请信息审核！");
                return false;
            }
            if (cou > 1 || cou <= 0) {
                alert("只能选择一条项目失去申请信息审核！");
                return false;
            }
            if (fMeasure != '0') {
                alert("暂时不可处理！");
            ...
            obj.name = '';
            obj.id = tmpVal;
            ShowWindow('SHAuditInfo.aspx?ftype=5&FLinkId=' + tmpVal + '&fSubFlowId=' + fsubid + '&fBaseInfoId=' + fbaseInfoid
                + '&fpid=' + fpid
        ...
        function sh() {
            var ret = window.showModalDialog('SHAuditInfo.aspx' + '?rid=' + Math.random(), '', 'dialogWidth:965px; dialogHeight:441px; center:yes; status:no; help:no;');
...
<body>
    <form id="form1" runat="server">
        <table width="98%" align="center" class="m_title">
            <tr>
                <th colspan="7">
                    <asp:Literal ID="lPostion" runat="server">项目在管申请</asp:Literal>
                </th>
            </tr>
            <tr>
                <td class="t_r">项目名称：
                ...
                <td colspan="2" rowspan="4" style="text-align: center; padding-right: 10px">
                    <asp:Button ID="btnQuery" runat="server" CssClass="m_btn_w2" Text="查询" />
                    &nbsp;
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="ddlState" runat="server" CssClass="m_txt" Width="169px">
                        ...
                        <asp:ListItem Value="0" Selected="True">未初审</asp:ListItem>
                        <asp:ListItem Value="1">初审已通过</asp:ListItem>
                        <asp:ListItem Value="3">初审未通过</asp:ListItem>
