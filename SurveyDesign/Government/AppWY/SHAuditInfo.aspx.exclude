<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SHAuditInfo.aspx.cs" Inherits="Government_AppWY_SHAuditInfo" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        function openWinNew(Url) {
            var newopen = window.open(Url, "", ",,,toolbar =no, menubar=no, scrollbars=yes, location=no, status=no");
            if (newopen) {
                newopen.moveTo(0, 0);
...
<body>
    <form id="form1" runat="server">
        ...
        <table width="95%" align="center" class="m_title">
            ...
            <td>
                <asp:TextBox ID="t_Fmanagetype" Enabled="false" runat="server" CssClass="m_txt" Width="195px"></asp:TextBox>
            </td>
            </tr>
            <%--<tr>
            <td class="t_r">
            ...
            <tr>
                <td>
                    <asp:DataGrid ID="DG_List" runat="server" AutoGenerateColumns="False" CssClass="m_dg1"
                        HorizontalAlign="Center" Style="margin-top: 7px"
                        Width="100%">
        ...
        <div style="text-align: center; margin-top: 2PX">
            ...
            &nbsp;&nbsp;<asp:Button ID="btnUPCS" runat="server" class="m_btn_w4" type="button" Text="审核" OnClick="btnUPCS_Click" Height="21px" />
            <%--&nbsp;&nbsp;<asp:Button ID="bthEndApp" runat="server" Text="不通过" class="m_btn_w6" />
            &nbsp;&nbsp;<asp:Button ID="btnBackToEnt" runat="server" Style="margin-left: 5px;" CssClass="m_btn_w2"
                Text="打回" />--%>
        ...
        <input id="Fappid" runat="server" type="hidden" />
        <input id="hidFManageTypeId" runat="server" type="hidden" />
    </form>
</body>
</html>
