<%@ Page Language="C#" AutoEventWireup="true" CodeFile="XMAuditList.aspx.cs" Inherits="Government_AppWY_XMAuditList" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function app() {
            ...
            obj.name = '';
            obj.id = tmpVal;
            var ref = ShowWindow('SHAuditInfo.aspx?fManagetypeid=' + fManagetypeid + '&ftype=5&FLinkId=' + tmpVal + '&fSubFlowId=' + fsubid + '&fBaseInfoId=' + fbaseInfoid
                + '&fpid=' + fpid
                + '&ferid=' + ferid, 965, 441, obj);
            if (ref == "ok") {
                location.reload();
            }
            //window.showModalDialog('SHAuditInfo.aspx?ftype=5&FLinkId=' + tmpVal + '&fSubFlowId=' + fsubid + '&fBaseInfoId=' + fbaseInfoid
            //    + '&fpid=' + fpid
            //    + '&ferid=' + ferid + '?rid=' + Math.random(), '', 'dialogWidth:965px; dialogHeight:441px; center:yes; status:no; help:no;');
            return false;
        }
...
<body>
    <form id="form1" runat="server">
        <table width="98%" align="center" class="m_title">
            <tr>
                <th colspan="7">
                    <asp:Literal ID="lPostion" runat="server">项目审核</asp:Literal>
                </th>
            </tr>
            <tr>
                <td class="t_r">项目名称：
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="ddrYWLX" runat="server" CssClass="m_txt" Width="169px">
                        <asp:ListItem Selected="True" Value="-1">--请选择--</asp:ListItem>
                        <asp:ListItem Value="14401">项目在管申请</asp:ListItem>
                        <asp:ListItem Value="14402">项目失去申请</asp:ListItem>
                        <asp:ListItem Value="14403">项目变更备案</asp:ListItem>
                        <asp:ListItem Value="14404">项目合同备案</asp:ListItem>
                        <asp:ListItem Value="14405">项目业委会备案</asp:ListItem>
                        <asp:ListItem Value="14406">项目财务年报</asp:ListItem>
                    </asp:DropDownList>
        ...
        <table width="98%" align="center" class="m_bar">
            <tr>
                <td class="m_bar_l"></td>
                <td class="t_r">
                    <asp:Button ID="btnCheck" runat="server" CssClass="m_btn_w2" Text="审核" OnClientClick="app()" />
        ...
        <asp:DataGrid ID="JustAppInfo_List" runat="server" AutoGenerateColumns="False" CssClass="m_dg1"
            HorizontalAlign="Center" Width="98%" OnItemCommand="JustAppInfo_List_ItemCommand" OnItemDataBound="JustAppInfo_List_ItemDataBound">
            ...
            <Columns>
                ...
                <%--<asp:BoundColumn HeaderText="项目名称" DataField="XMMC">
                ...
                <asp:BoundColumn HeaderText="业务类型" DataField="FName">
                    <ItemStyle Wrap="False" HorizontalAlign="Left" CssClass="padLeft" />
                    <HeaderStyle Font-Underline="False" Wrap="False" />
                </asp:BoundColumn>
                <asp:BoundColumn HeaderText="项目地址" DataField="XMDZ">
                    <ItemStyle Wrap="False" HorizontalAlign="Left" CssClass="padLeft" />
                    <HeaderStyle Font-Underline="False" Wrap="False" />
                </asp:BoundColumn>
                <asp:BoundColumn HeaderText="企业名称" DataField="FBaseName">
                    <ItemStyle Wrap="False" HorizontalAlign="Left" CssClass="padLeft" />
                    <HeaderStyle Font-Underline="False" Wrap="False" />
                </asp:BoundColumn>
                ...
                <asp:BoundColumn HeaderText="FAppFid" DataField="AppFid" Visible="False">
                    <ItemStyle Font-Underline="False" Wrap="False" />
                    <HeaderStyle Font-Underline="False" Wrap="False" />
                </asp:BoundColumn>
                <asp:BoundColumn HeaderText="FLinkId" DataField="FLinkId" Visible="False">
                    <ItemStyle Font-Underline="False" Wrap="False" />
                    <HeaderStyle Font-Underline="False" Wrap="False" />
                </asp:BoundColumn>
                <asp:BoundColumn HeaderText="XMSD" DataField="XMSD" Visible="False"></asp:BoundColumn>
                <asp:BoundColumn HeaderText="FManageTypeId" DataField="FManageTypeId" Visible="False"></asp:BoundColumn>
            </Columns>
