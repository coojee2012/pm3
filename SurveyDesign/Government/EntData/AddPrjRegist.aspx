...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function addPrjItem() {
            ...
            showAddWindow('AddPrjItem.aspx?fprjId=' + fid, 800, 450);
        }
    </script>
    ...
    <div id="divSetup2" runat="server">
        ...
        <table class="m_table" width="98%" align="center">
            ...
            <tr>
                ...
                <td colspan="1">
                    <asp:TextBox ID="t_FLevel" runat="server" CssClass="m_txt" Width="70px" MaxLength="25"
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="t_FLinkMan" runat="server" CssClass="m_txt" MaxLength="20" Width="90px"></asp:TextBox>
                    <tt>*</tt>
                </td>
                <td class="t_r t_bg">
                    联系人手机：
