<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SCEntList.aspx.cs" Inherits="Government_EntData_SCEntList" %>
...
<body style="margin-left: 5px; margin-right: 5px;">
    ...
    <asp:DataGrid ID="Ent_List" runat="server" AutoGenerateColumns="False" CssClass="m_dg1"
        ...
        <Columns>
            ...
            <asp:BoundColumn DataField="FUpDeptId" HeaderText="所属地区"></asp:BoundColumn>
            ...
            <asp:BoundColumn DataField="SYFS" HeaderText="当前分数"></asp:BoundColumn>
