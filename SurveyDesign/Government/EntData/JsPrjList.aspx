<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JsPrjList.aspx.cs" Inherits="Government_EntData_JsPrjList" %>
...
<body>
    ...
    <asp:DataGrid ID="dg_List" runat="server" AutoGenerateColumns="False" CssClass="m_dg1"
        ...
        <Columns>
            ...
            <asp:BoundColumn DataField="FAllAddress" HeaderText="工程地点"></asp:BoundColumn>
            <asp:BoundColumn DataField="FType" HeaderText="工程类别"></asp:BoundColumn>
            <asp:BoundColumn DataField="FAllMoney" HeaderText="总投资(万元)"></asp:BoundColumn>
            <asp:ButtonColumn HeaderText="项目办理情况"></asp:ButtonColumn>
