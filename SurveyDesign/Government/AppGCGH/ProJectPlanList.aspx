<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProJectPlanList.aspx.cs" Inherits="JSDW_ApplyGCGH_AuditMain_ProJectPlanList" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function app(url) {
            ...
            var url = url + '?typeId=1&GC_Id=' + GC_Id + '&fSubFlowId=' + fsubid;
            if (audit == "1")//已受理
                url = "PrintAccept.aspx?GC_Id=" + GC_Id + "&fSubFlowId=" + fsubid + "&audit=1";
            else if (audit == "0")
                url = "PrintAccept.aspx?GC_Id=" + GC_Id + "&fSubFlowId=" + fsubid + "&audit=0";
