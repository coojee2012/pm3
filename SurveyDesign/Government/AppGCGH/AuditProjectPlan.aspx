...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function Audit() {
            ...
            if (type == "5") {
                var GCGHBH = $("#txtGCGHXKZBH").val();
                var HFJG = $("#txtHFJG").val();
                var HFRQ = $("#txtHFRQ").val();
                if ($.trim(GCGHBH).length == 0) {
                    alert("工程规划许可证编号不能为空");
                    return false;
        ...
        $(function () {
            ...
            $("#btnAccept,#btnSaveYJ").click(function () {
                if (Save()) {
                    return Audit();
                }
                return false;
    ...
    <div>
        ...
        <table width="98%" align="center" class="m_title">
            ...
            <tr>
             ...
             <tr class="Table1">
                 <td class="t_r">工程规划许可证编号</td>
                <td colspan="5">建字第（<asp:TextBox ID="txtGCGHXKZBH" runat="server" Width="200"></asp:TextBox>）号</td>
            </tr>
            <tr class="Table1">
                <td class="t_r">核发机关</td>
                <td><asp:TextBox ID="txtHFJG" runat="server"></asp:TextBox></td>
                <td class="t_r">核发日期</td>
                <td colspan="3"><asp:TextBox ID="txtHFRQ" runat="server" CssClass="m_txt Wdate" onfocus="WdatePicker({skin:'whyGreen' })"></asp:TextBox></td>
            </tr>
            <tr>
        ...
        <div style="text-align: center; margin-top: 2PX">
            ...
            &nbsp;&nbsp;<asp:Button ID="btnAccept" runat="server"  class="m_btn_w4" Text="办结" OnClick="btnAccept_Click" />
            &nbsp;&nbsp;<asp:Button ID="btnNoAccept" runat="server" class="m_btn_w4" Visible="false" Text="不予受理" 
                onclick="btnNoAccept_Click" />
            &nbsp;&nbsp;<asp:Button ID="btnBack" runat="server" Text="打回企业"  OnClientClick="return confirm('确认打回？')" Visible="false" CssClass="m_btn_w4" 
