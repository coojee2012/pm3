...
<body>
    <form id="form1" runat="server">
        ...
        <table width="95%" align="center" class="m_title">
            <tr>
                <th colspan="4">
                    <asp:Label ID="lbTitle" runat="server" Text="停工处理">停工处理</asp:Label>
                </th>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="t_SHR" runat="server" CssClass="m_txt" Width="195px"></asp:TextBox>
                </td>
                <td class="t_r">审核单位：
                </td>
                <td>
                    <asp:TextBox ID="t_SHDW" runat="server" CssClass="m_txt" Width="195px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <asp:TextBox ID="t_SHRQ" onfocus="WdatePicker()" runat="server" CssClass="m_txt" Width="400px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="t_r"></td>
                ...
                <td class="t_r">
                    <asp:UpdatePanel ID="up_Main" runat="server" RenderMode="Inline">
                        <ContentTemplate>
                            <asp:Button ID="btnSave" runat="server" Text="通过" OnClick="btnSave_Click" CssClass="m_btn_w2" />
