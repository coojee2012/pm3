...
public partial class Government_AppTFGGL_FGList : govBasePage
{
    ...
    private void ShowInfo()
    {
        ...
        sb.Append(" case  when a.FYJSJFGRQ <= GETDATE() then '已复工' else '已停工' end as FSGZT  ");
