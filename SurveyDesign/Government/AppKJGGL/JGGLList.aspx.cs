...
public partial class Government_AppKJGGL_JGGLList:govBasePage
{
    ...
    private void ShowInfo()
    {
        ...
        sb.Append(" case qa.SJEndDate when qa.SJEndDate then '已竣工('+ CONVERT(varchar(4), YEAR( qa.SJEndDate))+'-'+CONVERT(varchar(4), MONTH( qa.SJEndDate))+'-'+CONVERT(varchar(4), DAY( qa.SJEndDate))+')' ");
