<%@ Page Language="C#" AutoEventWireup="true" CodeFile="KGGLList.aspx.cs" Inherits="Government_AppKJGGL_KGGLList" %>
...
<body>
    ...
    <table width="98%" align="center" class="m_title">
        <tr>
            <th colspan="7">
                <asp:Literal ID="lPostion" runat="server">开工管理</asp:Literal>
            </th>
        </tr>
        <tr>
            <td class="t_r">
            ...
            <ContentTemplate>
                <asp:DataGrid ID="JustAppInfo_List" runat="server" AutoGenerateColumns="False" CssClass="m_dg1"
                        ...
                        <Columns>
                            ...
                            <asp:BoundColumn HeaderText="开工状态" DataField="KGState" >
