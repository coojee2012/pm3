...
public partial class Government_AppKJGGL_KGSZ : System.Web.UI.Page
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            using (SqlConnection conn = new SqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings["dbCenter"].ConnectionString))
            {
                ...
                string sql = "UPDATE TC_SGXKZ_PrjInfo SET SJStartDate = '" + t_SJStartDate.Text + " 00:00:00' WHERE FAppId='" + t_fLinkId.Value + "'";
