<%@ Page Language="C#" AutoEventWireup="true" CodeFile="XZAcceptList.aspx.cs" Inherits="JSDW_ApplyXZYJS_AuditMain_XZAcceptList" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function app(url) {
            ...
            url = url + '?ftype=1&YJS_ID=' + YJS_ID + '&fSubFlowId=' + fsubid;
            if (audit == "1")//已受理
                url = "PrintAccept.aspx?YWBM=" + YJS_ID + "&fSubFlowId=" + fsubid + "&audit=1";
            else if (audit == "0")
                url = "PrintAccept.aspx?YWBM=" + YJS_ID + "&fSubFlowId=" + fsubid + "&audit=0";
        ...
        function BackApp(url)
        {
            ...
            var fsubid = $(items[0]).parent("span").attr("fSubFlowId");
            showAddWindow(url + '?ftype=1&FLinkId=' + tmpVal + '&fSubFlowId=' + fsubid, 700, 600);
            return true;
        }
    </script>
    ...
    <form id="form1" runat="server">
        ...
        <table width="98%" align="center" class="m_bar">
            <tr>
                ...
                <input type="button" value="接件" class="m_btn_w2" onclick="return app('AcceptJieJian.aspx')" />
    ...
    <asp:DataGrid ID="DG_List" runat="server" HorizontalAlign="Center" Width="98%" CssClass="m_dg1"
        ...
        <Columns>
           <asp:TemplateColumn>
                ...
                <asp:BoundColumn DataField="JSDZ" HeaderText="项目地址"></asp:BoundColumn>
