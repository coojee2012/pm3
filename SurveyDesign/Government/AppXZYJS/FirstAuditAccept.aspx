<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FirstAuditAccept.aspx.cs" Inherits="JSDW_ApplyXZYJS_AuditMain_FirstAuditAccept" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        function app(url) {
            ...
            //var YJS_ID = $(items[0]).parent("span").attr("name");
            //var fsubid = $(items[0]).parent("span").attr("fSubFlowId");
            ////showAddWindow(url + '?YJS_ID=' + YJS_ID, 700, 600);
            //showAddWindow(url + '?typeId=10&YJS_ID=' + YJS_ID + '&fSubFlowId=' + fsubid, 700, 600);
            var YJS_ID = $(items[0]).parent("span").attr("YJS_ID");
            var YWBM = $(items[0]).parent("span").attr("name");
            var fsubid = $(items[0]).parent("span").attr("fSubFlowId");
            showAddWindow(url + '?typeId=10&YJS_ID=' + YJS_ID + '&fSubFlowId=' + fsubid + '&YWBM=' + YWBM, 900, 600);
            return true;
        }
        function BackApp(url) {
            ...
            var fsubid = $(items[0]).parent("span").attr("fSubFlowId");
            showAddWindow(url + '?ftype=10&FLinkId=' + tmpVal + '&fSubFlowId=' + fsubid, 700, 600);
            return true;
        }
    </script>
</head>
    ...
    <form id="form1" runat="server">
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="dbSeeState" runat="server" CssClass="m_txt" Width="150px">
                        ...
                        <asp:ListItem Value="0" Selected="True">待初审</asp:ListItem>
        ...
        <asp:DataGrid ID="JustAppInfo_List" runat="server" AutoGenerateColumns="False" CssClass="m_dg1"
            ...
            <Columns>
                ...
                <asp:BoundColumn HeaderText="项目名称" DataField="FEmpName" HeaderStyle-Width="200px">
                    <ItemStyle Wrap="False" HorizontalAlign="Left" CssClass="padLeft" />
                    <HeaderStyle Font-Underline="False" Wrap="False" />
                </asp:BoundColumn>
                <asp:BoundColumn HeaderText="项目地址" HeaderStyle-Width="100px" DataField="JSDZ">
                    <ItemStyle Font-Underline="False" Wrap="False" HorizontalAlign="Left" />
                    <HeaderStyle Font-Underline="False" Wrap="False" />
                </asp:BoundColumn>
                <asp:BoundColumn DataField="JSDWMC" HeaderText="建设单位" HeaderStyle-Width="100"></asp:BoundColumn>
                <asp:BoundColumn DataField="AuditType" HeaderText="工程类型" HeaderStyle-Width="100"></asp:BoundColumn>
                <asp:BoundColumn HeaderText="所属地" HeaderStyle-Width="80px" DataField="XMSDMC">
                    <ItemStyle Font-Underline="False" Wrap="False" HorizontalAlign="Left" />
                    <HeaderStyle Font-Underline="False" Wrap="False" />
                </asp:BoundColumn>
                <asp:BoundColumn HeaderText="申请日期" HeaderStyle-Width="100px" DataField="FReportDate" DataFormatString="{0:yyyy-MM-dd}">
                    <ItemStyle Font-Underline="False" Wrap="False" HorizontalAlign="Left" />
                    <HeaderStyle Font-Underline="False" Wrap="False" />
                </asp:BoundColumn>
                <asp:BoundColumn HeaderText="业务状态" HeaderStyle-Width="100px"  DataField="FStatedesc">
                    <ItemStyle Font-Underline="False" Wrap="False" HorizontalAlign="Left" />
                    <HeaderStyle Font-Underline="False" Wrap="False" />
                </asp:BoundColumn>
