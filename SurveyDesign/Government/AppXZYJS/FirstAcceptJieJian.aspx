...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function Audit() {
            var type = $("#hfType").val();
            if (type == "5") {
                var XZYJSBH = $("#txtXZYJSBH").val();
                var HFJG = $("#txtHFJG").val();
                var HFRQ = $("#txtHFRQ").val();
                if ($.trim(XZYJSBH).length == 0) {
                    alert("选址意见书编号不能为空");
                    return false;
...
<body id="body1">
    ...
    <div>
        <table width="98%" align="center" id="CLQQ" class="m_title">
            ...
            <tr>
                ...
                <td class="t_r t_bg" style="width:50px;text-align: center;"><input type="checkbox" checked="checked" />是否具备</td>
    ...
    <%--    <table width="98%" align="center" class="m_title" id="Table1">
        ...
        <table width="98%" align="center" class="m_title">
            ...
            <tr class="Table1">
                <td class="t_r">选址意见书编号</td>
                <td colspan="5">选字第（<asp:TextBox ID="txtXZYJSBH" runat="server" Width="200"></asp:TextBox>）号</td>
            </tr>
            <tr class="Table1">
        ...
        <asp:Button ID="btnSave" runat="server" CssClass="m_btn_w2" Text="保存" OnClientClick="return Audit()" OnClick="btnSave_Click" />
            <asp:Button ID="btnAccept" runat="server" CssClass="m_btn_w4" Text="上报审批" OnClick="btnAccept_Click" OnClientClick="return Audit()" />
