...
public partial class JSDW_ApplyXZYJS_AuditMain_FirstAuditAccept : System.Web.UI.Page
{
    ...
    protected void JustAppInfo_List_ItemDataBound(object sender, DataGridItemEventArgs e)
    {
        if (e.Item.ItemIndex > -1)
        {
            ...
            if (fMeasure == "0")
            {
                ...
                //sUrl = "../IDeaBookApply.aspx?YJS_GUID=" + Id;
               // sUrl = "AcceptInfoGF.aspx?ftype=10&FLinkId=" + FLinkId + "&fSubFlowId=" + fSubFlowId;
                ...
                e.Item.Cells[9].Text = "未初审";
                fColor = "#ff9900";
            }
            else if (fMeasure == "5" && fFResult == "1")
            {
                e.Item.Cells[9].Text = "初审已通过";
                box.Enabled = false;
                fColor = "#339933";
            }
            else if (fMeasure == "5" && fFResult == "3")
            {
                e.Item.Cells[9].Text = "初审未通过";
                box.Enabled = false;
                fColor = "#ff0000";
            }
