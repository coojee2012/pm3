<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PrintAccept.aspx.cs" Inherits="Government_AppXZYJS_PrintAccept" %>
...
<body id="body1">
    ...
    <table width="98%" align="center" class="m_title" id="m_title">
        ...
        <tr>
            ...
            <td colspan="3"><asp:TextBox ID="txtJSDWMC" Enabled=false runat="server" Width="300"></asp:TextBox></td>
        </tr>
        <tr>
             <td class="t_r t_bg">建设地址</td>
            <td colspan="3"><asp:TextBox ID="txtJSDWDZ" Enabled=false runat="server" Width="300"></asp:TextBox></td>
        </tr>
        <tr>
            <td class="t_r t_bg">联系人</td>
            <td><asp:TextBox ID="txtLXR" Enabled=false runat="server"></asp:TextBox></td>
            <td class="t_r t_bg">联系电话</td>
            <td><asp:TextBox ID="txtLXDH" Enabled=false runat="server"></asp:TextBox></td>
        </tr>
    </table>
    ...
    <%--    <table width="98%" align="center" class="m_title" id="Table1">
            <tr>
                <td class="t_r t_bg">选址意见书编号</td>
                <td colspan="3" class="t_bg">选字第（<asp:TextBox ID="txtXZYJSBH" runat="server" Width="200"></asp:TextBox>）号</td>
            </tr>
            <tr>
                <td class="t_r t_bg">核发机关</td>
                <td><asp:TextBox ID="txtHFJG" runat="server"></asp:TextBox></td>
                <td class="t_r t_bg">核发日期</td>
        ...
        <table width="98%" align="center" class="m_title">
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="dResult" Enabled="false" runat="server" CssClass="m_txt">
                ...
                <td>
                    <asp:TextBox ID="t_FAppDate" Enabled="false" runat="server" CssClass="m_txt" onblur="isDate(this);"
            ...
            <tr>
                ...
                <td colspan="3">
                    <asp:TextBox ID="t_FAppIdea" Enabled="false" runat="server" CssClass="m_txt" Height="99px" TextMode="MultiLine"
