    ...
    <div>
        ...
        <table class="m_table" width="98%" align="center">
            <tr>
                ...
                <td colspan="3">
                    <asp:TextBox ID="txtGCMC" runat="server" CssClass="m_txt" Text="四川元丰建设项目管理有限公司" Enabled="false" Width="500px"></asp:TextBox><asp:Button ID="btnEnt" runat="server" CssClass="m_btn_w2" Text="选取" OnClientClick="if(!SelectEnt(this)){return false;}"
