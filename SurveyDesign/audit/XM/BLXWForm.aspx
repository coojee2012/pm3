    ...
    <form id="form1" runat="server">
        ...
        <div>
            ...
            <table class="m_table" width="98%" align="center">
                <tr>
                    <td class="t_r t_bg" colspan="2">处罚对象
                    </td>
                    <td colspan="3">
                        <asp:TextBox ID="txtGCMC" runat="server" CssClass="m_txt" Enabled="false" Width="500px"></asp:TextBox><asp:Button ID="btnEnt" runat="server" CssClass="m_btn_w2" Text="选取" OnClientClick="if(!SelectEnt(this)){return false;}"
                            OnClick="btnEnt_Click" /><tt>*</tt>
                    </td>
                </tr>
                <tr>
                    <td class="t_r t_bg" rowspan="8">被记录相关信息：
                    </td>
            ...
            <table width="98%" align="center" class="m_bar">
                <tr>
                    <td width="20%" align="left" style="padding-left: 10px;">违反规定
                    </td>
            ...
            <table width="98%" align="center" class="m_title">
                <tr id="firstFile">
                    <td class="t_r" style="text-align: center;">行为代码</td>
                    <td class="t_r" style="text-align: center;">行为类别</td>
                    <td class="t_r" style="text-align: center;">行为描述</td>
                    <td class="t_r" style="text-align: center;">扣分值</td>
                    <td class="t_r" style="text-align: center;">删除</td>
                </tr>
            </table>
            <table class="m_table" width="98%" align="center" style="margin-top: 10px;">
                <tr>
                    <td class="t_r t_bg">处罚单位
                    </td>
                    <td>
                        <asp:TextBox ID="TextBox7" runat="server" CssClass="m_txt" Width="200px"></asp:TextBox>
                    </td>
                    <td class="t_r t_bg">处罚时间
                    </td>
                    <td>
            ...
            <table width="98%" align="center" class="m_bar">
                <tr>
                    <td width="20%" align="left" style="padding-left: 10px;">附件
                    </td>
                    <td class="t_r" style="" width="auto">
            ...
            <table width="98%" align="center" class="m_title">
                <tr id="Tr1">
                    ...
                    <td class="t_r" style="text-align: center;">上传日期</td>
                    <td class="t_r" style="text-align: center;">附件类型</td>
                    <td class="t_r" style="text-align: center;">删除</td>
                </tr>
            </table>
        </div>
