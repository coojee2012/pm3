<%@ Page Language="C#" AutoEventWireup="true" CodeFile="YLXWForm.aspx.cs" Inherits="Share_Main_YLXWForm" %>
    ...
    <div>
        ...
        <table class="m_table" width="98%" align="center">
            <tr>
                ...
                <td colspan="3">
                    <asp:TextBox ID="txtGCMC" runat="server" CssClass="m_txt required" Enabled=false Width="500px"></asp:TextBox>
            ...
            <tr>
                ...
                <td colspan="3">
                    <asp:TextBox ID="TextBox7" runat="server" CssClass="m_txt" Width="500px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="t_r t_bg">
                ...
                <td>
                    <asp:TextBox ID="TextBox8" runat="server" CssClass="m_txt" Width="200px"></asp:TextBox>
                </td>
                <td class="t_r t_bg">
                    获奖类别：
                </td>
                <td>
                    <asp:TextBox ID="TextBox1" runat="server" CssClass="m_txt" Width="200px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="t_r t_bg">
                ...
                <td colspan="3">
                    <asp:TextBox ID="TextBox2" runat="server" CssClass="m_txt" Width="500px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="t_r t_bg">
                ...
                <td>
                    <asp:TextBox ID="TextBox9" runat="server" CssClass="m_txt" Width="150px"></asp:TextBox>
                </td>
                <td class="t_r t_bg">
                    颁证（发文）机关：
                </td>
                <td>
                    <asp:TextBox ID="TextBox10" runat="server" CssClass="m_txt" Width="150px"></asp:TextBox>
                    颁证（发文）日期：
                    <asp:TextBox ID="TextBox11" runat="server" CssClass="m_txt Wdate" onfocus="WdatePicker({skin:'whyGreen' })" Width="150px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="t_r t_bg">
