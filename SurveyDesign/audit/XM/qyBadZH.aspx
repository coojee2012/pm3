<%@ Page Language="C#" AutoEventWireup="true" CodeFile="qyBadZH.aspx.cs" Inherits="audit_XM_qyBadZH" %>
    ...
    <form id="form1" runat="server">
        ...
        <asp:DataGrid ID="DG_List" runat="server" HorizontalAlign="Center" Width="98%" CssClass="m_dg1"
            ...
            <Columns>
                ...
                <asp:BoundColumn DataField="FNAME" HeaderText="不良行为类型" HeaderStyle-Width="100px">
                ...
                <asp:BoundColumn DataField="CFCS" HeaderText="处罚次数" HeaderStyle-Width="80px">
                    <ItemStyle HorizontalAlign="Left" />
                    <ItemStyle CssClass="t_l" Wrap="false" />
                </asp:BoundColumn>
