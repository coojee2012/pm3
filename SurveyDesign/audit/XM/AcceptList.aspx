<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AcceptList.aspx.cs" Inherits="Government_AppZLJDBA_AcceptList" %>
    ...
    <form id="form1" runat="server">
        ...
        <table width="98%" align="center" class="m_title">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtSJDW" runat="server" CssClass="m_txt" Width="169px"></asp:TextBox>
                </td>
                <td class="t_r">状&nbsp; 态：
                </td>
                <td>
            ...
            <ContentTemplate>
                <asp:DataGrid ID="JustAppInfo_List" runat="server" AutoGenerateColumns="False" CssClass="m_dg1"
                    ...
                    <Columns>
                        ...
                        <asp:BoundColumn HeaderText="设计单位" DataField="sjdw">
                            <ItemStyle Wrap="False" HorizontalAlign="Left" CssClass="padLeft" />
                            <HeaderStyle Font-Underline="False" Wrap="False" />
                        </asp:BoundColumn>
