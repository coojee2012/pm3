...
<head id="Head1" runat="server">
    ...
    <style type="text/css">
        /*上一级*/div.imagespacer { width: 120px; height: 136px; text-align: center; float: left; font: 10pt verdana; margin: 0px 10px; overflow: hidden; cursor: pointer; border: 1px solid #CCCCCC; }
        div.imagespacer:hover { border: 2px solid #CCCCCC; }
        div.imageholder { margin: 1px auto; padding: 0px; border: 1px solid #CCCCCC; width: 100px; height: 100px; }
        div.titleholder { font-family: ms sans serif, arial; font-size: 8pt; width: 100px; text-overflow: ellipsis; overflow: hidden; white-space: nowrap; }
        div.filesholder { margin: 0px; padding: 0px 5px 0px 5px; width: 20px; height: 20px; float: left; }
        div.filesholder img { width: 16px; height: 16px; margin-top: 2px; }
        /*文件*/div.filespacer { width: 320px; height: 20px; line-height: 20px; text-align: center; font: 10pt verdana; margin-bottom: 10px; overflow: hidden; border: 1px solid #CCCCCC; cursor: pointer; }
        div.filespacer:hover { border: 1px solid #FF0000; }
        div.filestitleholder { text-align: left; font-family: ms sans serif, arial; font-size: 12px; line-height: 20px; width: 250px; text-overflow: ellipsis; overflow: hidden; white-space: nowrap; float: left; }
        /*中间那个—*/div.mid { float: left; }
    </style>
    ...
    <script type="text/javascript">
        ...
        function returnImage(imagename, width, height) {
            ...
            if (request("type") == "image") {
                ...
                if (request("iseditor") == 1) {
                    imagename = imagename + "|" + eval(width);
        ...
        <table width="98%" class="m_title" align="center">
            ...
            <tr>
                <td colspan="2" style="height: 240px">
                    <div id="galleryarea" style="width: 100%; min-height: 100%; height: 100%; overflow: auto;
                        margin-bottom: 4px;">
        ...
        <table class="m_title" align="center" width="98%">
            ...
            <tr id="UploadPanel" runat="server">
                ...
                <td style="height: 45px;">
                    ...
                    <asp:Button ID="UploadImage" Text="上传" runat="server" CssClass="m_btn_w2" OnClick="UploadImage_OnClick" />
