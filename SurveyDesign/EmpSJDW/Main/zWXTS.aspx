    ...
    <table height="95%" width="98%" align="center">
        ...
        <tr>
            ...
            <td class="wxts_m">
                ...
                <div style="width: 98%; margin: 0 auto; display:none;">
                    <asp:DataGrid ID="DG_MSG" runat="server" AutoGenerateColumns="False" CssClass="m_dg1"
                        HorizontalAlign="Center" OnItemDataBound="DG_MSG_ItemDataBound" Width="100%"
                        OnItemCommand="DG_MSG_ItemCommand">
                        ...
                        <Columns>
                            ...
                            <asp:BoundColumn DataField="FText" HeaderText="内容">
                                <ItemStyle CssClass="t_l" />
                            </asp:BoundColumn>
                            <asp:BoundColumn DataField="FSendTime" DataFormatString="{0:yyyy-MM-dd}" HeaderText="日期">
                                <HeaderStyle Width="80" />
                            </asp:BoundColumn>
                            <asp:TemplateColumn HeaderText="操作">
                                <HeaderStyle Width="85" />
                                <ItemTemplate>
                                    <asp:LinkButton ID="btnRead" CommandName="Read" Text="已读" runat="server" CommandArgument='<%#Eval("FID")%>'>
                                    </asp:LinkButton>
                                    |
                    ...
                    <webdiyer:AspNetPager ID="Pager1" runat="server" AlwaysShow="True" CssClass="pages"
                        ...
                        PageIndexBoxType="TextBox" PageSize="5" PrevPageText="上一页" ShowCustomInfoSection="Right"
                        ShowPageIndexBox="Always" SubmitButtonText="Go" TextAfterPageIndexBox="页" TextBeforePageIndexBox="转到">
                    </webdiyer:AspNetPager>
                </div>
                <div class="wxts_Ts">
                    您历次办理的业务有：<font color="black"><asp:Literal ID="lit_App" runat="server"></asp:Literal></font>（年度：<asp:DropDownList
                        ID="drop_FYear" runat="server" AutoPostBack="true" OnSelectedIndexChanged="drop_FYear_SelectedIndexChanged">
                    </asp:DropDownList>
                    ）
                </div>
                <div style="width: 98%; margin: 0 auto;">
                    <asp:DataGrid ID="App_List" runat="server" AutoGenerateColumns="False" CssClass="m_dg1"
                        ...
                        OnItemCommand="App_List_ItemCommand" PageSize="15">
                        <HeaderStyle CssClass="m_dg1_h" />
                        <ItemStyle CssClass="m_dg1_i" />
                        <%-- <AlternatingItemStyle CssClass="m_dg1_i" />--%>
                        <Columns>
                            ...
                            <asp:TemplateColumn HeaderText="工程名称">
                                ...
                                <ItemTemplate>
                                    <asp:Literal ID="lit_TS" runat="server"></asp:Literal>
                                    <a href='javascript:showAddWindow("../<%#Eval("fUrl") %>/ApplyBaseInfo.aspx?FDataID=<%#Eval("FLinkId") %>",800,700);'>
                                        <%#Eval("FPrjName")%>
                                    </a>
                            ...
                            <asp:BoundColumn HeaderText="主要职责" DataField="FFunction"></asp:BoundColumn>
                            <asp:BoundColumn DataField="FAppDate" DataFormatString="{0:d}" HeaderText="完成时间">
                            </asp:BoundColumn>
                    ...
                    <div style="margin: 4px auto;">
                        提示：<tt>点击“业务名称”办理或查看业务。</tt><img src="../../image/info.jpg" /><tt>表示人员安排有变化</tt>
                    </div>
                </div>
            </td>
            <td class="wxts_r">
