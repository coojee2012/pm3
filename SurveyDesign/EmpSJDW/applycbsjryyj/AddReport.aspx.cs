...
public partial class JZDW_ApplyXMJZ_AddReport : Page
{
    ...
    private void showInfo()
    {
        ...
        if (Request.QueryString["Self"] == "1")
        {
            ...
            {
                li_FTxt1.Text = db.CF_Emp_BaseInfo.Where(t => t.FId == fEmpId).Select(t => t.FName).FirstOrDefault();
                li_FTxt1.Enabled = false;
        ...
        if (v != null)
        {
            ...
            if (emp != null)
            {
                ...
                if (idea != null)
                {
                    ...
                    // t_FResultInt.SelectedValue = idea.FResultInt.ToString();//高忠宝
    ...
    protected void rep_List_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
        {
            ...
            if (!(Request.QueryString["Self"] == "1"))//如果是本人 
    ...
    bool IsUploadFile(int? FMTypeId, string FAppId ,string FUserId)
    {
        var v = db.CF_Sys_PrjList.Count(t => t.FIsMust == 1
            ...
            && db.CF_AppPrj_FileOther.Count(o => o.FPrjFileId == t.FId && o.FAppId == FAppId&&o.FUserId==FUserId ) < 1) > 0;
        return v;
    }
    ...
    private void saveInfo()
    {
        ...
        //验证必需的附件是否上传
        if (IsUploadFile(29202, FAppId,FEmpBaseInfo))
        {
        ...
        //idea.FResultInt = EConvert.ToInt(t_FResultInt.SelectedValue);高忠宝
