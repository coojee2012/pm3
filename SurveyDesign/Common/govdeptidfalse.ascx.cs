namespace Approve.Common
{
    ...
    ///		GovDeptDisp 的摘要说明。
    /// </summary>
    public partial class GovDeptIdFalse : System.Web.UI.UserControl
    {
        ...
        private void SetData()
        {
            ...
            if (Em.FLevel == 3)
            {
                ...
                EsManageDept Emp = (EsManageDept)rc.GetEBase(EntityTypeEnum.EsManageDept, "fid,fparentid,flevel,fnumber", "fnumber='" + Em.FParentId + "'and fisdeleted=0 order by forder,fnumber");
        ...
        {
            DataTable dt = rc.GetTable(EntityTypeEnum.EsManageDept, "FNumber,fname", "fparentid='" + CityId + "' and fname!='市辖区' and flevel=3 and fisdeleted=0 order by forder,fnumber");
