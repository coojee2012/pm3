<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FileMsgList.aspx.cs" Inherits="Government_DataCollect_FileMsgList" %>
...
<body>
    ...
    <asp:DataGrid ID="News_List" runat="server" HorizontalAlign="Center" Width="100%"
        ...
        <Columns>
            ...
            <asp:BoundColumn DataField="FName" HeaderText="文件标题">
