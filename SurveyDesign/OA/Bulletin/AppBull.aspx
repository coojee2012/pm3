<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AppBull.aspx.cs" Inherits="OA_Bulletin_AppBull" %>
...
<body>
    ...
    <table width="98%" align="center" class="m_title">
        ...
        <tr>
            <td class="t_r">
                公告标题：<asp:TextBox ID="txtFTitle" runat="server" CssClass="m_txt" Width="100px"></asp:TextBox>
            </td>
            <td class="t_r">
                公告类型：
            </td>
            <td>
                <asp:DropDownList ID="textFType" runat="server"  CssClass="m_txt">
                </asp:DropDownList>
            </td>
            <td class="t_r">
                &nbsp; 审核状态：
            ...
            <td>
                <asp:DropDownList ID="DropDownList1" CssClass="m_txt" Width="100px" runat="server">
    ...
    <table width="98%" align="center" class="m_bar">
        <tr>
            ...
            <td class="m_bar_m">
                <asp:Button ID="btnDel" runat="server" CssClass="m_btn_w4" Text="审核通过" OnClick="btnDel_Click" />
                
                
                <asp:Button
                    ID="Button1" runat="server" CssClass="m_btn_w2" Text="打回" OnClick="Button1_Click" />&nbsp;&nbsp;
                &nbsp;&nbsp;
            </td>
            <td class="m_bar_r">
            </td>
    ...
    <asp:GridView ID="BulList" runat="server" AutoGenerateColumns="False" CssClass="m_dg1"
        ...
        <Columns>
            ...
            <asp:BoundField DataField="app" HeaderText="审核状态">
                <ItemStyle Width="80" />
            </asp:BoundField>
    ...
    <table align="center" class="DataListTableBottom01" width="98%">
        <tr>
            <td width="10">
            </td>
            <td>
