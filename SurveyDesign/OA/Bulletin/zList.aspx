<%@ Page Language="C#" AutoEventWireup="true" CodeFile="zList.aspx.cs" Inherits="OA_Bulletin_zList" %>
...
<body>
    ...
    <asp:GridView ID="BulList" runat="server" AutoGenerateColumns="False" CssClass="m_dg1"
        ...
        <Columns>
            ...
            <asp:BoundField DataField="FCreateTime" HeaderText="发布时间" DataFormatString="{0:yyyy-MM-dd}">
