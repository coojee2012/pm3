...
public partial class JSDW_ApplyYDGH_ApplyIndex : System.Web.UI.Page
{
    ...
    {
        string sql = @"select A.*,B.XMBJMC,B.ID FROM CF_App_List A,YW_XMBJ B WHERE A.FID = B.YWBM AND B.FBaseInfoId='" + CurrentEntUser.EntId + "'";
    ...
    protected void DG_List_ItemCommand(object source, DataGridCommandEventArgs e)
    {
        if (e.Item.ItemIndex > -1)
        {
            ...
            {
                string fAppId = FId;
                string XM_Id = e.Item.Cells[e.Item.Cells.Count - 1].Text;
                ...
                //  string FState = EConvert.ToString(DataBinder.Eval(e.Item.DataItem, "FState"));
                // Session["YJS_GUID"] = e.XM_Id.Cells[e.Item.Cells.Count - 1].Text;
                var param = "?XM_Id=" + XM_Id + "&fAppId=" + fAppId;
            ...
            else if (e.CommandName == "Del")
            {
                ...
                sb.Append("delete from YW_XMBJ where YWBM='" + FId + "';");
