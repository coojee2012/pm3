<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Report.aspx.cs" Inherits="JSDW_ApplyYDGH_Report" %>
<!DOCTYPE html>
        ...
        <div>
            ...
            <table class="m_table" width="98%" align="center">
                ...
                <tr>
                    ...
                    <td colspan="3">
                        <asp:TextBox ID="t_YDGHMC" runat="server" CssClass="m_txt" Width="250px" Enabled="false"></asp:TextBox>
                    </td>
                </tr>
                <tr>
