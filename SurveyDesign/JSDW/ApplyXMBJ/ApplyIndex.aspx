                                    ...
                                    <table width="100%" id="Table1" runat="server">
                                        ...
                                        <tr>
                                            <td height="27" class="txt23" style="padding-left: 1px; margin-top: 6px;">业务名称：<asp:TextBox ID="t_YWFname" runat="server" CssClass="m_txt" Width="150px"></asp:TextBox>
                                                ...
                                                <input type="button"  class="m_btn_w12" onclick="javascript: window.location.href = 'ApplyFor.aspx'" value="新增项目报建申请" />
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                            ...
                            <tr>
                                <td align="center" valign="top" colspan="2">
                                    <asp:DataGrid ID="DG_List" runat="server" AutoGenerateColumns="False" CssClass="m_dg1"
                                       ...
                                       <%--     <asp:TemplateColumn HeaderText="选址名称">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btnMC" runat="server" CommandName="See" Text='<%#Eval("XZMC") %>'>
                                                    </asp:LinkButton>
                                                </ItemTemplate>
                                                <ItemStyle CssClass="t_l" />
                                            </asp:TemplateColumn>--%>
                                             <asp:BoundColumn DataField="XMBJMC" HeaderText="项目名称"></asp:BoundColumn>
                                            <asp:BoundColumn HeaderText="占位" Visible="false"></asp:BoundColumn>
