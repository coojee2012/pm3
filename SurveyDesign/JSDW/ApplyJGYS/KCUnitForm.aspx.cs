...
public partial class JSDW_ApplyJGYS_KCUnitForm : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            ShowInfo();
            EnabledControl();
            DG_List.Attributes.Add("style", "word-break:break-all;word-wrap:break-word");
        }
    }
    ...
    {
        string sql = string.Format(@"select * from YW_COMPANY where JGYS_ID='{0}' and TypeId=4", Id);
