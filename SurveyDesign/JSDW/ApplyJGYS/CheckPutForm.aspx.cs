...
public partial class JSDW_ApplyJGYS_CheckPutForm : System.Web.UI.Page
{
        ...
        if (!IsPostBack)
        {
            ...
            if (!string.IsNullOrEmpty(Id))
            {
                ...
                if (table != null && table.Rows.Count > 0)
                {
                    ...
                    ddlGCYT.SelectedValue = row["GCYT"].ToString();
                }
            }
            EnabledControl();
        }
    ...
    private void BindControl()
    {
        ...
        var GCYT = db.getDicList("2000101");
        ddlGCYT.DataSource = GCYT;
        ddlGCYT.DataTextField = "fname";
        ddlGCYT.DataValueField = "fnumber";
        ddlGCYT.DataBind();
        ddlGCYT.Items.Insert(0, new ListItem() { Text = "--请选择--", Value = "" });
        //结构体系
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        list.Add(new SqlParameter() { ParameterName = "@GD", Value = txtGD.Text, SqlDbType = SqlDbType.VarChar });
        list.Add(new SqlParameter() { ParameterName = "@DT", Value = txtDT.Text, SqlDbType = SqlDbType.VarChar });
        list.Add(new SqlParameter() { ParameterName = "@ZDFT", Value = txtZDFT.Text, SqlDbType = SqlDbType.VarChar });
        list.Add(new SqlParameter() { ParameterName = "@GCYT", Value = ddlGCYT.SelectedValue, SqlDbType = SqlDbType.VarChar });
