<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HTBAList.aspx.cs" Inherits="JSDW_ApplyJGYS_ProjectFile_HTBAList" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        function Add()
        {
            showAddWindow("HTBAForm.aspx?JG_Id=" + $("#hfId").val(), 800, 500);
            document.getElementById("btnRefresh").click();
        }
        function Edit(Id)
        {
            showAddWindow("HTBAForm.aspx?JG_Id=" + $("#hfId").val() + "&Id=" + Id, 800, 500);
            document.getElementById("btnRefresh").click();
        }
        function Show(Id) {
            showAddWindow("HTBAForm.aspx?JG_Id=" + $("#hfId").val() + "&Id=" + Id+"&IsShow=1", 800, 500);
        }
        function Save() {
...
<body>
    ...
    <asp:DataGrid ID="DG_List" runat="server" AutoGenerateColumns="False" CssClass="m_dg1"
        ...
        <Columns>
            ...
            <asp:BoundColumn DataField="HTBH" HeaderText="合同编号"></asp:BoundColumn>
            <asp:BoundColumn DataField="HTLBMC" HeaderText="合同类别"></asp:BoundColumn>
            <asp:BoundColumn DataField="HTJE" HeaderText="合同金额(万元)"></asp:BoundColumn>
            <asp:BoundColumn DataField="FBDWMC" HeaderText="发包单位名称"></asp:BoundColumn>
            <asp:TemplateColumn HeaderText="操作">
                <ItemTemplate>
                    <asp:LinkButton Text="删 除" CommandName="del" OnClientClick="return confirm('确认删除?');" runat="server"></asp:LinkButton>&nbsp;&nbsp;&nbsp;<a href="#" onclick="Edit('<%#Eval("ID") %>')">编 辑</a>
                </ItemTemplate>
            </asp:TemplateColumn>
