<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ZTBSGForm.aspx.cs" Inherits="JSDW_ApplyJGYS_ProjectFile_ZTBSGForm" %>
...
<body id="body1">
    ...
    <div>
        ...
        <table class="m_table" width="98%" align="center">
            ...
            <table class="m_table" width="98%" align="center">
            <tr>
                <td class="t_r t_bg" style="width:20px;text-align:center" rowspan="9">施工单位招投标信息</td>
                <td class="t_r t_bg">
                    招标方式：
                </td>
                <td>
                    <asp:DropDownList ID="ddlSGZBFS" runat="server" CssClass="required" Width="200"></asp:DropDownList><tt>*</tt>
                </td>
                 <td class="t_r t_bg">
                    招标类型：
                </td>
                <td>
                    <asp:DropDownList ID="ddlSGZBLX" runat="server" CssClass="required" Width="200"></asp:DropDownList><tt>*</tt>
                </td>
            </tr>
            <tr>
                <td class="t_r t_bg">
                ...
                <td>
                    <asp:TextBox ID="txtSGZBDW" runat="server" CssClass="required" Width="200px"></asp:TextBox><asp:Button ID="btnSearch" runat="server" CssClass="m_btn_w2 cancel" OnClientClick="return SearchZBDW()" Text="选 择" /><tt>*</tt>
                </td>
                 <td class="t_r t_bg">
                    中标单位组织机构代码：
                </td>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtZBDLDWMC" runat="server" CssClass="required" Width="200px"></asp:TextBox><asp:Button ID="Button2" runat="server" CssClass="m_btn_w2 cancel" OnClientClick="return SearchZBDLDW()" Text="选 择" /><tt>*</tt>
                </td>
                 <td class="t_r t_bg">
                    招标代理单位组织机构代码：
                </td>
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="ddlXMJLZJLX" runat="server" CssClass="required" Width="200"></asp:DropDownList><tt>*</tt>
                </td>
            </tr>
            <tr>
                <td class="t_r t_bg">
            ...
            <tr>
                ...
                <td colspan="3">
                    ...
                    <asp:Button ID="Button1" runat="server" CssClass="m_btn_w4" Text="选择文件..." OnClientClick="return SelectFiles()" /><br/>
