<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ChooseManagePerson.aspx.cs" Inherits="JSDW_ApplyJGYS_ProjectFile_ChooseManagePerson" %>
    ...
    <form id="form1" runat="server">
        <table width="98%" align="center" class="m_title">
            <tr>
                ...
                <td width="auto"><asp:Button ID="btnQuery" runat="server" Text="查 询" CssClass="m_btn_w2" OnClick="btnQuery_Click"  />&nbsp;&nbsp;<input type="button" value="返 回" class="m_btn_w2" onclick="javascript: window.close();" /></td>
            </tr>
        </table>
    ...
    <asp:DataGrid ID="DG_List" runat="server" HorizontalAlign="Center" Width="98%" CssClass="m_dg1"
        ...
        <Columns>
                <asp:TemplateColumn HeaderStyle-Width="50">
                    <ItemTemplate>
                        <a href="#" onclick="Choose('<%#Eval("RYZSXXID") %>')">选 择</a>
                    </ItemTemplate>
                </asp:TemplateColumn>
                ...
                <asp:BoundColumn DataField="QYMC" HeaderText="企业名称" HeaderStyle-Width="200"></asp:BoundColumn>
                <asp:BoundColumn DataField="XM" HeaderText="姓名">
                    <ItemStyle HorizontalAlign="Left" />
                </asp:BoundColumn>
                <asp:BoundColumn DataField="XB" HeaderText="性别"></asp:BoundColumn>
                <asp:BoundColumn DataField="BYYX" HeaderText="毕业院校"></asp:BoundColumn>
                <asp:BoundColumn DataField="SXZY" HeaderText="所学专业"></asp:BoundColumn>
                <asp:BoundColumn DataField="RYBH" Visible="false"></asp:BoundColumn>--%>
        </Columns>
    </asp:DataGrid>
