...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script language="javascript">
        ...
        function SearchProject() {
            var result = showWinByReturn("ChooseProjectItem.aspx?anc=1", 800, 500);
            if (result != undefined) {
                $("#hfFid").val(result);
                return true;
            }
                        ...
                        <table align="center" width="600" id="applyInfo" class="m_table">
                            ...
                            <tr>
                                <td align="center" colspan="2" height="30">
                                    <asp:Button ID="btnOk" runat="server" OnClick="btnOk_Click" CssClass="m_btn_w2" OnClientClick="return Submit();" Text="确认" />
