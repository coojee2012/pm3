<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BuildUnitList.aspx.cs" Inherits="JSDW_ApplyXZYJS_BuildUnitList" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function showWindow() {
            showAddWindow("user/AddUser.aspx?anc=1", 800, 500);
        }
    </script>
    ...
    <%--<table width="98%" align="center" class="m_title">
        ...
        <tr>
            ...
            <td rowspan="2" align="center">
                <asp:Button ID="btnQuery1" runat="server" CssClass="m_btn_w2" Text="搜索" OnClick="btnQuery1_Click" />
        ...
        <tr>
            ...
            <td>
                ...
                至：
                 <asp:TextBox ID="TextBox1" runat="server" CssClass="m_txt" Width="130px"></asp:TextBox>
            </td>
            <td colspan="2"></td>
        </tr>
    </table>--%>
        <table width="98%" align="center" class="m_title">
            ...
            <tr>
                ...
                <td>
                    ...
                    是否锁定：<asp:DropDownList ID="t_FCAState" runat="server">
        ...
        <tr>
            ...
            <td class="m_bar_m">
               <input id="Submit1" type="button" value="新 建" class="m_btn_w2" onclick="showWindow()" />
                ...
                <asp:Button ID="btnQuery" runat="server" CssClass="m_btn_w4" Text="刷新" Visible="false" OnClick="btnQuery_Click" />
                 <asp:Button ID="btnDownload" runat="server" CssClass="m_btn_w4" Text="fds" Visible="false" />
            </td>
