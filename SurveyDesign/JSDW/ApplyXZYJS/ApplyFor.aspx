<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ApplyFor.aspx.cs" Inherits="JSDW_ApplyXZYJS_ApplyFor" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script language="javascript">
        function SearchProject() {
            var result = showWinByReturn("ChooseProject.aspx?anc=1", 800, 500);
            if (result != undefined) {
                $("#hfFid").val(result);
                return true;
            }
