...
using System.Text;
using System.IO;
public partial class JSDW_ApplyXZYJS_FileAdd : System.Web.UI.Page
{
    ...
    private void ShowInfo()
    {
        ...
        if (!string.IsNullOrEmpty(FileId) && !string.IsNullOrEmpty(YJS_Id))
        {
            ...
            if (table != null && table.Rows.Count > 0)
            {
                ...
                {
                    _builder.Append("<tr>");
                    //string url = "DownLoad.aspx?filePath=" + row["DownLoadPath"] + "&fileName=" + row["FILE_NAME"];
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        if (!string.IsNullOrEmpty(hfUpadFile.Value))
        {
            ...
            foreach (var item in items)
            {
                ...
                sql += string.Format("INSERT INTO YW_FILE_DETAIL(ID,FileId,YWBM,[FILE_NAME],FILE_SIZE,DownLoadPath)VALUES(NEWID(),{0},'{1}','{2}','{3}','{4}')", FileId, YJS_Id, fileName, fileSize, downLoadPath);
            }
