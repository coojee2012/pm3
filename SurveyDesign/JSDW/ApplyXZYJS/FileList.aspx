<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FileList.aspx.cs" Inherits="JSDW_ApplyXZYJS_FileList" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        function UpadLoadFile(typeId,$obj)
        {
            ...
            var url = "fileUpadload.aspx?typeId=" + typeId + "&typeName=" + typeName + "&FIsApprove=" + $("#hfFIsApprove").val() + "&YJS_Id=" + $("#hfYJS_Id").val();
...
<body>
    ...
    <asp:HiddenField ID="hfYJS_Id" runat="server" />
