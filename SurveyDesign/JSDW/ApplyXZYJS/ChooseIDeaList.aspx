<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ChooseIDeaList.aspx.cs" Inherits="JSDW_ApplyXZYJS_ChooseIDeaList" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function showWindow()
        {
            showAddWindow("IDeaBookApply.aspx?", 800, 500);
        }
    </script>
    ...
    <table width="98%" align="center" class="m_bar">
        <tr>
            ...
            <td class="m_bar_m">
                ...
                <asp:Button ID="btnQuery3" runat="server" CssClass="m_btn_w2" Enabled="false" Text="处 理" />
                <asp:Button ID="btnDel" runat="server" CssClass="m_btn_w2" Text="删 除" Enabled="false" OnClick="btnDel_Click" OnClientClick="return confirm('确认删除');" />
                <asp:Button ID="btnQB" runat="server" CssClass="m_btn_w2" Enabled="false" Text="撤 回"/>
