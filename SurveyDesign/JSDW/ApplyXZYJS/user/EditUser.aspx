<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EditUser.aspx.cs" Inherits="JSDW_ApplyXZYJS_user_EditUser" %>
    ...
    <form id="form1" runat="server">
        ...
        <table class="m_table" width="98%" align="center">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="t_FEntType" Width="150px" runat="server" Text="建设单位" CssClass="m_txt" Enabled="False"></asp:TextBox>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <asp:TextBox ID="t_FMenuRole" Width="150px" runat="server" Text="建设单位" CssClass="m_txt" Enabled="False"></asp:TextBox>
                </td>
            </tr>
            <tr>
