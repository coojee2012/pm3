...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript">
        function ComanyAdd() {
            var url = "../ApplyJGYS/CompanyAdd.aspx?JG_Id=" + $("#hfId").val() + "&typeId=4&typeName=勘察单位";
        ...
        function ComanyEdit(companyId) {
            var url = "../ApplyJGYS/CompanyEdit.aspx?JG_Id=" + $("#hfId").val() + "&companyId=" + companyId + "&typeId=4&typeName=勘察单位";
            var result = showWinByReturn(url, 800, 500);
