<%@ Page Language="C#" AutoEventWireup="true" CodeFile="XZYJSForm.aspx.cs" Inherits="JSDW_ApplyJGYS_ProjectFile_XZYJSForm" %>
...
<body id="body1">
    ...
    <div>
        ...
        <table class="m_table" width="98%" align="center">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtJSDW" runat="server"  Enabled="false" CssClass="m_txt" Width="200px"></asp:TextBox>
                    <tt>*</tt>
                </td>
                 <td class="t_r t_bg">
                    项目拟选位置：
                ...
                <td>
                    <asp:TextBox ID="txtXMNXWZ" runat="server" CssClass="m_txt" Width="200"></asp:TextBox>
                </td>
            </tr>
             <tr>
                <td class="t_r t_bg">
                ...
                <td>
                    <asp:TextBox ID="txtNYDMJ" runat="server" CssClass="m_txt required" Width="200px"></asp:TextBox><tt>*</tt>
                </td>
                 <td class="t_r t_bg">
                    拟建设规模：
                </td>
                <td>
                    <asp:TextBox ID="txtNJSGM" runat="server" CssClass="m_txt" Width="200"></asp:TextBox>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtXZYJSZSBM" runat="server" CssClass="m_txt required" Width="200px"></asp:TextBox><tt>*</tt>
            ...
            <tr>
                ...
                <td colspan="3">
                    <asp:TextBox ID="txtHFJG" runat="server" CssClass="m_txt required" Width="500px"></asp:TextBox><tt>*</tt>
                </td>
            </tr>
             <tr>
                <td class="t_r t_bg">
                ...
                <td colspan="3">
                    <asp:TextBox ID="txtXMJSYJ" runat="server" CssClass="m_txt" Width="500" Height="60" TextMode="MultiLine"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="t_r t_bg">
                ...
                <td colspan="3">
                    <asp:TextBox ID="txtYDSPSX" runat="server" CssClass="m_txt" Width="500" Height="60" TextMode="MultiLine"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="t_r t_bg">
 ...
 <script type="text/javascript">
     ...
     function SaveValidate() {
         ...
         var name = $("#txtXMMC").val();
         var address = $("#txtJSDW").val();
