<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ChooseQYSG.aspx.cs" Inherits="JSDW_ApplyJGYS_ProjectFile_ChooseQYSG" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        function Verify(QYBM, QYMC, JGDM) {
            var str = QYBM + "|" + QYMC + "|" + JGDM;
            window.close();
        ...
        <Columns>
            ...
            <ItemStyle Width="50px" />
                ...
                <asp:TemplateColumn HeaderStyle-Width="50">
                    <ItemTemplate>
                        <a href="javascript:void(0)" onclick="Verify('<%#Eval("QYBM") %>','<%#Eval("QYMC") %>','<%#Eval("JGDM") %>')">选 定</a>
                    </ItemTemplate>
                </asp:TemplateColumn>
                ...
                <asp:BoundColumn DataField="ZZMC" HeaderText="主项资质" HeaderStyle-Width="100">
                ...
                <asp:BoundColumn DataField="AXZBH" HeaderText="安许证编号" HeaderStyle-Width="200"></asp:BoundColumn>
        </Columns>
    </asp:DataGrid>
