<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GCGHForm.aspx.cs" Inherits="JSDW_ApplyJGYS_ProjectFile_GCGHForm" %>
    ...
    <div>
        ...
        <table class="m_table" width="98%" align="center">
            ...
            <tr>
                ...
                <td colspan="3">
                    <asp:TextBox ID="txtJSDW" runat="server" Enabled="false" CssClass="m_txt required" Width="500px"></asp:TextBox><tt>*</tt>
                </td>
            </tr>
             <tr>
                <td class="t_r t_bg">
                ...
                <td colspan="3">
                    <asp:TextBox ID="txtJSXMMC" Enabled="false" runat="server" CssClass="m_txt" Width="500px"></asp:TextBox><tt>*</tt>
                </td>
            </tr>
            <tr>
                <td class="t_r t_bg">
                ...
                <td colspan="3">
                    <asp:TextBox ID="txtJSWZ" runat="server" CssClass="m_txt required" Width="500px"></asp:TextBox><tt>*</tt>
                </td>
            </tr>
            <tr>
                <td class="t_r t_bg">
                ...
                <td colspan="3">
                    <asp:TextBox ID="txtJSGM" runat="server" CssClass="m_txt required" Width="500px"></asp:TextBox><tt>*</tt>
                </td>
            </tr>
            <tr>
                <td class="t_r t_bg">
                ...
                <td>
                    <asp:TextBox ID="txtMJ" runat="server" CssClass="m_txt" Width="100px"></asp:TextBox>
                    跨度(高度)（m）：<asp:TextBox ID="txtKD" runat="server" CssClass="m_txt" Width="100px"></asp:TextBox>
                </td>
                 <td class="t_r t_bg">
                    其他：
                </td>
            ...
            <tr>
                ...
                <td colspan="3">
                    <asp:TextBox ID="txtGCGHXKZBH" runat="server" CssClass="m_txt required" Width="500px"></asp:TextBox><tt>*</tt>
                </td>
            </tr>
            <tr>
                <td class="t_r t_bg">
                ...
                <td>
                    <asp:TextBox ID="txtFZJG" runat="server" CssClass="m_txt" Width="200px"></asp:TextBox>
