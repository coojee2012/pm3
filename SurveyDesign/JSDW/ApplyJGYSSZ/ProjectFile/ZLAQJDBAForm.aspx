<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ZLAQJDBAForm.aspx.cs" Inherits="JSDW_ApplyJGYS_ProjectFile_ZLAQJDBAForm" %>
    ...
    <div>
        ...
        <table class="m_table" width="98%" align="center">
            ...
            <tr>
                ...
                <td colspan="3">
                    <asp:TextBox ID="txtXMMC" runat="server" Enabled="false" CssClass="m_txt" Width="500px"></asp:TextBox><tt>*</tt>
                </td>
            </tr>
             <tr>
                <td class="t_r t_bg">
                ...
                <td colspan="3">
                    <asp:TextBox ID="txtGCMC" runat="server" Enabled="false" CssClass="m_txt" Width="500px"></asp:TextBox><tt>*</tt>
                </td>
            </tr>
            <tr>
                <td class="t_r t_bg">
                ...
                <td colspan="3">
                    <asp:TextBox ID="txtJSDW" runat="server" Enabled="false" CssClass="m_txt" Width="500px"></asp:TextBox><tt>*</tt>
                </td>
            </tr>
        </table>
        <table class="m_table" width="98%" align="center">
            <tr>
                <td rowspan="2" class="t_r t_bg">质量备案</td>
                <td class="t_r t_bg">备案编号</td>
                <td colspan="3"><asp:TextBox ID="txtZLBABH" runat="server" CssClass="required" Width="200px"></asp:TextBox><tt>*</tt></td>
            </tr>
            <tr>
                <td class="t_r t_bg">备案机关</td>
                <td><asp:TextBox ID="txtZLBAJG" runat="server" Width="200px"></asp:TextBox></td>
				<td class="t_r t_bg">备案时间</td>
				<td><asp:TextBox ID="txtZLBASJ" runat="server"  CssClass="m_txt Wdate" onfocus="WdatePicker({skin:'whyGreen' })"  Width="200px"></asp:TextBox></td>
            </tr>
			<tr>
                <td rowspan="2" class="t_r t_bg">安全备案</td>
                <td class="t_r t_bg">备案编号</td>
                <td colspan="3"><asp:TextBox ID="txtAQBABH" runat="server" CssClass="required" Width="200px"></asp:TextBox><tt>*</tt></td>
            </tr>
            <tr>
                <td class="t_r t_bg">备案机关</td>
                <td><asp:TextBox ID="txtAQBAJG" runat="server" Width="200px"></asp:TextBox></td>
				<td class="t_r t_bg">备案时间</td>
				<td><asp:TextBox ID="txtAQBASJ" runat="server"  CssClass="m_txt Wdate" onfocus="WdatePicker({skin:'whyGreen' })"  Width="200px"></asp:TextBox></td>
            </tr>
        </table>
        <table class="m_table" width="98%" align="center">
            <tr>
