<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JLUnitForm.aspx.cs" Inherits="JSDW_ApplyJGYS_JLUnitForm" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript">
        function ComanyAdd() {
            var url = "../ApplyJGYS/CompanyAdd.aspx?JG_Id=" + $("#hfId").val() + "&typeId=6&typeName=监理单位";
        ...
        function ComanyEdit(companyId) {
            var url = "../ApplyJGYS/CompanyEdit.aspx?JG_Id=" + $("#hfId").val() + "&companyId=" + companyId + "&typeId=6&typeName=监理单位";
            var result = showWinByReturn(url, 800, 500);
