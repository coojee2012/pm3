<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ZYCBUnitForm.aspx.cs" Inherits="JSDW_ApplyJGYS_ZYCBUnitForm" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            //    var result = showWinByReturn("CompanyAdd.aspx?JG_Id=" + $("#hfId").val() + "&typeId=2&typeName='专业承包单位'", 800, 500);
            //    if (result != undefined) {
        ...
        function ComanyAdd()
        {
            var url = "../ApplyJGYS/CompanyAdd.aspx?JG_Id=" + $("#hfId").val() + "&typeId=2&typeName=专业承包单位";
        ...
        function ComanyEdit(companyId) {
            var url = "../ApplyJGYS/CompanyEdit.aspx?JG_Id=" + $("#hfId").val() + "&companyId=" + companyId + "&typeId=2&typeName=专业承包单位";
            var result = showWinByReturn(url, 800, 500);
         ...
         <asp:DataGrid ID="DG_List" runat="server" HorizontalAlign="Center" Width="98%" CssClass="m_dg1"
            ...
            <ItemStyle CssClass="m_dg1_i" />
                <Columns>
                    ...
                    <asp:BoundColumn HeaderText="资质项" DataField="ZZX">
