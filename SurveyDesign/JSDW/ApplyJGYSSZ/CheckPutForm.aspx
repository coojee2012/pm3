         ...
         <table class="m_table" width="98%" align="center">
            ...
            <tr>
             ...
             <tr>
                ...
                <td>
                    <asp:TextBox ID="txtXMFZR" runat="server" CssClass="m_txt" Width="200px"></asp:TextBox><tt>*</tt>
                </td>
                 <td class="t_r t_bg">
                    联系电话：
                </td>
                <td>
                     <asp:TextBox ID="txtLXDH" runat="server" CssClass="m_txt" Width="200px"></asp:TextBox><tt>*</tt>
                </td>
            </tr>
             <tr>
                 <td class="t_r t_bg">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtKGRQ" runat="server"  CssClass="m_txt Wdate" onfocus="WdatePicker({skin:'whyGreen' })" Width="200"></asp:TextBox>
                </td>
                 <td class="t_r t_bg">
                    竣工验收日期：
                </td>
