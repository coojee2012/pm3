<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LWFBUnitForm.aspx.cs" Inherits="JSDW_ApplyJGYS_NWFBUnitForm" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript">
        function ComanyAdd() {
            var url = "../ApplyJGYS/CompanyAdd.aspx?JG_Id=" + $("#hfId").val() + "&typeId=3&typeName=劳务分包单位";
        ...
        function ComanyEdit(companyId) {
            var url = "../ApplyJGYS/CompanyEdit.aspx?JG_Id=" + $("#hfId").val() + "&companyId=" + companyId + "&typeId=2&typeName=劳务分包单位";
            var result = showWinByReturn(url, 800, 500);
