<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ZBWJBAList.aspx.cs" Inherits="JSDW_APPLYZBBA_ZBWJBAList" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function selPrj(obj) {
            var pid = showWinByReturn('../ApplyZBBA/BDSel.aspx?ftype=<%=fMType %>', 1000, 500);
            if (pid != null && pid != '') {
                $("#t_BDId").val(pid);
                __doPostBack(obj.id, '');
            }
                                            ...
                                            <td style="padding-top: 10px">
                                                <table width="100%" align="center" class="m_title">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtBDBM" runat="server" CssClass="m_txt" Width="195px"></asp:TextBox>
                                                        </td>
                                                        <td class="t_r">标段名称：
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="txtBDMC" runat="server" CssClass="m_txt" Width="195px"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                     <tr>
                                                        <td class="t_r">
                                            ...
                                            <td align="center" valign="top" colspan="2">
                                                <asp:GridView ID="gv_list" runat="server" CssClass="m_dg1" Width="100%" HorizontalAlign="Center"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField HeaderText="标段编码" DataField="BDBM">
                                                        ...
                                                        <asp:BoundField HeaderText="编制人" DataField="BZR">
                                                            <HeaderStyle Width="70px" />
                                                        </asp:BoundField>
                                                        <asp:BoundField HeaderText="审核人" DataField="SHR">
                                                            <HeaderStyle Width="70px" />
                                                        </asp:BoundField>
                                                        <asp:BoundField HeaderText="审定人" DataField="SDR">
                                                            <HeaderStyle Width="70px" />
                                                        </asp:BoundField>
