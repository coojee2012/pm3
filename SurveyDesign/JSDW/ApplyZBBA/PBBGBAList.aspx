<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PBBGBAList.aspx.cs" Inherits="JSDW_APPLYZBBA_ZBDYBAList" %>
                                            ...
                                            <td align="center" valign="top" colspan="2">
                                                <asp:GridView ID="gv_list" runat="server" CssClass="m_dg1" Width="100%" HorizontalAlign="Center"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField HeaderText="备案单位" DataField="BADW">
                                                            <HeaderStyle Width="70px" />
                                                        </asp:BoundField>
                                                        <asp:BoundField HeaderText="备案时间" DataField="BATime" DataFormatString="{0:d}">
