...
public partial class JSDW_ApplyZBBA_ZBYSJGReport : System.Web.UI.Page
{
    ...
    void ShowEntInfo()
    {
        ...
        TC_YSJG_Record qa = db.TC_YSJG_Record.Where(t => t.FAppId.Equals(fAppId)).FirstOrDefault();
    ...
    private void Report()
    {
        ...
        TC_YSJG_Record tswj = db.TC_YSJG_Record.Where(t => t.FAppId == fAppId).FirstOrDefault();
