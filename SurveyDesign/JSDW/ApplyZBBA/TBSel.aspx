<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TBSel.aspx.cs" Inherits="JSDW_ApplyZBBA_TBSel" %>
...
<body>
    ...
    <asp:DataGrid ID="dg_List" runat="server" AutoGenerateColumns="False" CssClass="m_dg1"
        ...
        <Columns>
            ...
            <asp:BoundColumn DataField="QYMC" HeaderText="投标人" ItemStyle-HorizontalAlign="Left">
            </asp:BoundColumn>
            <asp:BoundColumn DataField="LXDH" HeaderText="联系电话"></asp:BoundColumn>
            <asp:BoundColumn DataField="PBJ" HeaderText="评标价"></asp:BoundColumn>
            <asp:BoundColumn DataField="TBJ" HeaderText="投标价"></asp:BoundColumn>
            <asp:BoundColumn DataField="TBTime" HeaderText="投标文件递交时间" DataFormatString="{0:d}"></asp:BoundColumn>
