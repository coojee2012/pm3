<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ZTBQKBAList.aspx.cs" Inherits="JSDW_APPLYZBBA_ZTBQKBAList" %>
                                            ...
                                            <td style="padding-top: 10px">
                                                <table width="100%" align="center" class="m_title">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtJSDZ" runat="server" CssClass="m_txt" Width="169px"></asp:TextBox>
                                                        </td>
                                                        <td class="t_r">上报状态：
                                                        </td>
                                                        <td>
                                                            <asp:DropDownList ID="ddlFState" runat="server">
                                                                ...
                                                                <asp:ListItem Value="2">撤回</asp:ListItem>
                                                                <asp:ListItem Value="2">已接件</asp:ListItem>
                                            ...
                                            <td align="center" valign="top" colspan="2">
                                                <asp:GridView ID="gv_list" runat="server" CssClass="m_dg1" Width="100%" HorizontalAlign="Center"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField HeaderText="标段名称" />
                                                        <asp:BoundField HeaderText="标段编码" />
                                                        <asp:BoundField HeaderText="备案单位" />
                                                        <asp:BoundField HeaderText="次数" />
                                                        <asp:BoundField HeaderText="备案时间" />
                                                        <asp:BoundField HeaderText="上报时间" />
