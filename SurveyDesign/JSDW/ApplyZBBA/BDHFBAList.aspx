<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BDHFBAList.aspx.cs" Inherits="JSDW_APPLYZBBA_BDHFBAList" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function selPrj(obj) {
            var pid = showWinByReturn('../project/ProjectSel.aspx?ftype=<%=fMType %>', 1000, 500);
            if (pid != null && pid != '') {
                $("#t_FPrjId").val(pid);
                __doPostBack(obj.id, '');
            }
                    ...
                    <div>
                                                ...
                                                <table width="100%" align="center" class="m_title">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left">
                                                            ...
                                                            <asp:TextBox ID="txtFProjectName" runat="server" CssClass="m_txt" Width="195px"></asp:TextBox>
                                                        </td>
                                                        <td class="t_r">
                                                            招标方式：
                                                        </td>
                                                        <td>
                                                          <asp:DropDownList ID="ddlZBFS" runat="server" Width="200px">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:DropDownList ID="ddlZGYSFS" runat="server" Width="200px">
                                                        ...
                                                        <td>
                                                            <asp:DropDownList ID="ddlZBLB" runat="server" Width="200px">
                                                     ...
                                                     <tr>
                                                        ...
                                                        <td>
                                                            <asp:DropDownList ID="ddlFState" runat="server" Width="200px">
                                                        ...
                                                        <td>
                                                            <asp:DropDownList ID="ddlFResult" runat="server" Width="200px">
                                                                <asp:ListItem Value="-1">--全部--</asp:ListItem>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtSDate" onfocus="WdatePicker()" runat="server" CssClass="m_txt" Width="197px"></asp:TextBox>
                                                        </td>
                                                        <td class="t_r">申报日期止：
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="txtEDate" onfocus="WdatePicker()" runat="server" CssClass="m_txt" Width="197px"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                            ...
                                            <td align="center" valign="top" colspan="2">
                                                <asp:GridView ID="gv_list" runat="server" CssClass="m_dg1" Width="100%" HorizontalAlign="Center"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField HeaderText="招标编码" DataField="ZBBM">
                                                            
                                                        </asp:BoundField>
                                                        <asp:TemplateField HeaderText="项目名称">
                                                            <ItemTemplate>
                                                                <asp:LinkButton ID="btnItemSee" runat="server" CommandName="See" Text='<%# Bind("ProjectName") %>' CommandArgument='<%#Eval("FID")+"@"+Eval("FState")%>'>
                                                                </asp:LinkButton>
                                                        ...
                                                        <asp:BoundField HeaderText="办理状态">
                                                            <HeaderStyle Width="120px" />
                                                        </asp:BoundField>
                        ...
                        <table align="center" width="600" id="applyInfo" runat="server" visible="false" class="m_table">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="t_ProjectName" runat="server" CssClass="m_txt" Width="300px" ReadOnly="true"></asp:TextBox>
