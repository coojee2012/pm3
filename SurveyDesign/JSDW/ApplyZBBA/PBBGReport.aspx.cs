...
public partial class JSDW_ApplyZBBA_PBBGReport : System.Web.UI.Page
{
    ...
    void ShowEntInfo()
    {
        ...
        TC_PBBG_Record qa = db.TC_PBBG_Record.Where(t => t.FAppId.Equals(fAppId)).FirstOrDefault();
    ...
    private void Report()
    {
        ...
        TC_PBBG_Record tswj = db.TC_PBBG_Record.Where(t => t.FAppId == fAppId).FirstOrDefault();
