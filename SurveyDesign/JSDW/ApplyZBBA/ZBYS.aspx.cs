...
public partial class JSDW_ApplyZBBA_ZBYS : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            else
            {
                ...
                EgovaDB dbContext = new EgovaDB();
                var jsdw = dbContext.TC_YSWJ_Record
    ...
    {
        EgovaDB dbContext = new EgovaDB();
        TC_YSWJ_Record qa = dbContext.TC_YSWJ_Record.Where(t => t.FId == EConvert.ToString(ViewState["FID"])).FirstOrDefault();
        pageTool tool = new pageTool(this.Page);
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        TC_YSWJ_Record qa = new TC_YSWJ_Record();
        pageTool tool = new pageTool(this.Page);
        if (!string.IsNullOrEmpty(fId))
        {
            qa = dbContext.TC_YSWJ_Record.Where(t => t.FId == fId).FirstOrDefault();
        }
        else
        {
