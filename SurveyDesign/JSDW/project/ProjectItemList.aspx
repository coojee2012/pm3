<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProjectItemList.aspx.cs" Inherits="JSDW_project_ProjectItemList" %>
...
<body>
    ...
    <asp:DataGrid ID="dg_List" runat="server" AutoGenerateColumns="False" CssClass="m_dg1"
        ...
        <Columns>
            ...
            <asp:BoundColumn DataField="PrjItemName" HeaderText="工程名称">
                <ItemStyle Wrap="false" />
            </asp:BoundColumn>
            <asp:BoundColumn DataField="PrjItemTypeStr" HeaderText="工程类别">
                <ItemStyle Wrap="false" />
            </asp:BoundColumn>
