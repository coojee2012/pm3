<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProjectSel.aspx.cs" Inherits="JSDW_project_ProjectSel" %>
...
<body>
    ...
    <asp:DataGrid ID="dg_List" runat="server" AutoGenerateColumns="False" CssClass="m_dg1"
        ...
        <Columns>
            ...
            <asp:BoundColumn DataField="Address" HeaderText="建设地址"></asp:BoundColumn>
            <asp:BoundColumn DataField="AddressDeptName" HeaderText="项目所属地"></asp:BoundColumn>
            <asp:BoundColumn DataField="ProjectTypeStr" HeaderText="工程性质"></asp:BoundColumn>
