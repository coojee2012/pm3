...
public partial class JSDW_ApplySGXKZGL_Report : System.Web.UI.Page
{
    ...
    void ShowEntInfo()
    {
        ...
        TC_BZGD_Record qa = db.TC_BZGD_Record.Where(t => t.FAppId.Equals(fAppId)).FirstOrDefault();
    ...
    private void showInfo()
    {
        ...
        if (app != null)
        {
            ...
            txtFPrjName.Text = db.TC_BZGD_Record.Where(t => t.FAppId == fAppId).Select(t => t.ProjectName).FirstOrDefault();
            //已提交不能修改
