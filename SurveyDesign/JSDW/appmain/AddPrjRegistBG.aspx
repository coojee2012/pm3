<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddPrjRegistBG.aspx.cs" Inherits="JSDW_appmain_AddPrjRegistBG" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function selPrj(obj) {
            var pid = showWinByReturn('../appmain/PrjRegistSel.aspx?isBG=1', 700, 500);
            if (pid != null && pid != '') {
                $("#txtFPrjId").val(pid);
                __doPostBack(obj.id, '');
            }
...
<body>
    ...
    <table class="m_table" width="98%" align="center" id="tabSetup1" runat="server">
        <tr>
            ...
            <td>
                ...
                <input id="txtFPrjId" type="hidden" runat="server" />
        ...
        <tr>
            ...
            <td>
                <uc2:govdeptid2 ID="txtgovd_FRegistDeptId" runat="server" />
                <asp:TextBox ID="txtFAllAddress" runat="server" CssClass="m_txt" Width="200px" MaxLength="30"
                    Enabled="false"></asp:TextBox>
                <input id="txtFAddressDept" type="hidden" runat="server" />
            </td>
        </tr>
        <tr>
            <td class="t_r t_bg">
            ...
            <td>
                <asp:TextBox ID="txtFBGTime" runat="server" CssClass="m_txt" Width="100px" Enabled="false"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="t_r t_bg">
            ...
            <td>
                <asp:TextBox ID="txtFBGDesc" runat="server" CssClass="m_txt" Width="300px" Height="80px"
        ...
        <tr>
            <td class="t_c" colspan="2">
                <asp:Button ID="btnOk" runat="server" CssClass="m_btn_w2" OnClick="btnNext_Click"
                    Text="确定" OnClientClick="if(checkInfo(this)){return confirm('确认要变更项目信息吗？');}else return false;" />
    ...
    <div id="divSetup2" runat="server">
        ...
        <table class="m_table" width="98%" align="center">
            <tr>
                ...
                <td colspan="3">
                    <asp:TextBox ID="B_FBGTime" runat="server" CssClass="m_txt" Width="100px" Enabled="false"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="t_r t_bg">
                ...
                <td colspan="3">
                    <asp:TextBox ID="B_FBGDesc" runat="server" CssClass="m_txt" Width="500px" Height="40px"
            ...
            <tr>
                ...
                <td colspan="1" width="45%">
                    <asp:TextBox ID="t_FPrjName" runat="server" CssClass="m_txt" Width="250px" MaxLength="40"
                        Enabled="false"></asp:TextBox>
                    <tt>*</tt>
                </td>
                ...
                <td colspan="1">
                    <asp:TextBox ID="t_FPrjNo" runat="server" CssClass="m_txt" Enabled="false"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="t_r t_bg">
                ...
                <td colspan="3">
                    ...
                    <asp:TextBox ID="t_FAllAddress" runat="server" CssClass="m_txt" Width="224px" MaxLength="30"
                        Enabled="false"></asp:TextBox>
                    <tt>*</tt>
                </td>
            </tr>
            ...
            <tr name="tr_t1">
                ...
                <td colspan="3">
                    <asp:TextBox ID="t_TCW" runat="server" CssClass="m_txt t_r" onblur="isFloat(this)"
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="t_FMobile" runat="server" CssClass="m_txt" MaxLength="20" Width="90px"></asp:TextBox>
                    <tt>*</tt>
                </td>
            </tr>
            <tr>
    ...
    <input id="t_FId" type="hidden" runat="server" />
    </form>
</body>
