...
public partial class JSDW_AppMain_FedBack : System.Web.UI.Page
{
    ...
    private void showInfo()
    {
        ...
        var v = (from p in db.CF_Prj_BaseInfo
                 where p.FBaseinfoId == FBaseinfoId && (!string.IsNullOrEmpty(t_FPrjName.Text) ? p.FPrjName.Contains(t_FPrjName.Text) : true)
