<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PrjList.aspx.cs" Inherits="JSDW_appmain_PrjList" %>
                    ...
                    <Columns>
                        ...
                        <asp:TemplateColumn HeaderText="工程名称">
                            ...
                            <ItemTemplate>
                                ...
                                <a href='javascript:showAddWindow("AddPrjRegist.aspx?FID=<%#Eval("FID") %>",900,700);'>
                                    <%#Eval("FPrjName")%></a>
                            </ItemTemplate>
                        </asp:TemplateColumn>
