<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EntListSel.aspx.cs" Inherits="JSDW_appmain_EntListSel" %>
...
<body>
    ...
    <asp:DataGrid ID="dg_List" runat="server" AutoGenerateColumns="False" CssClass="m_dg1"
        ...
        <Columns>
            ...
            <asp:BoundColumn DataField="FName" HeaderText="单位名称" ItemStyle-HorizontalAlign="Left">
            </asp:BoundColumn>
            <asp:BoundColumn DataField="FJuridcialCode" HeaderText="组织机构代码"></asp:BoundColumn>
