<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PrjKCSJSel.aspx.cs" Inherits="JSDW_appmain_PrjKCSJSel" %>
...
<body>
    ...
    <table width="98%" align="center" class="m_title">
        ...
        <tr>
            ...
            <td colspan="4" class="t_l">
                <asp:TextBox ID="t_FName" runat="server" CssClass="m_txt" Width="250px" MaxLength="30"></asp:TextBox>
    ...
    <asp:DataGrid ID="dg_List" runat="server" AutoGenerateColumns="False" CssClass="m_dg1"
        ...
        <Columns>
            ...
            <asp:BoundColumn DataField="FPrjName" HeaderText="工程名称">
                <ItemStyle CssClass="t_l" />
            </asp:BoundColumn>
            <asp:BoundColumn DataField="FType" HeaderText="工程类别"></asp:BoundColumn>
            <asp:BoundColumn DataField="FBaseName" HeaderText="勘察单位">
                <ItemStyle CssClass="t_l" />
            </asp:BoundColumn>
            <asp:BoundColumn DataField="FReportDate" DataFormatString="{0:d}" HeaderText="成果移交时间">
                <HeaderStyle  Width="90" />
            </asp:BoundColumn>
            <asp:TemplateColumn HeaderText="选择">
                <HeaderStyle  Width="60" />
                <ItemTemplate>
                    <asp:LinkButton ID="btnLink" CommandName="Sel" runat="server" Text="选择" CommandArgument='<%#Eval("FLinkId") %>'></asp:LinkButton>
                </ItemTemplate>
            </asp:TemplateColumn>
