    ...
    <div id="div_t1" runat="server">
        <table class="m_table" width="98%" align="center">
            <tr>
                ...
                <td colspan="1">
                    <asp:TextBox ID="t_FPrjItemName" runat="server" CssClass="m_txt" Width="250px" MaxLength="50"></asp:TextBox>
                    <tt>*</tt>
                </td>
                <td class="t_r t_bg" width="12%">
                    工程编号：
                ...
                <td colspan="1">
                    <asp:TextBox ID="t_FPrjItemNo" runat="server" CssClass="m_txt" Width="200px" MaxLength="30"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="t_r t_bg">
                ...
                <td colspan="1">
                    <asp:DropDownList ID="t_FLevel" runat="server" CssClass="m_txt t_r">
                    </asp:DropDownList>
                    <tt>*</tt>
                </td>
                <td class="t_r t_bg">
                ...
                <td>
                    <asp:TextBox ID="t_GCZJ" onblur="isFloat(this)" runat="server" CssClass="m_txt t_r"
            ...
            <tr>
                ...
                <td colspan="1">
                    <asp:TextBox ID="t_FYear" onblur="isInt(this)" runat="server" CssClass="m_txt t_r"
                        Width="70px" MaxLength="9"></asp:TextBox>(年) <tt>*</tt>
                </td>
                <td class="t_r t_bg" width="12%">
                    建筑面积：
                </td>
            ...
            <tr>
                ...
                <td colspan="3">
                    <asp:TextBox ID="t_FFire" runat="server" CssClass="m_txt t_r" Width="70px" onblur="isInt(this)"
                        MaxLength="9"></asp:TextBox>(级) 地上：
                    <asp:TextBox ID="t_FFireUp" runat="server" CssClass="m_txt t_r" Width="70px" onblur="isInt(this)"
                        MaxLength="25"></asp:TextBox>(级) 地下：
                    <asp:TextBox ID="t_FFireDown" runat="server" CssClass="m_txt t_r" Width="70px" onblur="isInt(this)"
                        MaxLength="25"></asp:TextBox>(级)
                </td>
            </tr>
            <tr>
                <td class="t_r t_bg">
                ...
                <td colspan="3">
                    <asp:TextBox ID="t_FWaterproof" runat="server" CssClass="m_txt t_r" Width="70px"
                        onblur="isInt(this)" MaxLength="9"></asp:TextBox>(级) 屋面：
                    <asp:TextBox ID="t_FWaterUp" runat="server" CssClass="m_txt t_r" Width="70px" onblur="isInt(this)"
                        MaxLength="25"></asp:TextBox>(级) 地下：
                    <asp:TextBox ID="t_FWaterDown" runat="server" CssClass="m_txt t_r" Width="70px" onblur="isInt(this)"
                        MaxLength="25"></asp:TextBox>(级)
                </td>
            </tr>
            <tr>
                ...
                <td colspan="1">
                    <asp:TextBox ID="t_FIntensity" runat="server" CssClass="m_txt t_r" MaxLength="30"
                        Width="70px" onblur="isFloat(this)"></asp:TextBox>(度) <tt>*</tt>
                </td>
            </tr>
            <tr>
                <td class="t_r t_bg">
                ...
                <td colspan="1">
                    <asp:TextBox ID="t_FSeismic" runat="server" CssClass="m_txt t_r" MaxLength="25" Width="70px"></asp:TextBox>(级)
                    <tt>*</tt>
                </td>
                <td class="t_r t_bg">
                    是否节能审查：
          ...
          <%--  <tr>
                ...
                <td colspan="3" class="m_txt_M">
                    <asp:TextBox ID="t_DWGCJSGM" runat="server" CssClass="m_txt" Height="35px" TextMode="MultiLine"
            ...
            <tr>
                ...
                <td colspan="3" class="m_txt_M">
                    <asp:TextBox ID="t_DWGCMS" runat="server" CssClass="m_txt" Height="35px" TextMode="MultiLine"
            ...
            <tr>
                ...
                <td colspan="3" class="m_txt_M">
                    <asp:TextBox ID="t_BZ" runat="server" CssClass="m_txt" Height="35px" TextMode="MultiLine"
                        Width="539px" onblur="checkLength(this,100,'备注');"></asp:TextBox>
                </td>
            </tr>
        </table>
    </div>
    <div id="div_t2" runat="server" visible="false">
        <table class="m_table" width="98%" align="center">
            <tr>
                ...
                <td>
                    <asp:TextBox ID="p_FPrjItemName" runat="server" CssClass="m_txt" Width="250px" MaxLength="50"></asp:TextBox>
                    <tt>*</tt>
                </td>
                <td class="t_r t_bg" width="12%">
                    工程编号：
                ...
                <td colspan="1">
                    <asp:TextBox ID="p_FPrjItemNo" runat="server" CssClass="m_txt" Width="200px" MaxLength="30"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="t_r t_bg">
                ...
                <td>
                    <asp:TextBox ID="p_DWGCZJ" onblur="isFloat(this)" runat="server" CssClass="m_txt t_r"
                        MaxLength="20" Width="70"></asp:TextBox>(万元) <tt>*</tt>
                </td>
            </tr>
            <tr>
                ...
                <td colspan="3">
                    <asp:DropDownList ID="p_FStruType" runat="server" CssClass="m_txt">
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
                ...
                <td colspan="3" class="m_txt_M">
                    <asp:TextBox ID="p_DWGCJSGM" runat="server" CssClass="m_txt" Height="35px" TextMode="MultiLine"
                        Width="539px" onblur="checkLength(this,1000,'建设规模');"></asp:TextBox>
                </td>
            </tr>
            <tr>
                ...
                <td colspan="3" class="m_txt_M">
                    <asp:TextBox ID="p_DWGCMS" runat="server" CssClass="m_txt" Height="35px" TextMode="MultiLine"
                        Width="539px" onblur="checkLength(this,1000,'工程描述');"></asp:TextBox>
                </td>
            </tr>
            <tr>
                ...
                <td colspan="3" class="m_txt_M">
                    <asp:TextBox ID="p_BZ" runat="server" CssClass="m_txt" Height="35px" TextMode="MultiLine"
                        Width="539px" onblur="checkLength(this,100,'备注');"></asp:TextBox>
                </td>
            </tr>
        </table>
