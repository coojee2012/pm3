<%@ Page Language="C#" AutoEventWireup="true" CodeFile="XMBJ.aspx.cs" Inherits="JSDW_ApplySGXKZGL_XMBJ" %>
    ...
    <table id="table1" class="m_table" width="98%" align="center">
        ...
        <tr>
            <td class="t_r t_bg">
                总投资额： </td>
            <td colspan="1">
                <asp:TextBox ID="t_ZTZE" onblur="isFloat(this)" runat="server" CssClass="m_txt" Width="195px"></asp:TextBox>（万元）
            </td> 
            <td class="t_r t_bg">
                政府投资： </td>
            <td colspan="1">
                <asp:TextBox ID="t_ZFTZ" onblur="isFloat(this)" runat="server" CssClass="m_txt" Width="195px"></asp:TextBox>（万元）
            </td>   
        </tr>
        <tr>
            <td class="t_r t_bg" style="width:18.8%;">
            ...
            <td colspan="1" style="width:29%;">
                <asp:TextBox ID="t_ZCTZ" onblur="isFloat(this)" runat="server" CssClass="m_txt" Width="195px"></asp:TextBox>（万元）
            </td>
            <td class="t_r t_bg">
                贷款投资： </td>
            <td colspan="1">
                <asp:TextBox ID="t_DKTZ" onblur="isFloat(this)" runat="server" CssClass="m_txt" Width="195px"></asp:TextBox>（万元）
            </td>   
        ...
        <tr>
            ...
            <td colspan="1" style="width:29%;">
                <asp:TextBox ID="t_WSTZ" onblur="isFloat(this)" runat="server" CssClass="m_txt" Width="195px"></asp:TextBox>（万元）
            </td> 
            <td class="t_r t_bg">
                其它投资： </td>
            <td colspan="1">
                <asp:TextBox ID="t_QTTZ" onblur="isFloat(this)" runat="server" CssClass="m_txt" Width="195px"></asp:TextBox>（万元）
            </td>   
        </tr>
        <tr>
            <td class="t_r t_bg" style="width:18.8%;">
            ...
            <td colspan="1" style="width:29%;">
                <asp:TextBox ID="t_YDMJ" onblur="isFloat(this)" runat="server" CssClass="m_txt" Width="195px"></asp:TextBox>（m2）
            </td> 
            <td class="t_r t_bg">
                建筑面积： </td>
            <td colspan="1">
        ...
        <tr>
            ...
            <td colspan="3" style="width:29%;">
                <asp:TextBox ID="t_Building" runat="server" CssClass="m_txt" Width="195px"></asp:TextBox>（栋）
            </td>
        </tr>
        <tr>
            <td class="t_r t_bg" style="width:18.8%;">
            ...
            <td colspan="1" style="width:29%;">
                <asp:TextBox ID="t_UpFloor" runat="server" CssClass="m_txt" Width="195px"></asp:TextBox>（层）
            </td> 
            <td class="t_r t_bg">
                地下层数： </td>
            <td colspan="1">
                <asp:TextBox ID="t_DownFloor" runat="server" CssClass="m_txt" Width="195px"></asp:TextBox>（层）
            </td>   
        </tr>
        <tr>
            <td class="t_r t_bg" style="width:18.8%;">
            ...
            <td class="t_r t_bg">
                最大跨度： </td>
            <td colspan="1">
                <asp:TextBox ID="t_Span" onblur="isFloat(this)" runat="server" CssClass="m_txt" Width="195px"></asp:TextBox>（m）
            </td>   
        </tr>
        <tr>
            <td class="t_r t_bg">
                计划开工日期： </td>
            <td colspan="1">
                <asp:TextBox ID="t_PlanStartTime" onfocus="WdatePicker()" runat="server" CssClass="m_txt" Width="195px"></asp:TextBox>
            </td>
            <td class="t_r t_bg">
                计划竣工日期： </td>
            <td colspan="1">
                <asp:TextBox ID="t_PlanEndTime" onfocus="WdatePicker()" runat="server" CssClass="m_txt" Width="195px"></asp:TextBox>
            </td>
        </tr>     
        <tr>
            <td class="t_r t_bg">
            ...
            <td colspan="1">
                <asp:DropDownList ID="t_FBFS" runat="server" CssClass="m_txt" Width="201px">
        ...
        <tr>
            ...
            <td colspan="3" class="m_txt_M">
                <asp:TextBox ID="t_XMJSNR" runat="server" CssClass="m_txt" Height="35px" TextMode="MultiLine"
                    Width="663px" onblur="checkLength(this,1000,'项目建设内容');"></asp:TextBox>
            </td>
        </tr>
    </table>
        <table width="98%" align="center" class="m_bar">
