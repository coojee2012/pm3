<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ZLAQJDSXList.aspx.cs" Inherits="JSDW_ApplySGXKZGL_ZLAQJDSXList" %>
    ...
    <table id="table1" class="m_table" width="98%" align="center">
        ...
        <tr>
            <td class="t_r t_bg">
                质量备案编号： </td>
            <td colspan="3">
                <asp:TextBox ID="t_ZLBABH" runat="server" CssClass="m_txt" Width="195px"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="t_r t_bg">
                质量备案机关： </td>
            <td colspan="1">
                <asp:TextBox ID="t_ZLBAJG" runat="server" CssClass="m_txt" Width="195px"></asp:TextBox>
            </td>
            <td class="t_r t_bg">
                质量备案时间： </td>
            <td colspan="1">
                <asp:TextBox ID="t_ZLBATime" onfocus="WdatePicker()" runat="server" CssClass="m_txt" Width="195px"></asp:TextBox>
            </td>   
        </tr>
        <tr>
            <td class="t_r t_bg">
                安全备案编号： </td>
            <td colspan="1">
                <asp:TextBox ID="t_AQBABH" runat="server" CssClass="m_txt" Width="195px" ReadOnly="true"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="t_r t_bg">
                安全备案机关： </td>
            <td colspan="1">
                <asp:TextBox ID="t_AQBAJG" runat="server" CssClass="m_txt" Width="195px"></asp:TextBox>
            </td>
            <td class="t_r t_bg">
                安全备案时间： </td>
            <td colspan="1">
                <asp:TextBox ID="t_AQBATime" onfocus="WdatePicker()" runat="server" CssClass="m_txt" Width="195px"></asp:TextBox>
            </td>   
        </tr>
    </table>
        <table width="98%" align="center" class="m_bar">
