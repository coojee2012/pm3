...
public partial class JSDW_ApplySGXKZGL_QTZLList : System.Web.UI.Page
{
    ...
    private void ShowTitle()
    {
        ...
        TC_SGXKZ_QTZL sp = dbContext.TC_SGXKZ_QTZL.Where(t => t.FAppId == EConvert.ToString(ViewState["FAppId"])).FirstOrDefault();
        if (sp != null)
        {
            txtFId.Value = sp.FId;
            ShowFile(sp.FId);
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        TC_SGXKZ_QTZL qa = new TC_SGXKZ_QTZL();
        pageTool tool = new pageTool(this.Page);
        if (!string.IsNullOrEmpty(fId))
        {
            qa = dbContext.TC_SGXKZ_QTZL.Where(t => t.FId == fId).FirstOrDefault();
        }
        else
        {
            ...
            dbContext.TC_SGXKZ_QTZL.InsertOnSubmit(qa);
        }
