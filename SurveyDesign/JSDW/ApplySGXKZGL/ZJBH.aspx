<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ZJBH.aspx.cs" Inherits="JSDW_ApplySGXKZGL_ZJBH" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <tr name="tr1">
            ...
            <tr>
                <td class="t_r t_bg">是否办理担保书：
                </td>
                <td colspan="3">
                    <asp:DropDownList ID="t_ISDBS" class="cc1" runat="server" CssClass="m_txt" Width="60%">
            ...
            <tr>
                <td class="t_r t_bg">资金保函或证明： </td>
                <td colspan="3">
                    <asp:TextBox ID="t_ZJBH" class="cc1" Height="35px" TextMode="MultiLine" runat="server" CssClass="m_txt" Width="72.2%"></asp:TextBox><tt>*</tt>
                </td>

            </tr>
            <tr>
                <td class="t_r t_bg" style="width: 18.8%;">甲方：
                </td>
                <td colspan="1" style="width: 29%;">
                    <asp:TextBox ID="t_JF" class="cc1" runat="server" CssClass="m_txt" Width="60%"></asp:TextBox><tt>*</tt>
                </td>
                <td class="t_r t_bg">乙方： </td>
                <td>
                    <asp:TextBox ID="t_YF" class="cc1" runat="server" CssClass="m_txt" Width="44%"></asp:TextBox><tt>*</tt>
                </td>
            </tr>
