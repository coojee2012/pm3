<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JSZLList.aspx.cs" Inherits="JSDW_ApplySGXKZGL_JSZLList" %>
    ...
    <table id="table1" class="m_table" width="98%" align="center">
        ...
        <tr > 
            ...
            <td class="t_r t_bg">
                审查报告编号： </td>
            <td colspan="1">
                <asp:TextBox ID="t_SCBGBH" runat="server" CssClass="m_txt" Width="195px"></asp:TextBox>
            </td>     
        </tr>
        <tr>
            <td class="t_r t_bg">
                审查合格书编号： </td>
            <td colspan="1">
                <asp:TextBox ID="t_SCHGSBH" runat="server" CssClass="m_txt" Width="195px"></asp:TextBox>
            </td>   
            <td class="t_r t_bg" style="width:18.8%;">
                发证日期：
            </td>
        ...
        <tr>
            ...
            <td colspan="1" style="width:29%;">
                <asp:TextBox ID="t_CSTJG" runat="server" CssClass="m_txt" Width="195px"></asp:TextBox>
            </td>
            <td class="t_r t_bg">
                资质等级： </td>
            <td colspan="1">
        ...
        <tr>
            <td class="t_r t_bg">
                证书编号： </td>
            <td colspan="3">
                <asp:TextBox ID="t_ZSBH" runat="server" CssClass="m_txt" Width="195px"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="t_r t_bg">
                法定代表人： </td>
            <td colspan="1">
                <asp:TextBox ID="t_FR" runat="server" CssClass="m_txt" Width="195px"></asp:TextBox>
            </td>
            <td class="t_r t_bg">
                技术负责人： </td>
            <td colspan="1">
                <asp:TextBox ID="t_JSFZR" runat="server" CssClass="m_txt" Width="195px"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="t_r t_bg">
                备查部门： </td>
            <td colspan="1">
                <asp:TextBox ID="t_BABM" runat="server" CssClass="m_txt" Width="195px"></asp:TextBox>
            </td>
            <td class="t_r t_bg">
                备案编号： </td>
            <td colspan="1">
        ...
        <tr>
            <td class="t_r t_bg">
                备案时间： </td>
            <td colspan="3">
                <asp:TextBox ID="t_BATime" onfocus="WdatePicker()" runat="server" CssClass="m_txt" Width="195px"></asp:TextBox>
            </td>
        </tr>     
    </table>
        <table width="98%" align="center" class="m_bar">
