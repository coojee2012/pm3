<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SGZZSJList.aspx.cs" Inherits="JSDW_ApplySGXKZGL_SGZZSJList" %>
    ...
    <table id="table1" class="m_table" width="98%" align="center">
        ...
        <tr>
            ...
            <td colspan="3" class="m_txt_M">
                <asp:TextBox ID="t_SGZZSJ" runat="server" CssClass="m_txt" Height="35px" TextMode="MultiLine"
                    Width="640px" onblur="checkLength(this,2000,'施工组织设计');"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="t_r t_bg">
                施工图组织设计会签表： </td>
            <td colspan="1">
                <asp:DropDownList ID="t_SGZZSJHQB" runat="server" CssClass="m_txt" Width="201px">
            ...
            <td class="t_r t_bg">
                会签日期： </td>
            <td colspan="1">
                <asp:TextBox ID="t_HQTime" onfocus="WdatePicker()" runat="server" CssClass="m_txt" Width="195px"></asp:TextBox>
            </td>   
        </tr>
