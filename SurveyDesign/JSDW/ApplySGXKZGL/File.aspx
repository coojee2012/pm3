<%@ Page Language="C#" AutoEventWireup="true" CodeFile="File.aspx.cs" Inherits="JSDW_ApplySGXKZGL_File" %>
...
<body>
    ...
    <table align="center" class="m_table" style="width: 98%">
        <tr>
            ...
            <td>
                <asp:TextBox ID="t_FileName" runat="server" CssClass="m_txt" Width="300"></asp:TextBox>
                <tt>*</tt>
            </td>
        </tr>
        <tr name="t_r2">
