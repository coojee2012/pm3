...
public partial class JSDW_ApplySGXKZGL_ZTBList : System.Web.UI.Page
{
    ...
    private void showInfo()
    {
        EgovaDB dbContext = new EgovaDB();
        var v =
        from t in dbContext.TC_SGXKZ_ZBJG
        ...
        select new
        {
            ...
            t.ZBTZSBH,
            t.Area,
            JLZBLXStr = dbContext.CF_Sys_Dic.Where(d => d.FNumber == Convert.ToInt32(t.JLZBLX)).Select(d => d.FName).FirstOrDefault(),
            t.FId
        };
    ...
    protected void App_List_ItemDataBound(object sender, DataGridItemEventArgs e)
    {
        if (e.Item.ItemIndex > -1)
        {
            ...
            e.Item.Cells[2].Text = "<a href='javascript:void(0)' onclick=\"showAddWindow('ZBJGList.aspx?fId=" + fId + "',1300,700);\">" + e.Item.Cells[2].Text + "</a>";
        }
    }
