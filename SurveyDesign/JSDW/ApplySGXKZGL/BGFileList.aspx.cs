...
public partial class JSDW_ApplySGXKZGL_BGFileList : System.Web.UI.Page
{
    ...
    protected void rep_List_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
        {
            ...
            int FFileCount = EConvert.ToInt(DataBinder.Eval(e.Item.DataItem, "FFileCount"));
            ...
            if (AppFile != null && AppFile.Count() > 0)
            {
                ...
                if (AppFile.Count() < FFileCount)
                {
                    ((Literal)e.Item.FindControl("lit_Has")).Text = "<font color='green'>是</font><input type=\"button\" class=\"m_btn_w4\" value=\"上传文件\" onclick='showAddWindow(\"FileUp.aspx?FMaterialTypeId=" + FId + "&&FFileName=" + FFileName + "\",500,250);' />";
