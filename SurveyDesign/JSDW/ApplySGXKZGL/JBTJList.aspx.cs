...
public partial class JSDW_ApplySGXKZGL_JBTJList : System.Web.UI.Page
{
    ...
    private void ShowTitle()
    {
        ...
        TC_SGXKZ_JBTJ sp = dbContext.TC_SGXKZ_JBTJ.Where(t => t.FAppId == EConvert.ToString(ViewState["FAppId"])).FirstOrDefault();
        if (sp != null)
        {
            txtFId.Value = sp.FId;
            ShowFile(sp.FId);
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        TC_SGXKZ_JBTJ qa = new TC_SGXKZ_JBTJ();
        pageTool tool = new pageTool(this.Page);
        if (!string.IsNullOrEmpty(fId))
        {
            qa = dbContext.TC_SGXKZ_JBTJ.Where(t => t.FId == fId).FirstOrDefault();
        }
        else
        {
            ...
            dbContext.TC_SGXKZ_JBTJ.InsertOnSubmit(qa);
        }
