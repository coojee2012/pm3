<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QTZLList.aspx.cs" Inherits="JSDW_ApplySGXKZGL_QTZLList" %>
    ...
    <table id="table1" class="m_table" width="98%" align="center">
        ...
        <tr>
            ...
            <td colspan="3" class="m_txt_M">
                <asp:TextBox ID="t_QTZL" runat="server" CssClass="m_txt" Height="35px" TextMode="MultiLine"
