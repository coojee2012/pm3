<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TGGLList.aspx.cs" Inherits="JSDW_ApplySGXKZGL_TGGLList" %>
...
<body>
    ...
    <table width="98%" align="center" class="m_title">
        <tr>
            <th colspan="7">
                <asp:Literal ID="lPostion" runat="server">停工申请</asp:Literal>
            </th>
        </tr>
        <tr>
            <td class="t_r">
 ...
 <table width="98%" align="center" class="m_bar">
        <tr>
            ...
            <td class="t_r">
                <asp:Button ID="btnCheck" runat="server" CssClass="m_btn_w2" Text="申请" OnClientClick="return app('TGSQInfo.aspx')" />
