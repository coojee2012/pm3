<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ZTBList.aspx.cs" Inherits="JSDW_ApplySGXKZGL_ZTBList" %>
    ...
    <table id="table1" class="m_table" width="98%" align="center">
        ...
        <table width="98%" align="center" class="m_bar">
            <tr>
                ...
                <td>
                    <label runat="server" id="lblTitle"> 招投标信息</label>     
                </td>
                <td class="t_r">
        ...
        <asp:DataGrid ID="dg_List" runat="server" AutoGenerateColumns="false" CssClass="m_dg1"
            ...
            <Columns>
                ...
                <asp:BoundColumn HeaderText="中标通知书编号" DataField="ZBTZSBH">
                    <ItemStyle Wrap="False" />
                </asp:BoundColumn>
                <asp:BoundColumn HeaderText="总面积（平方米）" DataField="Area">
                    <ItemStyle Wrap="False" />
                </asp:BoundColumn>
