<%@ Page Language="C#" AutoEventWireup="true" CodeFile="YQBLList.aspx.cs" Inherits="JSDW_APPLYSGXKZGL_YQBLList" %>
<%@ Register Src="../../common/govdeptid.ascx" TagName="govdeptid" TagPrefix="uc1" %>
<%@ Register Assembly="AspNetPager" Namespace="Wuqi.Webdiyer" TagPrefix="webdiyer" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>施工许可证管理延期办理</title>
    ...
    <script type="text/javascript" language="javascript">
        ...
        function selPrj(obj) {
            var pid = showWinByReturn('../ApplySGXKZGL/ProjectItemSelForYQ.aspx?ftype=<%=fMType %>', 700, 500);
            if (pid != null && pid != '') {
                        ...
                        <table align="center" width="600" id="applyInfo" runat="server" visible="false" class="m_table">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input id="t_FPrjInfoId" type="hidden" runat="server" />
                                    <input id="t_YQCS" type="hidden" runat="server" />
