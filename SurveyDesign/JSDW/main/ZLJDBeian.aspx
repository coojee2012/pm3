<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ZLJDBeian.aspx.cs" Inherits="EntSelf_MainSelf_zWXTS" %>
    ...
    <table height="95%" width="98%" align="center">
        ...
        <tr>
            ...
            <td class="wxts_m">
                ...
                <div style="width: 98%; margin: 0 auto; height:32px;">
                ...
                <div style="width: 98%; margin: 0 auto;">
                    <asp:DataGrid ID="App_List" runat="server" AutoGenerateColumns="False" CssClass="m_dg1"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateColumn HeaderText="工程名称">
                                ...
                                <ItemTemplate>
                                    <a href='javascript:showAddWindow("../appmain/AddPrjRegist.aspx?fid=<%#Eval("FPrjId") %>",800,700);'>
                                        <%#Eval("FPrjName")%>
                                    </a>
                                    <asp:Literal ID="prj_Count" runat="server"></asp:Literal>
                                </ItemTemplate>
                            </asp:TemplateColumn>
                            <asp:BoundColumn HeaderText="申报日期起"></asp:BoundColumn>
                            <asp:BoundColumn HeaderText="申报日期止"></asp:BoundColumn>
                            <asp:BoundColumn HeaderText="上报状态">
                            </asp:BoundColumn>
                            <asp:BoundColumn HeaderText="审批状态"></asp:BoundColumn>
                            <asp:BoundColumn HeaderText="审批结果"></asp:BoundColumn>
                            <asp:TemplateColumn HeaderText="操作" Visible="false">
                                <HeaderStyle Width="60" />
                                <ItemTemplate>
                                    <asp:LinkButton ID="btnOp" runat="server" CommandArgument='<%#Eval("FID")+","+Eval("FManageTypeId")+","+Eval("FState")%>'>
                                    </asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateColumn>
                            <asp:BoundColumn DataField="FId" Visible="False"></asp:BoundColumn>
                    ...
                    <div style="margin: 4px auto;">
                        <tt>提示：点击“工程名称”查看工程情况，点击“业务名称”办理或查看业务。</tt>
                    </div>
                </div>
            </td>
            <td class="wxts_r">
