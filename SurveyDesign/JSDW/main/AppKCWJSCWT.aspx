<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AppKCWJSCWT.aspx.cs" Inherits="JSDW_main_AppKCWJSCWT" %>
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateColumn HeaderText="操作">
                                                            ...
                                                            <ItemTemplate>
                                                                ...
                                                                <br />
                                                                <br />
                                                                <asp:LinkButton ID="btnRe" runat="server" CommandArgument='<%#Eval("FAppId")%>' Visible="false">
                                                                </asp:LinkButton>
                                                            </ItemTemplate>
                                                        </asp:TemplateColumn>
