<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AppZLJDBeian.aspx.cs" Inherits="JSDW_main_AppDesign" %>

<%@ Register Assembly="AspNetPager" Namespace="Wuqi.Webdiyer" TagPrefix="webdiyer" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>质量监督备案申请</title>
    ...
    <script type="text/javascript" language="javascript">
        ...
        function selPrj(obj) {
            ...
            //293:设计单位成果移交
            var pid = showWinByReturn('../appmain/PrjRegistSel.aspx?ftype=<%=fMType %>&needfType=293', 700, 500);
            if (pid != null && pid != '') {
                $("#HPid").val(pid);
                __doPostBack(obj.id, '');
            }
                                            ...
                                            <table width="100%" id="Table1" runat="server">
                                                <tr>
                                                    <td height="27" class="txt23" style="padding-left: 1px; margin-top: 6px;">
                                                        项目名称：<asp:TextBox ID="TextBox1" runat="server" CssClass="m_txt" Width="100px"></asp:TextBox>
                                                        工程名称：<asp:TextBox ID="TextBox2" runat="server" CssClass="m_txt" Width="100px"></asp:TextBox>
                                                        申报日期起：<asp:TextBox ID="TextBox3" runat="server" CssClass="m_txt" Width="100px"></asp:TextBox>
                                                        申报日期止：<asp:TextBox ID="TextBox4" runat="server" CssClass="m_txt" Width="100px"></asp:TextBox>
                                                       
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td height="27" class="txt23" style="padding-left: 1px; margin-top: 6px;">   
                                                      上报状态：<asp:DropDownList ID="ddlFState" runat="server">
                                                            <asp:ListItem Value="">--全部--</asp:ListItem>
                                                            <asp:ListItem Value="0">未上报</asp:ListItem>
                                                            <asp:ListItem Value="1">已上报</asp:ListItem>
                                                            <asp:ListItem Value="2">退回重报</asp:ListItem>
                                                        </asp:DropDownList>
                                                        &nbsp; 审批状态：<asp:DropDownList ID="ddlFState1" runat="server">
                                                            <asp:ListItem Value="">--全部--</asp:ListItem>
                                                            <asp:ListItem Value="0">未办结</asp:ListItem>
                                                            <asp:ListItem Value="1">已办结</asp:ListItem>                              
                                                        </asp:DropDownList>
                                                        &nbsp; 审核结果：<asp:DropDownList ID="ddlFResault" runat="server">
                                                            <asp:ListItem Value="">--全部--</asp:ListItem>
                                                        ...
                                                        <asp:Button ID="btnPup" runat="server" CssClass="m_btn_w14" CommandArgument="1" OnClick="btn_Click" Text="新增质量监督备案">
                                                        </asp:Button>
                                                    </td>
                                                </tr>
                                            </table>
                                        ...
                                        <td align="center" valign="top" colspan="2">
                                            <asp:DataGrid ID="DG_List" runat="server" AutoGenerateColumns="False" CssClass="m_dg1"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundColumn DataField="FwriteDate" DataFormatString="{0:d}" HeaderText="上报时间">
                                                    </asp:BoundColumn>
