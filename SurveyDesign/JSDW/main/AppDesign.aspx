<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AppDesign.aspx.cs" Inherits="JSDW_main_AppDesign" %>

<%@ Register Assembly="AspNetPager" Namespace="Wuqi.Webdiyer" TagPrefix="webdiyer" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>初步设计文件审查申报</title>
                                                ...
                                                <tr>
                                                    <td height="27" class="txt23" style="padding-left: 1px; margin-top: 6px;">
                                                        ...
                                                        &nbsp; 办理状态：<asp:DropDownList ID="ddlFState" runat="server">
                                                            ...
                                                            <asp:ListItem Value="2">被退回</asp:ListItem>
