<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AppXMKCWT.aspx.cs" Inherits="EvaluateEntApp_main_AppXMKCWT" %>
                                            ...
                                            <table width="100%" id="Table1" runat="server">
                                                ...
                                                <tr>
                                                    <td height="27" class="txt23" style="padding-left: 1px; margin-top: 6px;">
                                                        ...
                                                        <asp:Button ID="btnPup" runat="server" CssClass="m_btn_w12" CommandArgument="1" OnClick="btn_Click">
                                                        </asp:Button>
                                                    </td>
                                                </tr>
                                            </table>
                                            ...
                                            <div style="width: 98%; margin: auto;">
                                                <asp:DataGrid ID="DG_List" runat="server" AutoGenerateColumns="False" CssClass="m_dg1"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateColumn HeaderText="工程名称">
                                                            ...
                                                            <ItemTemplate>
                                                                <asp:LinkButton ID="btnItemSee" runat="server" CommandName="See" Text='<%#Eval("FPrjName") %>'
                                                                    CommandArgument='<%#Eval("FID")+","+Eval("FState")%>'>'>
                                                                </asp:LinkButton>
                                                        ...
                                                        <asp:BoundColumn HeaderText="勘察单位办理结果">
                                                            <ItemStyle CssClass="lh t_l" />
                                                        </asp:BoundColumn>
                                                        <asp:BoundColumn HeaderText="见证单位办理结果">
                                                            <ItemStyle CssClass="lh t_l" />
                                                        </asp:BoundColumn>
