...
<head id="Head1" runat="server">
    ...
    <script language="javascript">
        ...
        function showUpPicWindow(sUrl, width, height) {
            ...
            var idvalue = window.showModalDialog(sUrl + '?fileid=' + document.getElementById('hidden_Fid').value + '&rid=' + Math.random(), '', 'dialogWidth:' + width + 'px; dialogHeight:' + height + 'px; center:yes; resizable:yes; status:no; help:no;scroll:no;')
...
<body>
    ...
    <table class="m_table" width="98%" align="center">
        <tr>
            <td class="t_r t_bg">
                <asp:Label ID="labTitle" runat="server" Text="添加附件"></asp:Label>文件编号：
            </td>
            <td>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="t_FCount" runat="server" Width="247px" onblur="isInt(this)" CssClass="m_txt"
        ...
        <tr>
            <td align="center" height="21" colspan="2">
                <input id="btnAdd" onclick="showUpPicWindow('UploadPhoto.aspx',554,234);" type="button"
