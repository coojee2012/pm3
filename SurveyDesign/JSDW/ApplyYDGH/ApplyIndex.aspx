                                    ...
                                    <table width="100%" id="Table1" runat="server">
                                        ...
                                        <tr>
                                            <td height="27" class="txt23" style="padding-left: 1px; margin-top: 6px;">业务名称：<asp:TextBox ID="t_YWFname" runat="server" CssClass="m_txt" Width="150px"></asp:TextBox>
                                                ...
                                                <input type="button"  class="m_btn_w12" onclick="javascript: window.location.href = 'ApplyFor.aspx'" value="新增用地规划申请" />
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                ...
                                <td align="center" valign="top" colspan="2">
                                    <asp:DataGrid ID="DG_List" runat="server" AutoGenerateColumns="False" CssClass="m_dg1"
                                       ...
                                       <%--     <asp:TemplateColumn HeaderText="选址名称">
                                             ...
                                             <asp:BoundColumn DataField="YDGHMC" HeaderText="项目名称"></asp:BoundColumn>
