...
<body>
    ...
    <asp:GridView ID="File_list" runat="server" AutoGenerateColumns="False" BorderWidth="1px"
        CssClass="m_dg1" Style="margin-top: 6px; width: 98%;" OnRowDataBound="File_list_RowDataBound"
        align="center">
