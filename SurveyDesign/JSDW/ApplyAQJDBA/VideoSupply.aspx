<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VideoSupply.aspx.cs" Inherits="JSDW_ApplyAQJDBA_VideoSupply" %>
...
<head id="Head1" runat="server">
    ...
    <script>
        ...
        function addPrjPlan() {
            ...
            showAddWindow('VideoList.aspx?fAppId=' + fid, 800, 550);
        }
    </script>
...
<body style="margin-left: 5px; margin-right: 5px;">
    ...
    <asp:DataGrid ID="Ent_List" runat="server" AutoGenerateColumns="False" CssClass="m_dg1"
        ...
        <Columns>
            ...
            <asp:BoundColumn HeaderText="视频供应商" DataField="VideoProvider">
