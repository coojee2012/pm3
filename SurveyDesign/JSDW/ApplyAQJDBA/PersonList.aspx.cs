...
public partial class JSDW_ApplyAQJDBA_PersonList : System.Web.UI.Page
{
    ...
    {
        var v = from t in dbContext.TC_AJBA_Human
                orderby t.XMZW
                select new
                {
                    t.FAppId,
    ...
    protected void btnDel_Click(object sender, EventArgs e)
    {
        ...
        tool.DelInfoFromGrid(dg_List, dbContext.TC_AJBA_Human, tool_Deleting);
        ShowTitle();
    }
    //主要人员删除
    private void tool_Deleting(System.Collections.Generic.IList<string> FIdList, System.Data.Linq.DataContext context)
    {
        if (dbContext != null)
        {
            var para = dbContext.TC_AJBA_Human.Where(t => FIdList.ToArray().Contains(t.FId));
            dbContext.TC_AJBA_Human.DeleteAllOnSubmit(para);
        }
    }
