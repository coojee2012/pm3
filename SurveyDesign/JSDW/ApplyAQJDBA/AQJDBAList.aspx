<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AQJDBAList.aspx.cs" Inherits="JSDW_APPLYZLJDBN_AQJDBAList" %>

<%@ Register Assembly="AspNetPager" Namespace="Wuqi.Webdiyer" TagPrefix="webdiyer" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>安全监督备案申请</title>
                    ...
                    <div>
                                        ...
                                        <td style="padding-top: 10px">
                                            <table width="100%" id="Table1" runat="server">
                                                ...
                                                <tr style ="height:30px;">               
                                                    ...
                                                    <td>
                                                       <asp:TextBox ID="txtSDate" onfocus="WdatePicker()" runat="server" CssClass="m_txt" Width="150px" ></asp:TextBox>
                                                    </td>
                                                    <td class="t_r">
                                                        申报日期止：
                                                    </td>
                                                    <td>
                                                        <asp:TextBox ID="txtEDate" onfocus="WdatePicker()" runat="server" CssClass="m_txt" Width="150px" ></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr style ="height:30px;">
                                                    <td class="t_r">
                                                    ...
                                                    <td>
                                                        <asp:DropDownList ID="ddlFState" runat="server" Width="156px">
                                                    ...
                                                    <td>
                                                        <asp:DropDownList ID="ddlFResult" runat="server" Width="156px">
                                                            <asp:ListItem Value="-1">--全部--</asp:ListItem>
                     ...
                     <table align="center" width="600" id="applyInfo" runat="server" visible="false" class="m_table">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="t_FPrjItemName" runat="server" CssClass="m_txt" ReadOnly="true" Width="300px"></asp:TextBox>
