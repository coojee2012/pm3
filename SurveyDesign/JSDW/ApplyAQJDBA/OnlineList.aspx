<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OnlineList.aspx.cs" Inherits="JSDW_ApplyAQJDBA_OnlineList" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function addOnline() {
            ...
            showAddWindow('Online.aspx?fAppId=' + fid, 800, 550);
        }
    </script>
...
<body>
    ...
    <asp:DataGrid ID="dg_List" runat="server" AutoGenerateColumns="False" CssClass="m_dg1"
        ...
        <Columns>
            ...
            <asp:BoundColumn DataField="FMobile" HeaderText="移动电话">
                <ItemStyle Wrap="false" />
            </asp:BoundColumn>
