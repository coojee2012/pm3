<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ApplyBaseInfo.aspx.cs" Inherits="JSDW_applycbsjwt_ApplyBaseInfo" %>
...
<body>
    ...
    <table class="m_table" width="98%" align="center">
        ...
        <tr>
            ...
            <td colspan="3">
                <asp:CheckBox runat="server" ID="t_FFloat10" onclick="isVisible();" />
            </td>
        </tr>
        ...
        <tr>
            ...
            <td class="t_l t_bg" colspan="3">
                ...
                <tt>*</tt>
                <asp:Button ID="btnMod" runat="server" Text="选择..." CssClass="m_btn_w4" OnClientClick="return selEnt('k_FBaseInfoId',1553,this);"
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="k_FMoney" runat="server" CssClass="m_txt" MaxLength="20" onblur="isFloat(this);" ></asp:TextBox>(万元) 
            </td>
            <td class="t_r t_bg">
                要求完成日期：
            </td>
    ...
    <table runat="server" class="m_table" width="98%" align="center" id="otherSJ" style="display: none;">
        <tr>
            ...
            <td class="t_r t_bg">
                <input type="hidden" runat="server" id="sj_FBaseInfoId" />
                <input type="hidden" runat="server" id="sj_FBaseInfoId_c" />
                <asp:Button ID="btnAdd" runat="server" Text="新增" CssClass="m_btn_w4" OnClientClick="return doSelOther('sj_FBaseInfoId',this,'1553','1','k_FBaseInfoId','请先选择上方的‘主要设计单位’！');"
                    CommandArgument="15503" UseSubmitBehavior="false" OnClick="btnAddKC_Click" />
            </td>
        </tr>
        <tr>
    ...
    <table class="m_table" width="98%" align="center">
        ...
        <tr>
            ...
            <td colspan="3">
                <asp:CheckBox runat="server" ID="t_FFloat11" onclick="isVisible();" />
            </td>
        </tr>
        ...
        <tr>
            ...
            <td class="t_l t_bg" colspan="3">
                ...
                <asp:Button ID="btnChoose" runat="server" Text="选择..." CssClass="m_btn_w4" OnClientClick="return selEnt('s_FBaseInfoId',1554,this);"
                    UseSubmitBehavior="false" CommandName="KC" OnClick="btnSel_Click" />
                <asp:Button ID="btnClear" runat="server" Text="清空" CssClass="m_btn_w4" UseSubmitBehavior="false"
    ...
    <table runat="server" class="m_table" width="98%" align="center" id="otherKC" style="display: none;">
        <tr>
            ...
            <td class="t_r t_bg">
                ...
                <asp:Button ID="btnDel" runat="server" Text="新增" CssClass="m_btn_w4" OnClientClick="return doSelOther('kc_FBaseInfoId',this,'1554','1','s_FBaseInfoId','请先选择上方的‘主要勘察单位’！');"
                    CommandArgument="15502" UseSubmitBehavior="false" OnClick="btnAddKC_Click" />
            </td>
        </tr>
        <tr>
            <td colspan="2" align="center">
                    ...
                    <asp:Repeater runat="server" ID="repeaterDisplay_KC" OnItemDataBound="repeaterDisplay_ItemDataBound"
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td>
                                    <asp:LinkButton runat="server" ID="btnDel" OnClientClick="return confirm('确定要删除吗')"
                                        Text="删除" CommandName="Delete_KC" CommandArgument='<%#Eval("fid") %>'></asp:LinkButton>
                                </td>
                            </tr>
                        </ItemTemplate>
                    </asp:Repeater>
