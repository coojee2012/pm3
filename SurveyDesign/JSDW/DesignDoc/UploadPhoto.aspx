<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UploadPhoto.aspx.cs" Inherits="GH_GHCG_UploadPhoto" %>
    ...
    <script type="text/javascript">
        function SelectFiles() {
            ...
            if (rv != null && rv.split('|')[0] != 'undefined') {
                ...
                $('#t_FFileSize').val(eval(rv.split('|')[1]));
    ...
    <table align="center" class="m_table" style="width: 98%">
        ...
        <tr>
            ...
            <td style="padding: 4px; line-height: 28px;">
                ...
                <asp:Button id="btnSelect" runat="server" class="m_btn_w6" OnClientClick="SelectFiles();" OnClick="btnQuery_Click" type="button"
                    Text="选择文件..." />
            </td>
        </tr>
    </table>
