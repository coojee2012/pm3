...
public partial class JSDW_appmain_Report : Page
{
    ...
    private void Report()
    {
        ...
        if (app != null)
        {
            ...
            {
                s = "“" + CurrentEntUser.EntName + "”接受了工程“" + txtFPrjName.Text + "”的施工图设计文件编制合同申请。";

                idea.FContent = t_FTxt19.Text;
                idea.FAppTime = EConvert.ToDateTime(txtFDate6.Text);


                //办完“受理”后 创建下一个业务“施工图设计文件编制人员安排29701”
                if (!CreateNewApp(app.FPrjId, app.FLinkId, txtFPrjName.Text, 29701))
                {
            ...
            {
                s = "“" + CurrentEntUser.EntName + "”退回了工程“" + txtFPrjName.Text + "”的施工图设计文件编制合同备案申请。";
                idea.FResultInt = 2;
                idea.FResult = "退回";
