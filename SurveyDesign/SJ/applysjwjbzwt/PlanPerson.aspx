<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PlanPerson.aspx.cs" Inherits="JSDW_applycbsjwt_PlanPerson" %>
...
<body>
    ...
    <table width="98%" align="center" class="m_title">
        <tr>
            <th colspan="5">
                <asp:Literal ID="lit_title" runat="server" Text="施工图设计文件编制人员安排"></asp:Literal>
            </th>
        </tr>
    </table>
    <table width="98%" align="center" class="m_bar">
        <tr>
            ...
            <td class="t_r">
                <asp:Button ID="btnSave" runat="server" Text="保存" CssClass="m_btn_w2" OnClientClick="return checkInfo();"
                    OnClick="btnSave_Click" />
                <asp:Button ID="btnReport" runat="server" Text="安排完毕" CssClass="m_btn_w4" OnClientClick="if(checkInfo()) return confirm('确认人员安排完毕？'); else {return false};"
    ...
    <table class="m_table" width="98%" align="center">
        <tr>
            <td class="t_l t_bg" colspan="2" style="padding-left: 20px; color: Red;">
                合同备案确认情况：
            </td>
        </tr>
        <tr>
            ...
            <td colspan="1">
                <asp:TextBox ID="s_FAppDate" runat="server" CssClass="m_txt" Width="100px" Enabled="false"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="t_r t_bg">
            ...
            <td colspan="1">
                <asp:TextBox ID="s_FAppIdea" runat="server" CssClass="m_txt" Enabled="false" Height="50px"
    ...
    <table class="m_table" width="98%" align="center">
        ...
        <tr>
            ...
            <td colspan="3">
                <asp:TextBox ID="t_FAppDate" runat="server" CssClass="m_txt" Width="100px" Enabled="false"></asp:TextBox>
                <tt>*</tt>
            </td>
        </tr>
        <tr>
            ...
            <td style="line-height: 20px; padding: 3px;">
                ...
                <asp:TextBox ID="f_FName" runat="server" CssClass="m_txt" Enabled="false" Width="100px"></asp:TextBox>
                <tt>*</tt>
            ...
            <td>
                <asp:TextBox ID="f_FTel" runat="server" CssClass="m_txt"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="t_r t_bg">
            ...
            <td>
                <asp:TextBox ID="f_FCall" runat="server" CssClass="m_txt"></asp:TextBox>
            </td>
            <td class="t_r t_bg">
                Email：
            </td>
            <td>
                <asp:TextBox ID="f_FEmail" runat="server" CssClass="m_txt"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="t_r t_bg">
            ...
            <td>
                <asp:TextBox ID="f_FMajor" runat="server" CssClass="m_txt" Enabled="false"></asp:TextBox>
            </td>
            <td class="t_r t_bg">
                证书编号：
            </td>
            <td>
                <asp:TextBox ID="f_FCertiNo" runat="server" CssClass="m_txt" Enabled="false"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="t_r t_bg">
    ...
    <table class="m_table" width="98%" align="center">
        <tr>
            ...
            <td class="t_r t_bg" style="border-left: none">
                <asp:Button ID="btnSelE" runat="server" Text="选择" CssClass="m_btn_w4" OnClientClick="return selEnt('',2,this,1);"
    ...
    <asp:DataGrid ID="dg_List" runat="server" AutoGenerateColumns="False" CssClass="m_dg1"
        ...
        <Columns>
            ...
            <asp:TemplateColumn HeaderText="主要职责">
                <ItemTemplate>
                    <asp:TextBox ID="t_FFunction" runat="server" Text='<%#Eval("FFunction") %>' CssClass="m_txt"
