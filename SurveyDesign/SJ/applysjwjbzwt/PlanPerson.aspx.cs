    ...
    private void showSlInfo(string FLinkId)
    {
        ...
        var v = (from a in db.CF_App_List
                 ...
                 where a.FReportCount == i.FReportCount
                       && a.FLinkId == FLinkId && a.FManageTypeId == 296 && a.FState == 6
                 select new
                 {
                     i.FContent,
                     i.FAppTime,
    ...
    private void SaveInfo(int FState)
    {
        ...
        { //提交，办结
            ...
            else
            {
                ...
                //办完“设计文件编制人员安排”后自动创建下一个业务“施工图设计文件编制人员意见29702”
                if (!CreateNewApp(app.FPrjId, app.FLinkId, txtFPrjName.Text, 29702))
                {
                ...
                for (int i = 0; i < dg_List.Items.Count; i++)
                {
                    ...
                    sms.SendMessage(empId, "“" + CurrentEntUser.EntName + "”给您安排了“" + txtFPrjName.Text + "”工程的“施工图设计文件编制人员”职责，请及时处理。");
                }
            }
        }
