...
public partial class JZDW_ApplyXMJZ_Report : Page
{
    ...
    private void showEmpList()
    {
        ...
        var v = (from t in db.CF_Prj_Emp
                 ...
                 where t.FType == 2 && a.FLinkId == hidd_FDataID.Value && a.FManageTypeId == 29701 && a.FState == 6
    ...
    private void saveInfo(int FState)
    {
        ...
        if (app != null)
        {
            if (FState == 6)
            {
                ...
                //办完“ 人员意见 ”后自动创建下一个业务“成果移交298”
                if (!CreateNewApp(app.FPrjId, app.FLinkId, txtFPrjName.Text, 298))
                {
