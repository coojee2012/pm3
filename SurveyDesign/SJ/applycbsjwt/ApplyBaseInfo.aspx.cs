...
public partial class JSDW_applycbsjwt_ApplyBaseInfo : Page
{
    ...
    private void showInfo()
    {
        ...
        var v = (from a in db.CF_App_List
                 ...
                 where d.FId == FLinkId && a.FManageTypeId == 291 && a.FState > 0
                 select new
                 {
                     a.FId,
                     a.FManageTypeId,
        ...
        if (v != null)
        {
            ...
            {
                this.t_FFloat11.Enabled = false;
            }
            ShowPrjEnt(v.FAppId, 15503, repeaterDisplay);//显示设计联合体
            ShowPrjEnt(v.FAppId, 15502, repeaterDisplay_KC);//显示勘察联合体
        }
    }
    //显示其他子单位信息
