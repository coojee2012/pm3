    ...
    <script type="text/javascript">
        ...
        function checkInfo() {
            ...
            if ($("#t_FInt1").val() == "6") {
                ...
                if (!getLength(document.getElementById("t_FTxt17"), 50, '“原因”')) {
                    return false;
                }
            }
        }
...
<body>
    ...
    <table id="tab_6" class="m_table" width="98%" align="center">
        ...
        <tr>
            ...
            <td colspan="1" class="m_txt_M" width="20%">
                <asp:TextBox ID="t_FTxt16" runat="server" CssClass="m_txt" Width="100px" MaxLength="20"></asp:TextBox>
                <tt>*</tt>
            </td>
            <td class="t_r t_bg">
                办理时间：
            ...
            <td class="m_txt_M">
                <asp:TextBox ID="txtFDate6" runat="server" CssClass="m_txt" Width="100px" Enabled="false"></asp:TextBox>
                <tt>*</tt>
            </td>
        </tr>
        <tr>
    ...
    <table id="tab_2" class="m_table" width="98%" align="center">
        ...
        <tr>
            ...
            <td colspan="3" class="m_txt_M">
                <asp:TextBox ID="txtFDate2" runat="server" CssClass="m_txt" Width="100px" Enabled="false"></asp:TextBox>
            </td>
        </tr>
        <tr>
    ...
    <table id="tab_7" class="m_table" width="98%" align="center">
        ...
        <tr>
            ...
            <td colspan="3" class="m_txt_M">
                <asp:TextBox ID="txtFDate7" runat="server" CssClass="m_txt" Width="100px" Enabled="false"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="t_r t_bg" width="150">
