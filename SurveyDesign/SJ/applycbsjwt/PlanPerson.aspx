...
<body>
    ...
    <table width="98%" align="center" class="m_title">
        <tr>
            <th colspan="5">
                <asp:Literal ID="lit_title" runat="server" Text="初步设计人员安排"></asp:Literal>
            </th>
        </tr>
    </table>
    <table width="98%" align="center" class="m_bar">
        <tr>
            ...
            <td class="t_r">
                ...
                <asp:Button ID="btnReport" runat="server" Text="安排完毕" CssClass="m_btn_w4" OnClientClick="if(confirm('确认人员安排完毕？')){return checkInfo()} else {return false};"
    ...
    <table class="m_table" width="98%" align="center">
        ...
        <tr>
            ...
            <td colspan="1" class="m_txt_M" width="20%">
                <asp:TextBox ID="s_FTxt16" runat="server" CssClass="m_txt" Width="100px" Enabled="false"></asp:TextBox>
                <tt>*</tt>
            </td>
            <td class="t_r t_bg" width="15%">
                办理时间：
    ...
    <table class="m_table" width="98%" align="center">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="f_FTel" runat="server" CssClass="m_txt" MaxLength="15" onblur="return isTel(this);"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="t_r t_bg">
