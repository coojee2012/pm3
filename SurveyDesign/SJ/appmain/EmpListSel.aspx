<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EmpListSel.aspx.cs" Inherits="JSDW_appmain_EmpListSel" %>
...
<body>
    ...
    <table width="98%" align="center" class="m_title">
        <tr>
            <th colspan="5">
                <asp:Label ID="lTitle" runat="server" Text="勘察单位" ForeColor="Red"></asp:Label>人员列表
            </th>
        </tr>
        <tr>
    ...
    <table width="98%" align="center" class="m_bar">
        <tr>
            ...
            <td class="t_r" style="padding-right: 10px">
                <asp:Button ID="btnOk" runat="server" Text="选定" CssClass="m_btn_w2" OnClientClick="return confirm('确认要选择吗?');"
    ...
    <asp:DataGrid ID="dg_List" runat="server" AutoGenerateColumns="False" CssClass="m_dg1"
        ...
        <Columns>
            ...
            <asp:BoundColumn DataField="FIdCard" HeaderText="身份证号"></asp:BoundColumn>
            <asp:BoundColumn DataField="FRegistSpecialId" HeaderText="从事专业"></asp:BoundColumn>
            <asp:BoundColumn DataField="FCertiNo" HeaderText="注册证号"></asp:BoundColumn>
