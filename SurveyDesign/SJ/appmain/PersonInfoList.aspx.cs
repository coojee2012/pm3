...
public partial class SJ_AppMain_PersonInfoList : System.Web.UI.Page
{
    ...
    protected void DG_List_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            sb.Append("select e.fappid from CF_Prj_Emp e,cf_app_list l where FEmpBaseInfo='" + FID + "' and l.fid=e.fappid and l.fmanagetypeid=29201  and l.fstate = 6 ");
            ...
            sb.Append("select e.fappid from CF_Prj_Emp e,cf_app_list l where FEmpBaseInfo='" + FID + "' and l.fid=e.fappid and l.fmanagetypeid=29701  and l.fstate = 6 ");
            ...
            //{
            //    string sUrl = "<a href='javascript:void(0)' onclick=\"showAddWindow('PersonInfoPrj.aspx?empId=" + FID + "&FType=1',750,550);\">[" + iCount + "]</a>";
            //    e.Row.Cells[4].Text = sUrl;
            //}
            //iCount = EConvert.ToInt(DataBinder.Eval(e.Row.DataItem, "FCount2"));
            //if (iCount > 0)//如果有参与项目，则可点击查看列表
            //{
            //    string sUrl = "<a href='javascript:void(0)' onclick=\"showAddWindow('PersonInfoPrj.aspx?empId=" + FID + "&FType=2',750,550);\">[" + iCount + "]</a>";
            //    e.Row.Cells[5].Text = sUrl;
            //}
        }
    }
