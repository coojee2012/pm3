            ...
            <td class="l_main" valign="top" align="left">
                <div class="l_main_bg" style="height: 100%; overflow: auto; width: 180px; text-align: center;"
                    ...
                    <div id="dv2" runat="server" class="o_menu">
                        <a id="a12" class="o_m01_1" href='../main/Message.aspx' target="main"><span>文件通知</span></a>
                    </div>
                    <div id="dv3" runat="server" class="o_menu">
                        <a id="a2" class="o_m01_1" target="main"><span>单位信息</span></a>
                        <div class="o_smenu">
                            <a id="a23" class="o_m02_1" href='../main/Baseinfo1.aspx' target="main"><span>基本信息</span></a>
                            <div class="o_smenu2">
                            </div>
                            <a id="a25" class="o_m02_1" href='../main/Baseinfo2.aspx' target="main"><span>证书信息</span></a>
                            <div class="o_smenu2">
                            </div>
                            <a id="a27" class="o_m02_1" target="main"><span>人员信息</span></a>
                            <div class="o_smenu2">
                                <a id="a32" class="o_m03_1" href='../Main/Baseinfo3.aspx' target="main"><span>注册人员信息</span></a>
                                <a id="a33" class="o_m03_1" href='../Main/Baseinfo4.aspx' target="main"><span>非注册人员信息</span></a>
                            </div>
                        </div>
                    </div>
                    <div class="o_menu">
                        <a id="a13" class="o_m01_1" href='javascript:'><span>初步设计</span></a>
                        <div class="o_smenu">
                            <a id="a17" class="o_m02_1" href='AppCBSJWT.aspx' target="main"><span>初步设计合同</span></a>
                            <div class="o_smenu2">
                            </div>
                            <a id="a24" class="o_m02_1" href='../AppMain/HTBAlist.aspx?type=291' target="main"><span>
                                合同备案</span></a>
                            <div class="o_smenu2">
                            </div>
                            <%--<a id="a25" class="o_m02_1" href='../AppMain/HTBAlist.aspx?type=291&t=2' target="main">
                                <span>省外合同备案</span></a>
                            <div class="o_smenu2">
                            </div>--%>
                            <a id="a18" class="o_m02_1" href='AppCBSJRY.aspx' target="main"><span>人员安排</span></a>
                            <div class="o_smenu2">
                            </div>
                            <a id="a6" class="o_m02_1" href='AppCBSJRYYJ.aspx' target="main"><span>人员意见</span></a>
                            <div class="o_smenu2">
                            </div>
                            <a id="a19" class="o_m02_1" href='AppCBSJCGYJ.aspx' target="main"><span>成果提交</span></a>
                            <div class="o_smenu2">
                            </div>
                        </div>
                    </div>
                    <div class="o_menu">
                        <a id="a3" class="o_m01_1" href='javascript:'><span>施工图设计</span></a>
                        <div class="o_smenu">
                            <a id="a4" class="o_m02_1" href='AppSJWJBZWT.aspx' target="main"><span>设计文件合同</span></a>
                            <div class="o_smenu2">
                            </div>
                            <a id="a26" class="o_m02_1" href='../AppMain/HTBAlist.aspx?type=296' target="main"><span>
                                合同备案</span></a>
                            <div class="o_smenu2">
                            </div>
                            <%--<a id="a27" class="o_m02_1" href='../AppMain/HTBAlist.aspx?type=296&t=2' target="main">
                                <span>省外合同备案</span></a>
                            <div class="o_smenu2">
                            </div>--%>
                            <a id="a5" class="o_m02_1" href='AppSJWJBZRY.aspx' target="main"><span>人员安排</span></a>
                            <div class="o_smenu2">
                            </div>
                            <a id="a7" class="o_m02_1" href='AppSJWJBZRYYJ.aspx' target="main"><span>人员意见</span></a>
                            <div class="o_smenu2">
                            </div>
                            <a id="a20" class="o_m02_1" href='AppSJWJBZCGYJ.aspx' target="main"><span>成果提交</span></a>
                            <div class="o_smenu2">
                            </div>
                            <a id="a31" class="o_m02_1" href='../ApplySGTSCYJHF/SgtScyjHfList.aspx' target="main">
                                <span>施工图审查意见回复</span></a>
                            <div class="o_smenu2">
                            </div>
                        </div>
                    </div>
                    <div id="dv5" runat="server" class="o_menu">
                        <a id="a8" class="o_m01_1" href='../AppMain/HTBAPrjlist.aspx' target="main"><span>联合体查询</span></a>
                        <div class="o_smenu">
                        </div>
                    </div>
                    ...
                    <div class="o_menu">
                        <a id="a9" class="o_m01_1" style="cursor: pointer" target="main"><span>市场行为</span></a>
                        <div class="o_smenu">
                            <a id="a28" class="o_m02_1" href='../../BadBehavior/main/GoodList.aspx' target="main">
                                <span>良好行为</span></a>
                            <div class="o_smenu2">
                            </div>
                            <a id="a29" class="o_m02_1" href='EntBadActionList.aspx' target="main"><span>不良行为</span></a>
                            <div class="o_smenu2">
                            </div>
                            <a id="a30" class="o_m02_1" href='../../BadBehavior/main/BadList.aspx' target="main">
                                <span>投诉举报</span></a>
                            <div class="o_smenu2">
                            </div>
                        </div>
                    ...
                    <div id="dv9" runat="server" class="o_menu">
                        <a id="a14" class="o_m01_1" href='javascript:'><span>查询统计</span></a>
                        <div class="o_smenu">
                            <a id="a121" class="o_m02_1" href='../Statistics/PrjList.aspx' target="main"><span>项目查询</span></a>
                            <div class="o_smenu2">
                            </div>
                            <a id="a15" class="o_m02_1" href='../AppMain/PersonInfoList.aspx' target="main"><span>
                                人员参与项目</span></a>
                            <div class="o_smenu2">
                            </div>
                            <a id="a16" class="o_m02_1" href='../AppMain/AppInfoList.aspx' target="main"><span>业务统计</span></a>
                            <div class="o_smenu2">
                            </div>
                            <a id="a11" class="o_m02_1" href='../AppMain/AppInfoList2.aspx' target="main"><span>
                                项目统计</span></a>
                            <div class="o_smenu2">
                            </div>
                            <a id="a22" class="o_m02_1" href='EntBadActionList.aspx' target="main"><span>不良行为</span></a>
                            <div class="o_smenu2">
                            </div>
                        </div>
                    </div>
                    <div id="dv4" runat="server" class="o_menu">
                        <a id="a21" class="o_m01_1" href='../Main/ZDTEntList.aspx' target="main"><span>代填其他企业业务</span></a>
                    </div>
