<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddEmpInfo2.aspx.cs" Inherits="JSDW_QMain_AddEmpInfo" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>企业非注册人员信息</title>
...
<body scroll="no">
    ...
    <table class="m_table" width="98%" align="center">
        ...
        <tr>
            ...
            <td>
                <asp:Label ID="txtFUserName" runat="server">--</asp:Label>
            </td>
        </tr>
        <tr>
            <td class="t_r t_bg">
            ...
            <td>
                <asp:Label ID="txtFPassWord" runat="server">--</asp:Label>
            </td>
        </tr>
    </table>
    </form>
