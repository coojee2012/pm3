            ...
            <td class="wxts_m">
                ...
                <div class="wxts_msg">
                    最新系统消息： <font color="black" style="font-weight: normal;">（共有 <b style="color: Green;">
                        ...
                        <asp:Button ID="btnAllRead" runat="server" Text="全部标记为已读" CssClass="m_btn_w8" OnClick="btnAllRead_Click"
                            OnClientClick="return confirm('要全部标记为已读吗?');" Visible="false" />
                ...
                <div style="width: 98%; margin: 0 auto;">
                    <asp:DataGrid ID="App_List" runat="server" AutoGenerateColumns="False" CssClass="m_dg1"
                        HorizontalAlign="Center" OnItemDataBound="App_List_ItemDataBound" Style="margin-top: 1px;
                        margin-bottom: 1px;" Width="100%" OnItemCommand="App_List_ItemCommand">
                        ...
                        <Columns>
                            ...
                            <asp:TemplateColumn HeaderText="业务名称">
                                <ItemStyle CssClass="t_l" Wrap="false" />
                                <ItemTemplate>
                                    <asp:LinkButton ID="btnItemSee" CommandName="See" Text='<%#Eval("FName") %>' CommandArgument='<%#Eval("FCmd")%>'
                                        runat="server">
                                    </asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateColumn>
                    ...
                    <div style="margin: 4px auto;">
                        提示：点击“工程名称”查看工程情况，点击“业务名称”查看该业务办理详情。
                    </div>
                </div>
            </td>
            <td class="wxts_r">
