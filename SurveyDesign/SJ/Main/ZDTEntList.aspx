<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ZDTEntList.aspx.cs" Inherits="KC_Main_ZDTEntList" %>
...
<body>
        ...
        <tr>
            ...
            <td class="m_bar_m">
                <input id="Submit1" type="button" value="新增" onclick="showAddWindow('AddCAEntUser.aspx?type=1&fmatypeid=<%=Request["fmatypeid"] %>',800,600);"
                    class="m_btn_w2" visible="false" style="display: none;" />
                <asp:Button ID="btnQuery" runat="server" CssClass="m_btn_w2" Text="刷新" OnClick="btnQuery_Click" />
                <asp:Button ID="btnDel" runat="server" CssClass="m_btn_w2" Text="删除" Visible="false" />
                <asp:Button ID="btnDownload" runat="server" CssClass="m_btn_w4" Text="下载最新" Visible="false" />
            </td>
    ...
    <asp:DataGrid ID="DG_List" runat="server" HorizontalAlign="Center" Width="98%" CssClass="m_dg1"
        ...
        <Columns>
            ...
            <asp:BoundColumn DataField="FName" HeaderText="用户名" Visible="false">
                <ItemStyle HorizontalAlign="Left" />
            </asp:BoundColumn>
            <asp:BoundColumn DataField="FCompany" HeaderText="企业名称">
                <ItemStyle CssClass="t_l" Wrap="false" />
            </asp:BoundColumn>
            <asp:BoundColumn DataField="FCANumber" HeaderText="CA证书号" Visible="false"></asp:BoundColumn>
            <asp:BoundColumn DataField="FSystemId" HeaderText="用户类型">
                <ItemStyle Font-Underline="False" Wrap="False" />
            </asp:BoundColumn>
            <asp:BoundColumn HeaderText="相关权限" ItemStyle-HorizontalAlign="Left" Visible="false">
                <ItemStyle Font-Underline="False" Wrap="False" />
                <HeaderStyle Font-Underline="False" Wrap="False" />
            </asp:BoundColumn>
