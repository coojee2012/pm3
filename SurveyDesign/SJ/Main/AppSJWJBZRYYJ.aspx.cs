...
public partial class KcsjSgt_AppMain_AppSJWJBZRYYJ : System.Web.UI.Page
{
    ProjectDB db = new ProjectDB();
    int fMType = 29702;//文件编制设计人员意见
    ...
    protected void DG_List_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            //状态办理结果
            string s = "";
            string o = "<a href='javascript:showAddWindow(\"../applysjwjbzryyj/Report.aspx?FAppId=" + FID + "\",700,500);'>";
            switch (FState)
            {
                case "0":
                case "1":
                    s = "<font color='#888888'>还未填写</font>";
                    o += "查看意见";
