...
<body scroll="no">
    ...
    <table class="m_table" width="98%" align="center">
        <tr>
            ...
            <td colspan="3">
                <asp:TextBox ID="t_FName" runat="server" CssClass="m_txt" MaxLength="10"></asp:TextBox>
                <tt>*</tt>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="t_FSealNo" runat="server" CssClass="m_txt" MaxLength="15"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="t_r t_bg">
            ...
            <td>
                <asp:TextBox ID="t_FUserName" runat="server" CssClass="m_txt" MaxLength="25"></asp:TextBox>
                <tt>*</tt>
            </td>
            <td class="t_r t_bg">
                密码：
            ...
            <td>
                <asp:TextBox ID="txtFPassWord" runat="server" CssClass="m_txt" MaxLength="25"></asp:TextBox>
                <tt>*</tt>
            </td>
        </tr>
    </table>
