...
public partial class KcsjSgt_AppMain_AppCBSJRYYJ : System.Web.UI.Page
{
    ProjectDB db = new ProjectDB();
    int fMType = 29202;//初步设计人员意见
    ...
    protected void DG_List_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            //状态办理结果
            string s = "";
            string o = "<a href='javascript:showAddWindow(\"../applycbsjryyj/Report.aspx?FAppId=" + FID + "\",700,500);'>";
            switch (FState)
            {
                case "0":
                case "1":
