<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AppCBSJWT.aspx.cs" Inherits="EvaluateEntApp_main_AppCBSJWT" %>
                                ...
                                <table width="100%" id="appTab" runat="server">
                                    ...
                                    <tr>
                                        <td height="27" class="txt23" style="padding-left: 50px; margin-top: 6px;">
                                            工程名称：
                                            <asp:TextBox ID="txtFPrjName" runat="server" CssClass="m_txt" Width="150px"></asp:TextBox>
                                            &nbsp; 办理状态：
                                    ...
                                    <tr>
                                        <td align="center" valign="top" colspan="2">
                                                ...
                                                <asp:DataGrid ID="DG_List" runat="server" AutoGenerateColumns="False" CssClass="m_dg1"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateColumn HeaderText="工程名称">
                                                            <ItemTemplate>
                                                                <a href='javascript:showAddWindow("../applycbsjwt/ApplyBaseInfo.aspx?FDataID=<%#Eval("FLinkId") %>",800,650);'>
                                                                    <%#Eval("FPrjName")%>
                                                                </a>
                                            ...
                                            <div style="width: 98%; margin: 4px auto; text-align: left">
