<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AppSJWJBZRY.aspx.cs" Inherits="EvaluateEntApp_main_AppCBSJRY" %>
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="工程名称">
                                ...
                                <ItemTemplate>
                                    ...
                                    <a href='javascript:showAddWindow("../applysjwjbzwt/ApplyBaseInfo.aspx?FDataID=<%#Eval("FLinkId") %>",800,700);'>
                                        <%#Eval("FPrjName")%>
                                    </a>
