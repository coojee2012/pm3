...
public partial class KcsjSgt_AppMain_Print_SJGZS : System.Web.UI.Page
{
    RCenter rc = new RCenter();
    public string ReportServer = "";
    int fMType = 30103;//	技术性审查(设计)--不合格的数据 
    ...
    private void showInfo()
    {
        ...
        var v = from t in db.CF_App_List
                where t.FManageTypeId == fMType && t.FState == 3
    ...
    protected void DG_List_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            string printUrl = fType == 2000101 ? "SCYJGZS-JZGC" : "SCYJGZS-SZGC";
            HyperLink a = e.Row.FindControl("print_A") as HyperLink;
            if (a != null)
            {
                a.Text = "打印";
                a.NavigateUrl = ReportServer + printUrl + ".cpt&FAppId=" + FID + "&FPrjId=" + fPrjId + "&PrjId=" + fPrjId;
            }
        }
    }
    //列表事件
