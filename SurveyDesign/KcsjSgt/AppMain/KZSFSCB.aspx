<%@ Page Language="C#" AutoEventWireup="true" CodeFile="KZSFSCB.aspx.cs" Inherits="KcsjSgt_AppMain_Print_KZSFSCB" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        function addKZSF(obj) {
            showAddWindow("../ApplyOther/KZSFInfo.aspx?e=1", 850, 600);
        }
    </script>
                    ...
                    <asp:GridView ID="DG_List" runat="server" CssClass="m_dg1" Width="100%" HorizontalAlign="Center"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="工程名称">
                                ...
                                <ItemTemplate>
                                    <a href='javascript:showAddWindow("../ApplyOther/KZSFInfo.aspx?fId=<%#Eval("FId") %>",850,600);'>
                                        <%#Eval("FPrjName")%>
                                    </a>
                            ...
                            <asp:BoundField HeaderText="设防烈度" DataField="FIntensity">
                                <HeaderStyle Wrap="false" />
                                <ItemStyle Wrap="false" HorizontalAlign="Center" />
                            </asp:BoundField>
                            <asp:BoundField HeaderText="建筑面积(㎡)" DataField="FArea">
                                <HeaderStyle Wrap="false" />
                                <ItemStyle Wrap="false" HorizontalAlign="Center" />
                            </asp:BoundField>
