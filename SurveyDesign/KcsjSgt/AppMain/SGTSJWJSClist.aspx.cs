...
public partial class KcsjSgt_AppMain_SGTSJWJSClist : System.Web.UI.Page
{
    RCenter rc = new RCenter();
    int fMType = 300;//	施工图设计文件审查合同备案--受理 
    ...
    protected void DG_List_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            //状态办理结果
            string s = "";
            string o = "<a href='javascript:showAddWindow(\"../ApplySGTSJWJSCWTSL/Report.aspx?FAppId=" + FID + "\",700,580);'>";
            string t = "";
            switch (FState)
            {
                case "1":
                ...
                case "6":
                    ...
                    o += "查看详情";
                    t += "<a href='" + ReportServer + "SLD-SGTSJWJSC.cpt&FAppId=" + FID + "' target='_blank'>打印合同确认单</a>";
                    break;
                case "7":
