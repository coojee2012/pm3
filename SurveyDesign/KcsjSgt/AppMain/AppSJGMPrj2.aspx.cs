...
public partial class KC_appmain_AppSJGMPrj2 : System.Web.UI.Page
{
    ...
    void BindControl()
    {
        ...
        string tag = fMType == fMType1 ? "勘察文件" : "施工图设计文件";
        switch (fType)
        {
            case "F":
                fType = "审查项目_大型";
    ...
    void showInfo()
    {
        ...
        if (fType.Substring(0, 1) == "J")
            PType = PType2;
        else if (fType.Substring(0, 1) == "X")
            PType = PType3;
        //业务类型 
        int iType = fMType == fMType1 ? fMType3 : jMType3;
        int iType2 = fMType == fMType1 ? fMType2 : jMType2;
        int iType3 = fMType == fMType1 ? fMType4 : jMType4;
