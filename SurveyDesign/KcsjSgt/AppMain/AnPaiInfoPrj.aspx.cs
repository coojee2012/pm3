...
public partial class KcsjSgt_appmain_AnPaiInfoPrj : System.Web.UI.Page
{
    ...
    void showInfo()
    {
        ...
        var App = from l1 in db.CF_App_List
                  ...
                  where l1.FState == 6 && l2.FState < 1//未办结
                  && l1.FManageTypeId == iT
    ...
    protected void App_List_ItemDataBound(object sender, DataGridItemEventArgs e)
    {
        if (e.Item.ItemIndex > -1)
        {
            ...
            e.Item.Cells[e.Item.Cells.Count - 2].Text = "<a href='javascript:showAddWindow(\"../" + s + "/" + sUrl + "\",700,650);'>查看/填写意见</a>";
        }
    }
    //分页面控件翻页事件
