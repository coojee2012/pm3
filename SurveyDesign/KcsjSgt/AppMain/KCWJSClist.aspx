<%@ Page Language="C#" AutoEventWireup="true" CodeFile="KCWJSClist.aspx.cs" Inherits="KcsjSgt_AppMain_KCWJSClist" %>
            ...
            <td class="wxts_m" valign="top">
                ...
                <div style="width: 98%; margin: 0 auto;">
                    ...
                    <asp:GridView ID="DG_List" runat="server" CssClass="m_dg1" Width="100%" HorizontalAlign="Center"
                        ...
                        EmptyDataText="当前没有勘察文件审查受理业务" OnRowCommand="DG_List_RowCommand">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField HeaderText="确认结果" DataField="FState">
                                <HeaderStyle Width="80" />
                            </asp:BoundField>
