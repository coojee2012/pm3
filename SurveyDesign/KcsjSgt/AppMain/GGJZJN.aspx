<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GGJZJN.aspx.cs" Inherits="KcsjSgt_AppMain_GGJZJN" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        function addKZSF(obj) {
            showAddWindow("../ApplyOther/GGJZJNInfo.aspx?e=1", 850, 700);
        }
    </script>
                    ...
                    <asp:GridView ID="DG_List" runat="server" CssClass="m_dg1" Width="100%" HorizontalAlign="Center"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="工程名称">
                                ...
                                <ItemTemplate>
                                    <a href='javascript:showAddWindow("../ApplyOther/GGJZJNInfo.aspx?fId=<%#Eval("FId") %>",850,700);'>
                                        <%#Eval("FPrjName")%>
                                    </a>
