<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SGTSJWJBAlist.aspx.cs" Inherits="KcsjSgt_AppMain_KCWJBAlist" %>
                    ...
                    <asp:GridView ID="DG_List" runat="server" CssClass="m_dg1" Width="100%" HorizontalAlign="Center"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="操作">
                                <ItemTemplate>
                                    <asp:LinkButton runat="server" CommandName="CX" CommandArgument='<%#Eval("FID")%>'></asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                    </asp:GridView>
