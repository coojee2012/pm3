                    ...
                    <table width="100%" id="appTab" runat="server">
                        ...
                        <tr>
                            <td height="27" class="txt23" style="padding-left: 10px; margin-top: 6px;">
                                工程名称：<asp:TextBox ID="txtFPrjName" runat="server" CssClass="m_txt" Width="130px"></asp:TextBox>
                                ...
                                <asp:Button ID="btnPup" runat="server" CssClass="m_btn_w12" OnClick="btn_Click"></asp:Button>
                            </td>
                        </tr>
                        <tr>
                            <td>
