<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PersonInfoPrj.aspx.cs" Inherits="SJ_appmain_PersonInfoPrj" %>
...
<body>
    ...
    <table width="98%" align="center" class="m_title">
        <tr>
            <th colspan="4">
                参与项目情况（<asp:Label ID="lTitle" runat="server" ForeColor="Red"></asp:Label>）
            </th>
        </tr>
        <tr>
