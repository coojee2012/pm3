...
public partial class KcsjSgt_AppMain_KCSCRYAPlist : System.Web.UI.Page
{
    ...
    int fMType = 28802;//勘察文件审查--审查人员安排 
    ...
    protected void DG_List_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            //状态办理结果
            string s = "";
            string o = "<a href='javascript:showAddWindow(\"../ApplyKCSCRYAP/Report.aspx?FAppId=" + FID + "\",700,680);'>";
            switch (FState)
            {
                case "0":
                case "1":
            ...
            //判断是否已完成"技术性审查(勘察)28803"，否则还可以变更
            if (FState == "6" && db.CF_App_List.Count(t => t.FLinkId == FLinkId && t.FManageTypeId == 28803 && (t.FState == 0)) > 0)
            {
                e.Row.Cells[7].Text += "<a style='margin-left:10px;' title='人员安排变更' ";
                e.Row.Cells[7].Text += "href='javascript:showAddWindow(\"../ApplyKCSCRYAP/Report.aspx?c=1&FAppId=" + FID + "\",700,680);'>";
            ...
            string FTxt8 = (from a in db.CF_App_List
                            ...
                            where a.FLinkId == FLinkId && a.FState == 6 && a.FManageTypeId == 28801
            ...
            else
            {
                ...
                e.Row.Cells[7].Text = "<a href=\"javascript:alert('正在等待管理部门分配“业务流水号”，目前无法办理该业务。');\">安排人员</a>";
            }
