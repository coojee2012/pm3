<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SGTSJSCRYAPlist.aspx.cs"
    Inherits="KcsjSgt_AppMain_KCSCRYAPlist" %>
        ...
        <tr>
            ...
            <td class="wxts_m" valign="top">
                ...
                <div style="width: 98%; margin: 4px auto;">
                    提示：<tt>点击“工程名称”查看合同备案详情</tt>，<tt>安排完成后在未开始办“施工图设计文件备案”前人员可以变更</tt>
                </div>
            </td>
            <td class="wxts_r">
            </td>
