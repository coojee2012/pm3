<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Print_SJHGZ.aspx.cs" Inherits="KcsjSgt_AppMain_Print_SJHGZ" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        function checkLSH(obj) {
            ...
            if (state) {
                return confirm('设置为已打印后，不可再行修流水号,确认要保存设置吗?');
            }
            return true;
        }
    </script>
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="操作">
                                ...
                                <ItemTemplate>
                                    ...
                                    <%--<a href="<%=ReportServer %>SC-SGTSJWJHGS.cpt&FAppId=<%#Eval("FID") %>&FBaseId=<%=FBaseId%>&FPrjId=<%#Eval("FPrjId") %>"
                                        target="_blank">打印</a>--%>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
