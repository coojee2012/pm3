...
public partial class KcsjSgt_AppMain_FedBack : System.Web.UI.Page
{
    ...
    private void showInfo()
    {
        ...
        var v = (from p in db.CF_Prj_BaseInfo
                 ...
                 where (!string.IsNullOrEmpty(t_FPrjName.Text) ? p.FPrjName.Contains(t_FPrjName.Text) : true)
                    && a.FToBaseinfoId == FBaseinfoId && (a.FManageTypeId == 287 || a.FManageTypeId == 300) && a.FState == 6
    ...
    protected void DG_List_ItemDataBound(object sender, DataGridItemEventArgs e)
    {
        if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
        {
            ...
            var v = (from a in db.CF_App_List
                     join id in db.CF_App_Idea.Where(t => t.FUserId == null || t.FType == 290 || t.FType == 305) on a.FId equals id.FLinkId into idea
