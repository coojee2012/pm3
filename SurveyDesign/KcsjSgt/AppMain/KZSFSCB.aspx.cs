...
public partial class KcsjSgt_AppMain_Print_KZSFSCB : System.Web.UI.Page
{
    ...
    private void showInfo()
    {
        ...
        var v = from t in db.CF_Prj_KZSFInfo
    ...
    protected void btnDel_Click(object sender, EventArgs e)
    {
        ...
        tool.DelInfoFromGrid(DG_List, db.CF_Prj_KZSFInfo);
        showInfo();
    }
}
