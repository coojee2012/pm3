...
public partial class KC_AppMain_AppTypeList : System.Web.UI.Page
{
    ...
    private void showInfo()
    {
        ...
        string sUrl = "<a href='javascript:void(0)' onclick=\"showAddWindow('AppTypePrj.aspx?FYear=" + iYear + "&FMType={0}&FMonth={1}&FType={2}',700,550);\">{3}</a>";
    ...
    protected void DG_List_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        ...
        {
            object[] nums = new object[] { fc1, jc1, fc1_1, jc1_1, fc1_2, jc1_2, fc4, jc4, fc5, jc5, fc6, jc6, fc7, jc7, fc8, jc8 };
            string[] types = new string[] { "F1", "J1", "F1_1", "J1_1", "F1_2", "J1_2", "F4", "J4", "F5", "J5", "F6", "J6", "F7", "J7", "F8", "J8" };
            int[] mtypes = new int[] { fMType1, jMType1, fMType1, jMType1, fMType1, jMType1, fMType4, jMType4, fMType5, jMType5, fMType6, jMType6, fMType5, jMType5, fMType5, jMType5 };
            string sUrl = "<a href='javascript:void(0)' onclick=\"showAddWindow('AppTypePrj.aspx?FYear=" + ddlFYear.SelectedValue + "&FMType={0}&FType={1}',700,550);\">{2}</a>";
            for (int i = 0; i < nums.Length; i++)
            {
                string fmType = mtypes[i].ToString();
                int ii = i % 2 == 0 ? 1 : -1;
                fmType += "," + mtypes[i + ii];
                string sTemp = nums[i].ToString();
                if (!(i == 4 || i == 5) && sTemp != "0")
                {
                    sTemp = string.Format(sUrl, fmType, types[i], sTemp);
                }
