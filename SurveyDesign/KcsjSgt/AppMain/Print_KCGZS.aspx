<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Print_KCGZS.aspx.cs" Inherits="KcsjSgt_AppMain_Print_KCGZS" %>
                            ...
                            <asp:TemplateField HeaderText="操作">
                                ...
                                <ItemTemplate>
                                    <asp:LinkButton ID="btnSave" runat="server" Text="保存" CommandName="DoSave" CommandArgument='<%#Eval("FID") %>'></asp:LinkButton>|<a
                                        href="<%=ReportServer %>SC-KCWJSCYJGZS.cpt&FAppId=<%#Eval("FID") %>&FPrjId=<%#Eval("FPrjId") %>&PrjId=<%#Eval("FPrjId") %>"
                                        target="_blank"> 打印</a>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
