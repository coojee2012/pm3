<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AnPaiInfoPrj.aspx.cs" Inherits="KcsjSgt_appmain_AnPaiInfoPrj" %>

<%@ Register Assembly="AspNetPager" Namespace="Wuqi.Webdiyer" TagPrefix="webdiyer" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>正在审查项目情况</title>
...
<body>
    ...
    <table width="98%" align="center" class="m_title">
        <tr>
            <th colspan="4">
                正在审查项目情况（<asp:Label ID="lTitle" runat="server" ForeColor="Red"></asp:Label>）
            </th>
        </tr>
        <tr>
    ...
    <asp:DataGrid ID="dg_List" runat="server" AutoGenerateColumns="False" CssClass="m_dg1"
        ...
        <Columns>
            ...
            <asp:BoundColumn DataField="FFunction" HeaderText="主要职责"></asp:BoundColumn>
            <asp:BoundColumn HeaderText="操作"></asp:BoundColumn>
