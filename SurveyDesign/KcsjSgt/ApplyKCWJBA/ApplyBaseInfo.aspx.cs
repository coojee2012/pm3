...
public partial class KcsjSgt_ApplyKCWJBA_ApplyBaseInfo : EntAppPage
{
    ...
    private void showInfo()
    {
        ...
        if (app != null)
        {
            ...
            var k = (from t in db.CF_Prj_Ent
                     ...
                     where a.FPrjId == app.FPrjId && a.FManageTypeId == 283 && t.FEntType == 15501 && a.FState == 6
            ...
            var s = (from t in db.CF_Prj_Ent
                     ...
                     where a.FLinkId == app.FLinkId && a.FManageTypeId == 287 && t.FEntType == 145 && a.FState == 6
                     select new
                     {
                         t.FId,
                         t.FBaseInfoId,
            ...
            var ssDate = db.CF_App_List.Where(t => t.FManageTypeId == 287 &&
    ...
    private void showEmpYJ(string fLinkId)
    {
        ...
        var v = from a in db.CF_App_List
                ...
                where a.FManageTypeId == 28803 && oa.FManageTypeId == 28802
                && a.FLinkId == fLinkId
                ...
                select new
                {
                    ...
                    FCount = db.CF_App_List.Where(li => li.FLinkId == fLinkId && li.FManageTypeId == 287).Select(li => li.FReportCount).FirstOrDefault(),
                    e.FAppMajor,//审查专业
