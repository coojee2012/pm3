...
<body>
    ...
    <table width="98%" align="center" class="m_bar">
        <tr>
            ...
            <td class="t_r">
                <asp:Button ID="btnSave" runat="server" Text="保存" OnClick="btnSave_Click" CssClass="m_btn_w2"  Visible="false" />  <asp:Button ID="btnDownload" runat="server" Text="同步" CssClass="m_btn_w2" 
    ...
    <table width="98%" align="center" class="m_bar">
        <tr>
            ...
            <td class="t_r">
                <input type="button" id="btnAdd" runat="server" value="新增" class="m_btn_w2" onclick="showAddWindow('AddEmpInfo.aspx?e=1',600,400);" runat="server"/>
    ...
    <table width="98%" align="center" class="m_bar">
        <tr>
            ...
            <td class="t_r">
                <input type="button" id="btnMod" runat="server" value="新增" class="m_btn_w2" onclick="showAddWindow('AddEmpInfo2.aspx?e=1',600,400,document.getElementById('btnReload2'));" runat="server"/>
                <asp:Button ID="btnDel2" runat="server" Text="删除" CssClass="m_btn_w2" OnClientClick="return confirm('确认要删除吗?');"
                    OnClick="btnDel2_Click" />
                <asp:Button ID="btnReload2" runat="server" Text="刷新" CssClass="m_btn_w2" OnClick="btnReload2_Click" />
                <asp:Button ID="btnInput0" runat="server" Text="同步" CssClass="m_btn_w2" OnClick="btnInput_Click"  Visible="false" />
            </td>
            <td class="m_bar_r">
            </td>
        </tr>
