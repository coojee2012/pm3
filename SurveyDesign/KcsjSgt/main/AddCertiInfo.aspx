    ...
    <table width="98%" align="center" class="m_bar">
        <tr>
            ...
            <td class="m_bar_m" align="right">
                <asp:Button ID="btnSave" runat="server" CssClass="m_btn_w2" Text="保存" OnClick="btnSave_Click" Visible="false" />
        ...
        <tr>
            ...
            <td class="txt34" colspan="3">
                <asp:TextBox ID="t_FContent" runat="server" CssClass="m_txt" Height="70px" TextMode="MultiLine"
                    Width="95%" Style="text-align: left" MaxLength="250"  onblur="checkLength(this,250,'包含范围');"></asp:TextBox>
            </td>
        </tr>
    </table>
    <table width="98%" align="center" class="m_bar">
