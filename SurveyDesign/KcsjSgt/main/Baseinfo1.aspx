<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Baseinfo1.aspx.cs" Inherits="KcsjSgt_main_Baseinfo1" %>
...
<body>
    ...
    <table class="m_table" width="98%" align="center">
        ...
        <tr>
            ...
            <td class="txt31">
                <asp:TextBox ID="t_FOTxt5" runat="server" CssClass="m_txt" MaxLength="15" ReadOnly="true"></asp:TextBox>
                <tt>*</tt>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <asp:DropDownList ID="c_FLevel" runat="server" Enabled="false">
                </asp:DropDownList>
                <tt>*</tt>
            </td>
            <td class="t_r t_bg">
            ...
            <td>
                <asp:TextBox ID="c_FCertiNo" runat="server" CssClass="m_txt" MaxLength="20" ReadOnly="true"></asp:TextBox>
                <tt>*</tt>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="t_FCall" runat="server" CssClass="m_txt" MaxLength="15"></asp:TextBox>
                <tt>*</tt>
            </td>
            <td class="t_r t_bg">
                EMail：
            ...
            <td colspan="1">
                <asp:TextBox ID="t_FEMail" runat="server" CssClass="m_txt" MaxLength="30" Width="250px"></asp:TextBox>
            </td>
        </tr>
    </table>
    </form>
