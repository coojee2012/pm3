...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function checkInfo() {
            ...
            //            var v = true;
            //            $("input[id$=t_FFunction]").each(function() {
            //                if ($(this).val() == "") {
            //                    alert("请填写人员的“主要职责”。");
            //                    $(this).focus();
            //                    v = false;
            ...
            //                }
            //            });
            //            $("input[id$=t_FAppMajor]").each(function() {
            //                if ($(this).val() == "") {
            //                    alert("请填写人员的“审查专业”。");
            //                    $(this).focus();
            //                    v = false;
        ...
        function seePrj() {
            ...
            showAddWindow('../ApplySGTSJWJSCWTSL/ApplyBaseInfo.aspx?FDataID=' + fid, 900, 700);
        }
        function doCheck(obj) {
            var v1 = $(obj).parent().prev().find(":text[id*=t_FFunction]").val();
            var v2 = $(obj).parent().prev().prev().find(":text[id*=t_FAppMajor]").val();
...
<body>
    ...
    <table width="98%" align="center" class="m_title">
        <tr>
            <th colspan="5"> 
                <asp:Literal ID="lit_title" runat="server" Text="施工图设计文件审查--审查人员安排"></asp:Literal>
            </th>
        </tr>
    </table>
    ...
    <table class="m_table" width="98%" align="center">
        ...
        <tr>
            <td class="t_r t_bg" width="110">
                项目负责人：
            </td>
            <td style="line-height: 20px; padding: 3px;">
                <asp:Literal ID="lit_oldEmp" runat="server"></asp:Literal>
                <asp:TextBox ID="emp_FName" runat="server" CssClass="m_txt" ReadOnly="true" Width="70"></asp:TextBox>
                <tt>*</tt>
            ...
            <td>
                <asp:TextBox ID="emp_FTel" runat="server" CssClass="m_txt"></asp:TextBox>
                <tt>*</tt>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <asp:TextBox ID="emp_FCall" runat="server" CssClass="m_txt"></asp:TextBox>
                <tt>*</tt>
            </td>
            <td class="t_r t_bg">
                E-Mail：
            ...
            <td>
                <asp:TextBox ID="emp_FEmail" runat="server" CssClass="m_txt"></asp:TextBox>
                <tt>*</tt>
            </td>
        </tr>
        <tr>
    ...
    <table class="m_table" width="98%" align="center">
        <tr>
            ...
            <td class="t_r t_bg" style="border-left: none;">
                <asp:Button ID="btnSelEmpList" runat="server" Text="选择" CssClass="m_btn_w2" OnClientClick="return selEmp('hidd_empId2',2,this,1);"
                    UseSubmitBehavior="false" OnClick="btnSelEmpList_Click" CommandArgument="2" />
                <input type="hidden" id="hidd_empId2" runat="server" />
        ...
        <tr>
            <td class="t_bg m_txt_M" colspan="2">
                <asp:GridView ID="EmpList1" runat="server" CssClass="m_dg1" Width="100%" HorizontalAlign="Center"
                    ...
                    OnRowCommand="EmpList2_RowCommand" OnRowDataBound="EmpList2_RowDataBound">
                    <HeaderStyle CssClass="m_dg1_h" />
                    <RowStyle CssClass="m_dg1_i" />
                    ...
                    <Columns>
                        ...
                        <asp:BoundField HeaderText="姓名" DataField="FName">
                            <ItemStyle Wrap="false" />
                        </asp:BoundField>
                        <asp:BoundField HeaderText="从事专业" DataField="FMajor">
                            <ItemStyle Wrap="false" />
                        </asp:BoundField>
                        <asp:TemplateField HeaderText="审查专业">
                            <ItemStyle Wrap="false" />
                            <ItemTemplate>
                                <asp:TextBox ID="t_FAppMajor" runat="server" CssClass="m_txt" MaxLength="15" Text='<%#Eval("FAppMajor") %>'></asp:TextBox>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="操作">
                            <ItemStyle Wrap="false" />
                            <ItemTemplate>
                                <asp:LinkButton ID="lbSave" CommandArgument='<%#Eval("FId") %>' CommandName="doSave"
    ...
    <table class="m_table" width="98%" align="center">
        <tr>
            ...
            <td class="t_r t_bg" style="border-left: none">
                <asp:Button ID="Button1" runat="server" Text="选择" CssClass="m_btn_w2" OnClientClick="return selEmp('hidd_empId3',3,this,1);"
                    UseSubmitBehavior="false" OnClick="btnSelEmpList_Click" CommandArgument="3" />
                <input type="hidden" id="hidd_empId3" runat="server" />
                ...
                <asp:GridView ID="EmpList2" runat="server" CssClass="m_dg1" Width="100%" HorizontalAlign="Center"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="操作">
                            <ItemStyle Wrap="false" />
                            <ItemTemplate>
                                <asp:LinkButton CommandArgument='<%#Eval("FId") %>' CommandName="doSave" OnClientClick="return doCheck(this);"
    ...
    <input id="h_FAppMajor" type="hidden" runat="server" />
    </form>
</body>
</html>
