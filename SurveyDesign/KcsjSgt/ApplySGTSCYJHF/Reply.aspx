<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Reply.aspx.cs" Inherits="KcsjSgt_ApplySGTSCYJHF_Reply" %>
...
<body>
    ...
    <table class="m_table" width="98%" align="center">
        ...
        <tr>
            ...
            <td colspan="3" class="m_txt_M" style="height: 140px;">
    ...
    <table class="m_table" width="98%" align="center">
        <tr>
            <td colspan="4" class="t_l t_bg" style="padding-left: 30px;">
                <b>审图机构意见</b> <tt class="f_r">
                    <asp:Button ID="btnSave" runat="server" Text="确认回复" OnClick="btnSave_Click" CssClass="m_btn_w4" />
                </tt>
            </td>
        </tr>
        <tr>
            ...
            <td colspan="3" class="m_txt_M" style="height: 100px;">
                <asp:TextBox ID="t_FTxt" runat="server" CssClass="m_txt" Width="90%" TextMode="MultiLine"
        ...
        <tr>
            ...
            <td colspan="3" class="m_txt_M">
                <asp:TextBox ID="t_FTxt3" runat="server" CssClass="m_txt" Width="100px" MaxLength="20"></asp:TextBox>
                <tt>*</tt>
            </td>
        </tr>
        <tr>
            ...
            <td colspan="3" class="m_txt_M">
                <asp:TextBox ID="t_FAppDate" runat="server" CssClass="m_txt" Width="100px" onfocus="WdatePicker()"></asp:TextBox>
                <tt>*</tt>
            </td>
        </tr>
    </table>
