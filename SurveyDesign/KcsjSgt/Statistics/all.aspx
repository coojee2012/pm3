<%@ Page Language="C#" AutoEventWireup="true" CodeFile="all.aspx.cs" Inherits="KcsjSgt_Statistics_all" %>
...
<body>
    ...
    <table width="98%" align="center" class="m_bar">
        <tr>
            ...
            <td class="t_r">
                <input type="button" class="m_btn_w2" value="关闭" onclick="window.close();" />
            </td>
            <td class="m_bar_r">
            </td>
        </tr>
    ...
    <table class="xtable" width="98%" align="center" style="margin: 4px auto; border: 1px solid #73B9F7;">
        <tr>
            ...
            <td>
                <div class="x f_l" onclick='seePrj("<%=Request.QueryString["FID"]%>");' title="点击查看工程详情">
        ...
        <tr id="tr_SGTSJWJSCWT" class="alte">
            <td class="ti">
