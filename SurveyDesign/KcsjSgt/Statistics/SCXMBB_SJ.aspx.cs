...
public partial class KcsjSgt_Statistics_SCXMBB_SJ : System.Web.UI.Page
{
    ...
    private void showInfo()
    {
        ...
        //参与项目（查询技术性审查已经通过的。）
        var v = (from t in db.CF_App_List.Where(a => a.FBaseinfoId == FBaseinfoId && (a.FManageTypeId == 30103) && a.FState == 6)
