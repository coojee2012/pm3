...
<body>
    ...
    <table class="m_table" width="98%" align="center">
        <tr>
            ...
            <td>
                ...
                <input id="hidd_FDataID" runat="server" type="hidden" />
            </td>
        </tr>
        <tr>
            <td class="t_r t_bg">
    ...
    <table id="tab_2" class="m_table" width="98%" align="center">
        ...
        <tr>
            ...
            <td class="m_txt_M">
                <asp:TextBox ID="tt_FDate6" runat="server" CssClass="m_txt" Width="100px" Enabled="false"></asp:TextBox>
                <tt>*</tt>
            </td>
        </tr>
        <tr>
