...
public partial class KcsjSgt_ApplyKCWJSCWTSL_Report : Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            tt_FDate6.Text = EConvert.ToShortDateString(DateTime.Now);
    ...
    private void saveInfo(bool isReport)
    {
        ...
        if (data != null)
        {
            ...
            if (t_FInt1.SelectedValue == "6")
            {
                data.FDate6 = EConvert.ToDateTime(t_FDate6.Text.Trim());
            }
            else
            {
                data.FDate6 = EConvert.ToDateTime(tt_FDate6.Text.Trim());
            }
    ...
    private void Report()
    {
        ...
        if (app != null)
        {
            ...
            {
                s = "“" + CurrentEntUser.EntName + "”受理了工程“" + txtFPrjName.Text + "”的施工图文件审查合同申请。";

                idea.FContent = t_FTxt19.Text;


                //办完“受理”后自动创建下一个业务“程序性审查”
                if (!CreateNewApp(app.FPrjId, app.FLinkId, txtFPrjName.Text, 30101))
                {
            ...
            {
                s = "“" + CurrentEntUser.EntName + "”退回了工程“" + txtFPrjName.Text + "”的施工图文件审查合同备案申请。";
