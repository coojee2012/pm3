<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EmpReport.aspx.cs" Inherits="KcsjSgt_ApplySGTSJJSXSC_EmpReport" %>
...
<body>
    ...
    <table class="m_table" width="98%" align="center">
        ...
        <tr>
            ...
            <td colspan="3">
                <asp:Literal ID="t_FAppMajor" runat="server"></asp:Literal>
            </td>
        </tr>
        <tr>
            <td class="t_r t_bg">
        ...
        <tr>
            ...
            <td colspan="1">
                <asp:TextBox ID="t_FTxt4" runat="server" CssClass="m_txt" MaxLength="10"></asp:TextBox>
            </td>
            <td class="t_r t_bg">
                违返强条数量：
            </td>
    ...
    <table id="tab_3" style="display: none;" class="m_table" width="98%" align="center">
        <tr>
            ...
            <td class="t_r t_bg" style="border-left: none;">
                <input id="btnAdd" class="m_btn_w2" value="新增" type="button" onclick='showAddWindow("EmpReportAdd.aspx?FEmpBaseinfoId=<%= ViewState["FEmpBaseInfo"]%>&FAppId=<%=Request.QueryString["FAppId"] %>",500,350);'
                    style="display: none" />
                <asp:Button ID="Button1" runat="server" Text="刷新" OnClick="btnQuery_Click" class="m_btn_w2" />
            </td>
        </tr>
        <tr>
