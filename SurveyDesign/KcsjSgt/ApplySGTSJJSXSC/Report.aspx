...
<body>
    ...
    <table class="m_table" width="98%" align="center">
            ...
            <td colspan="4" class="t_bg m_txt_M">
                <asp:GridView ID="DGList" runat="server" CssClass="m_dg1" Width="100%" HorizontalAlign="Center"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField HeaderText="审查专业" DataField="FAppMajor"></asp:BoundField>
                        ...
                        <asp:TemplateField HeaderText="操作">
                            <HeaderStyle Width="80" />
                            <ItemTemplate>
                                <a href='javascript:showAddWindow("EmpReport.aspx?FID=<%#Eval("FId") %>&FAppId=<%#Request.QueryString["FAppId"] %>",700,600);'>
                                    查看意见</a>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="t_FDate6" runat="server" CssClass="m_txt" onfocus="WdatePicker()"></asp:TextBox>
                <tt>*</tt>
            </td>
        </tr>
        <tr>
            ...
            <td class="m_txt_M" colspan="3">
                <asp:TextBox ID="t_FTxt12" runat="server" CssClass="m_txt" Width="320px" MaxLength="50"></asp:TextBox>
                <tt>*</tt>
            </td>
        </tr>
        <tr>
            ...
            <td class="m_txt_M" colspan="3">
                <asp:DropDownList ID="t_FTxt14" runat="server">
                    ...
                    <asp:ListItem Value="一" Text="一星"></asp:ListItem>
                    <asp:ListItem Value="二" Text="二星"></asp:ListItem>
                    <asp:ListItem Value="三" Text="三星"></asp:ListItem>
                </asp:DropDownList>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="m_txt_M" colspan="3">
                <asp:TextBox ID="t_FTxt13" runat="server" CssClass="m_txt" Width="320px" MaxLength="50"
                    TextMode="MultiLine" Height="40"></asp:TextBox>
                <tt>*</tt>
            </td>
        </tr>
    </table>
