...
public partial class KcsjSgt_ApplyKCCXXSC_Report : Page
{
    ...
    private void showInfo()
    {
        ...
        if (v != null)
        {
            ...
            t_FTxt14.SelectedValue = v.FTxt13;
    ...
    private void showEmpYJ()
    {
        ...
        var v = from a in db.CF_App_List
                ...
                where a.FManageTypeId == 30102 && a.FLinkId == hidd_DataFId.Value && !e.FIsDeleted.GetValueOrDefault()
                && a.FState == 6
    ...
    private void saveInfo(bool isReport)
    {
        ...
        if (data != null)
        {
            ...
            data.FTxt13 = t_FTxt13.Text;//其他问题说明
    ...
    string GetLSH(string fAppId, string fPrjId)
    {
        RCenter rc = new RCenter();
        StringBuilder sb = new StringBuilder();
        var fType = db.CF_Prj_BaseInfo.Where(t => t.FId == fPrjId).Select(t => t.FType).FirstOrDefault();
        string lsh_Type = fType == 2000101 ? "02" : "03";//房建或者市政
        string lsh = string.Empty;
        lsh += "SHSS" + lsh_Type + "-" + DateTime.Now.Year.ToString().Substring(2, 2) + "-";
    ...
    private void Report()
    {
        ...
        if (app != null)
        {
            ...
            //设置生成的编号
            app.FResult = GetLSH(FAppId, app.FPrjId);
