 ...
 * 最后修正：2010-5-11
 **/
var IMAGESPATH = '../../zDialogNew/images/'; //图片路径配置
...
Dialog.setStyle = function() {
    //皮肤
    if (document.styleSheets) {
        for (var i = 0; i < document.styleSheets.length; i++) {
            if (document.styleSheets[i].title && document.styleSheets[i].title != "") {
                if (document.styleSheets[i].title == "Orange") {
                    IMAGESPATH = '../../zDialogNew/Orange/'
                }
            }
        }
    }
