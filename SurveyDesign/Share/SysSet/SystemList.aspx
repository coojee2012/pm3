<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SystemList.aspx.cs" Inherits="Admin_main_SystemList" %>
...
<body style="margin-left: 5px; margin-right: 5px;">
    ...
    <table width="100%" align="center" class="m_bar">
        <tr>
            ...
            <td class="m_bar_m">
                <input id="Submit1" type="button" value="新增" onclick="showAddWindow('SystemAdd.aspx?e=0',480,550);"
                    class="m_btn_w2" />
            ...
            <asp:TemplateColumn HeaderText="顺序">
                ...
                <ItemTemplate>
                    <asp:TextBox ID="FOrder" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"FOrder") %>'
                        Width="50" CssClass="m_txt" onblur="isInt(this);"></asp:TextBox>
                </ItemTemplate>
            </asp:TemplateColumn>
