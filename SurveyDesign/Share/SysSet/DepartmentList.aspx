<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DepartmentList.aspx.cs" Inherits="Share_SysSet_DepartmentList" %>
...
<body>
    ...
    <table width="98%" align="center" class="m_title">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="text_FName" runat="server" CssClass="m_txt" Width="150px" />
            </td>
            <td class="t_r">
                部门编码：
            </td>
            ...
            <td>
                <asp:DropDownList ID="drop_Flevel" runat="server" CssClass="m_txt">
                </asp:DropDownList>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <asp:TextBox ID="text_FCNumber" runat="server" CssClass="m_txt" Width="150px"></asp:TextBox>
            </td>
            <td class="t_r">
                部门类别：
            </td>
            <td>
                <asp:DropDownList ID="drop_FClassNumber" runat="server" CssClass="m_txt">
                </asp:DropDownList>
            </td>
    ...
    <table width="98%" align="center" class="m_bar">
        <tr>
            ...
            <td class="m_bar_m">
                <input type="button" id="btnAdd" runat="server" class="m_btn_w2" value="新增" />
    ...
    <asp:DataGrid ID="ManageDept_List" runat="server" HorizontalAlign="Center" Width="98%"
        ...
        <Columns>
            ...
            <asp:BoundColumn DataField="FName" HeaderText="部门名称">
                <ItemStyle HorizontalAlign="Center" />
            </asp:BoundColumn>
            <asp:BoundColumn DataField="FNumber" HeaderText="部门编码"></asp:BoundColumn>
            <asp:BoundColumn DataField="FLevelName" HeaderText="部门级别"></asp:BoundColumn>
            <asp:BoundColumn DataField="FClassNumberName" HeaderText="部门类别"></asp:BoundColumn>
            <asp:BoundColumn DataField="FFullName" HeaderText="部门全称">
