<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QualiLevelList.aspx.cs" Inherits="Admin_main_QualiLevelList" %>
...
<head id="Head1" runat="server">
    ...
    <script language="javascript">
        function clearQuery() {
            ...
            document.getElementById("drop_FSystemIdName").value = "";
        }
...
<body style="margin-left: 5px; margin-right: 5px;">
    ...
    <table width="100%" align="center" class="m_title">
        ...
        <tr>
            ...
            <td>
                <asp:DropDownList ID="drop_FSystemIdName" runat="server" CssClass="m_txt">
                </asp:DropDownList>
            </td>
            <td class="t_c">
    ...
    <table width="100%" align="center" class="m_bar">
        <tr>
            ...
            <td class="m_bar_m">
                <input id="btnAdd" class="m_btn_w2" type="button" value="新增" onclick="showApproveWindow('QualiLevelAdd.aspx?e=0',557,360);" />
    ...
    <asp:DataGrid ID="QualiLevel_List" runat="server" HorizontalAlign="Center" Width="100%"
        CssClass="m_dg1" Style="margin-top: 4px;" AutoGenerateColumns="False" OnItemDataBound="QualiLevel_List_ItemDataBound">
        ...
        <Columns>
            ...
            <asp:BoundColumn DataField="FName" HeaderText="资质级别名称">
                <ItemStyle CssClass="t_l" />
            </asp:BoundColumn>
            <asp:BoundColumn DataField="fnumber" HeaderText="编码"></asp:BoundColumn>
            <asp:BoundColumn DataField="FSystemId" HeaderText="类型编码"></asp:BoundColumn>
            <asp:BoundColumn DataField="FSystemName" HeaderText="系统名称"></asp:BoundColumn>
            <asp:BoundColumn DataField="FLevel" HeaderText="级别"></asp:BoundColumn>
