<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DicSubList.aspx.cs" Inherits="Share_SysSet_DicSubList" %>
...
<body style="margin-left: 5px; margin-right: 5px;">
    ...
    <table width="98%" align="center" class="m_title">
        ...
        <tr>
            ...
            <td>
                <asp:DropDownList ID="drop_FSystemId" runat="server">
                </asp:DropDownList>
            </td>
            <td class="t_c">
                <asp:Button ID="btnQuery" runat="server" CssClass="m_btn_w2" OnClick="btnQuery_Click"
                    Text="搜索" />
                <input id="Button3" class="m_btn_w2" onclick="clearQuery();" style="margin-left: 10px"
    ...
    <table width="98%" align="center" class="m_bar">
        <tr>
            ...
            <td class="m_bar_m">
                <input id="btnAdd" runat="server" type="button" class="m_btn_w2" value="新增" />
    ...
    <asp:DataGrid ID="Dic_List" runat="server" HorizontalAlign="Center" Width="98%" CssClass="m_dg1"
        ...
        <Columns>
            ...
            <asp:BoundColumn DataField="FParentId" HeaderText="父字典编号"></asp:BoundColumn>
            ...
            <asp:BoundColumn DataField="FCNumber" HeaderText="国家编号"></asp:BoundColumn>
