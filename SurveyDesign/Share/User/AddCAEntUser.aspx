<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddCAEntUser.aspx.cs" Inherits="Share_User_AddCAEntUser"
    ...
    <div id="divSetup2" runat="server">
        ...
        <table class="m_table" width="98%" align="center">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="t_FAddress" runat="server" CssClass="m_txt" Width="209px"></asp:TextBox>
                    <tt>*</tt>
                </td>
                <td class="t_r t_bg">
                    主管部门：
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="t_FJuridcialCode" runat="server" CssClass="m_txt" Width="104px"></asp:TextBox>
                    <tt>*</tt>
                </td>
                <td class="t_r t_bg">
                    营业执照注册号：
                ...
                <td>
                    <asp:TextBox ID="t_FLicence" runat="server" CssClass="m_txt" MaxLength="15" Width="104px"></asp:TextBox>
                </td>
            </tr>
        </table>
        <table class="m_table" width="98%" align="center">
            ...
            <tr>
                ...
                <td colspan="3">
                    <asp:TextBox ID="t_FIdCard" runat="server" CssClass="m_txt" MaxLength="18" Width="104px"></asp:TextBox>
                    <tt>*</tt>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <asp:TextBox ID="t_FMobile" runat="server" CssClass="m_txt" MaxLength="15" Width="104px"></asp:TextBox>
                    <tt>*</tt>
                </td>
                <td class="t_r t_bg">
                    电子邮件：
                ...
                <td>
                    <asp:TextBox ID="t_FEmail" runat="server" CssClass="m_txt" MaxLength="24" Width="104px"></asp:TextBox>
                    <tt>*</tt>
                </td>
            </tr>
            <tr>
                ...
                <td colspan="3">
                    <asp:TextBox ID="t_FMemo" runat="server" CssClass="m_txt" MaxLength="15" Width="358px"
                        Height="33px" TextMode="MultiLine"></asp:TextBox>
                </td>
            </tr>
        </table>
        <table width="98%" align="center" class="m_bar">
        ...
        <table class="m_dg1" width="98%" align="center">
            <tr class="m_dg1_h">
                <td>
                    序号
                </td>
        ...
        <table class="m_table" width="98%" align="center">
            <tr>
                ...
                <td>
                    <asp:TextBox ID="t_FCACardId" runat="server" CssClass="m_txt" Width="100px"></asp:TextBox>
                    <asp:Button ID="btnReadCA" runat="server" CssClass="m_btn_w2" Text="推送" OnClientClick="if(!fnQYLogin()){}"
                ...
                <td>
                    <asp:TextBox ID="t_FCANumber" runat="server" CssClass="m_txt" Width="100px" MaxLength="75"></asp:TextBox>
                    <asp:Button ID="btnSaveCA" runat="server" CssClass="m_btn_w2" Text="保存CA" OnClientClick="if(!fnQYLogin()){}"
        ...
        <ContentTemplate>
        <asp:GridView ID="RepCA" CssClass="m_dg1" Width="98%" HorizontalAlign="Center" runat="server"
            AutoGenerateColumns="False" OnRowCancelingEdit="RepCA_RowCancelingEdit" OnRowEditing="RepCA_RowEditing"
            OnRowUpdating="RepCA_RowUpdating" onrowdeleting="RepCA_RowDeleting">
            <HeaderStyle CssClass="m_dg1_h" />
            <RowStyle CssClass="m_dg1_i" />
            <Columns>
                <asp:TemplateField HeaderText="CA密码卡号">
                    <EditItemTemplate>
                        <asp:TextBox ID="txtFCACardId"  CssClass="m_txt" runat="server" Text='<%# Bind("FCACardId") %>'></asp:TextBox>
                    </EditItemTemplate>
                    <ItemTemplate>
                        <asp:Label ID="Label1" runat="server" Text='<%# Bind("FCACardId") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="CA数字证书编号">
                    <EditItemTemplate>
                        <asp:TextBox ID="txtFCANumber"  CssClass="m_txt" runat="server" Text='<%# Bind("FCANumber") %>'></asp:TextBox>
                    </EditItemTemplate>
                    <ItemTemplate>
                        <asp:Label ID="Label2" runat="server" Text='<%# Bind("FCANumber") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField ShowHeader="False">
                    <ItemTemplate>
                        <asp:LinkButton ID="LinkButton1" runat="server" CausesValidation="False" CommandName="Delete" OnClientClick="return confirm('确认要删除么?');"
        ...
        <table class="m_table" width="98%" align="center">
            <tr>
                ...
                <td>
                    <asp:TextBox ID="t_FName" runat="server" CssClass="m_txt" Width="100px" MaxLength="10"
                        ReadOnly="true"></asp:TextBox>
                    <tt>*</tt>&nbsp;
                </td>
                <td class="t_r t_bg">
        ...
        <table class="m_table" width="98%" align="center">
            <tr>
                ...
                <td colspan="3">
                    <asp:TextBox ID="t_FAcceptUnit" runat="server" CssClass="m_txt" Width="100px" MaxLength="25"></asp:TextBox>
                    <tt>*</tt>&nbsp;
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <asp:TextBox ID="t_FAcceptPerson" runat="server" CssClass="m_txt" Width="100px" MaxLength="25"></asp:TextBox>
                    <tt>*</tt>&nbsp;
                </td>
                <td class="t_r t_bg">
                    受理日期：
                ...
                <td>
                    <asp:TextBox ID="t_FAcceptTime" runat="server" CssClass="m_txt" Width="100px" onfocus="WdatePicker()"></asp:TextBox>
                </td>
            </tr>
        </table>
        <table width="98%" align="center" class="m_table">
            <tr>
                ...
                <td colspan="3">
                    <asp:CheckBoxList ID="CityList" runat="server" RepeatDirection="Horizontal">
                    </asp:CheckBoxList>
                </td>
            </tr>
        </table>
