<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ManMenuRoleSet.aspx.cs" Inherits="Share_User_ManMenuRoleSet" %>
...
<body>
    ...
    <asp:DataList ID="dg_list" runat="server" OnItemDataBound="dg_list_ItemDataBound"
        RepeatDirection="Horizontal" RepeatLayout="Flow" DataKeyField="FId">
        <HeaderTemplate>
        ...
        <ItemTemplate>
            <tr>
                <td class="t_r t_bg">
                    <asp:Label ID="lSystemName" runat="server" ForeColor="Black" Text='<%#Eval("FName") %>'></asp:Label>：
                    <tt>*</tt>
                </td>
                <td class="m_txt_M">
                    <asp:CheckBoxList ID="t_FMenuRoleId" CssClass="noborder" runat="server" RepeatColumns="3"
