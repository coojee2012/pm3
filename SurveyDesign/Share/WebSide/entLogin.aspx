<%@ Page Language="C#" AutoEventWireup="true" CodeFile="entLogin.aspx.cs" Inherits="Share_WebSide_Login" %>
                        ...
                        <div id="ta_UserEmp" runat="server">
                            <div>
                                ...
                                <asp:DropDownList ID="d_dEmp" runat="server">
                                    <asp:ListItem Text="演示用户备选" Value=""></asp:ListItem>
                                    <asp:ListItem Text="审图人员" Value="sdrD5LgCRHQ="></asp:ListItem>
                                    <asp:ListItem Text="见证人员" Value="sdrD5LgCRHQ="></asp:ListItem>
                                </asp:DropDownList>
                            </div>
                            <div>
                                <tt>密&nbsp;&nbsp;码：</tt><span>
