<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JZDWLogin1.aspx.cs" Inherits="Share_WebSide_JZDWLogin1" %>

<%@ Register Namespace="Tools" TagPrefix="cc1" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>四川省勘察设计科技信息系统-见证单位</title>
    ...
    <table border="0" width="100%" height="100%">
        <tr>
            <td align="center" valign="middle">
                <div style="margin: 0 auto; position: relative; width: 780px; height: 540px; background-image: url(../image/JZDWLogin.jpg)">
