<%@ Page Language="C#" AutoEventWireup="true" CodeFile="sprLogin.aspx.cs" Inherits="Share_WebSide_sprLogin" %>

<%@ Register Namespace="Tools" TagPrefix="cc1" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>四川省施工企业工法申报管理信息系统</title>
        ...
        <table border="0" width="100%" height="100%">
            <tr>
                <td align="center" valign="middle">
                    <div style="margin: 0 auto; position: relative; width: 780px; height: 540px; background-image: url(../image/gfLogin.jpg)">
                        ...
                        <div style="height: 174px">
                            <table style="margin-left: 50px; float: left; width: 350px; line-height: 34px;">
                                ...
                                <tr>
                                    <td colspan="2">
                                        <asp:Button ID="btnLogin" runat="server" CssClass="m_btn_w4" Text="登陆" OnClick="btnLogin_Click" />
                                        &nbsp;
                                        <asp:Button ID="Button1" runat="server" CssClass="m_btn_w4" Text="驱动下载" />
                                        &nbsp;
                                    <asp:Button ID="btnEmpLogin" runat="server" CssClass="m_btn_w4" Text="问题解答" />
                                    </td>
                                </tr>
                            </table>
                        </div>
                        <table style="float: left; width: 99%; line-height: 34px; text-align: center;">
                            <tr>
                                <td style="color: White; font-size: 10pt; font-weight: bold;" align="center">四川省住房和城乡建设厅信息中心 &nbsp;&nbsp;
                                    联系电话：028-85533312&nbsp;&nbsp;&nbsp;
                                     <script type="text/javascript" src="http://static.b.qq.com/account/bizqq/js/wpa.js?wty=1&type=2&kfuin=800059000&ws=http%3A%2F%2F&btn1=%E5%9C%A8%E7%BA%BF%E5%92%A8%E8%AF%A2&aty=1&a=1003&key=%5B%3EWfTa%005%054%05j%0B%3BR%3B%07g%03%3C%06%3C%05bVfV0%5C%3F%0Aa_2%0D%3C%050"></script>
                                </td>
                                <%-- <td style="color: White; font-size: 10pt; font-weight: bold;" align="center">
                                    <script type="text/javascript" src="http://static.b.qq.com/account/bizqq/js/wpa.js?wty=1&type=2&kfuin=800059000&ws=http%3A%2F%2F&btn1=%E5%9C%A8%E7%BA%BF%E5%92%A8%E8%AF%A2&aty=1&a=1003&key=%5B%3EWfTa%005%054%05j%0B%3BR%3B%07g%03%3C%06%3C%05bVfV0%5C%3F%0Aa_2%0D%3C%050"></script>
                                    &nbsp;&nbsp;电话：028-85533312&nbsp;&nbsp;&nbsp;邮编：610041
                                        <br />
                                    四川省住房和城乡建设厅信息中心&nbsp;&nbsp;&nbsp;地址：成都市人民南路四段36号
                                </td>--%>
                            </tr>
                        </table>
