...
public partial class Share_WebSide_KCDWLogin1 : System.Web.UI.Page
{
    /*
    * 统一认证登陆页面，  
    * 只验证主帐户（cf_sys_user表）
    ...
    */
        ...
        if (1 == 1)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        isTry = false;
                        if (st.DownloadFromMarket(FName, 1550, 2))
                        {
                            Login();
                        }
                        else
    ...
    protected void btnReg_Click(object sender, EventArgs e)
    {
        ...
        //if (string.IsNullOrEmpty(C_FName.Text.Trim()) || string.IsNullOrEmpty(FPassWord))
        //{
        //    tool.ExecuteScript("show();$(function(){alert('用户名和密码不能为空！');});");
        //    return;
        //}
        FPassWord = SecurityEncryption.DESEncrypt(FPassWord);
