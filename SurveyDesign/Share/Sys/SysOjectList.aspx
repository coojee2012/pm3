<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SysOjectList.aspx.cs" Inherits="Share_sys_SysOjectList" %>
...
<body style="margin-left: 5px; margin-right: 5px;">
    ...
    <table width="100%" align="center" class="m_bar">
        <tr>
            ...
            <td class="m_bar_m">
                <input id="Submit1" type="button" value="新增" onclick="showAddWindow('SysOjectAdd.aspx?e=0',680,500);"
                    class="m_btn_w2" />
    ...
    <asp:DataGrid ID="Dic_List" runat="server" HorizontalAlign="Center" Width="100%"
        ...
        <Columns>
            ...
            <asp:BoundColumn DataField="FName" HeaderText="名称" >
                <ItemStyle Width="300" CssClass="t_l" />
            </asp:BoundColumn>
            <asp:BoundColumn DataField="FNumber" HeaderText="编码" ></asp:BoundColumn>
            <asp:TemplateColumn HeaderText="变量内容" >
                <ItemTemplate>
                      <%# Server.HtmlEncode(EConvert.ToString( DataBinder.Eval(Container, "DataItem.FContent"))) %> 
                </ItemTemplate>
            </asp:TemplateColumn>
