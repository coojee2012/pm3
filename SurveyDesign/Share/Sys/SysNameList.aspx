<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SysNameList.aspx.cs" Inherits="Share_Sys_SysNameList" %>
...
<body>
    ...
    <table width="98%" align="center" class="m_bar">
        <tr>
            ...
            <td class="m_bar_m">
                <input id="Submit1" type="button" value="新增" onclick="showAddWindow('SysNameAdd.aspx?',500,500);"
                    class="m_btn_w2" />
    ...
    <asp:DataGrid ID="DG_List" runat="server" HorizontalAlign="Center" Width="98%" CssClass="m_dg1"
        ...
        <Columns>
            ...
            <asp:TemplateColumn HeaderText="系统名称">
                <ItemStyle CssClass="t_l" />
                <ItemTemplate>
                    <a href="javascript:showAddWindow('SysNameAdd.aspx?FID=<%#Eval("FID") %>',500,500)">
                        <%#Eval("FName") %></a>
                </ItemTemplate>
            </asp:TemplateColumn>
            <asp:BoundColumn DataField="FNumber" HeaderText="系统编号"></asp:BoundColumn>
            <asp:BoundColumn DataField="FType" HeaderText="系统类型"></asp:BoundColumn>
            <asp:BoundColumn DataField="FDesc" HeaderText="备注">
                <ItemStyle CssClass="t_l" />
            </asp:BoundColumn>
