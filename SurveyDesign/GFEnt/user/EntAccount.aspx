    ...
    <form id="form1" runat="server">
        ...
        <table width="98%" align="center" class="m_bar">
            <tr>
                ...
                <td class="m_bar_m">
                    ...
                    <asp:Button ID="btnDel" Enabled="false" runat="server" CssClass="m_btn_w2" OnClick="btnDel_Click"
                        Text="删除" />
        ...
        <asp:DataGrid ID="DG_List" runat="server" HorizontalAlign="Center" Width="98%" CssClass="m_dg1"
            ...
            <Columns>
                ...
                <asp:BoundColumn DataField="FRESON" HeaderText="工法名称"></asp:BoundColumn>
