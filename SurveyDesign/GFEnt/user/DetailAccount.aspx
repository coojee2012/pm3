<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DetailAccount.aspx.cs" Inherits="GFEnt_user_DetailAccount" %>
    ...
    <form id="form1" runat="server">
        ...
        <table width="98%" align="center" class="m_bar">
            <tr>
                <td class="m_bar_l"></td>
                <td class="m_bar_m">
                    <input id="Submit1" type="button" value="新增" onclick="refresh('AddDetailEntUser.aspx?type=1');"
                        class="m_btn_w2" />
