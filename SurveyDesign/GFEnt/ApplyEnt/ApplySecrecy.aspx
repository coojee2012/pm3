<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ApplySecrecy.aspx.cs" Inherits="GFEnt_ApplyEnt_ApplySecrecy" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <table class="m_table" width="98%" align="center">
            <tr>
                <td class="t_r t_bg">关键技术及保密点
                </td>
                <td style="height: 400px; width: 90%">
                    <asp:TextBox ID="t_GJJSJBMD" runat="server" CssClass="m_txt" Width="100%" Height="400px" TextMode="MultiLine"></asp:TextBox>
