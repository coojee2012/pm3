<%@ Page Language="C#" AutoEventWireup="true" CodeFile="addTechnology.aspx.cs" Inherits="GFEnt_ApplyEnt_addTechnology" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        function getFilUp(url) {
            ...
            showAddWindow(url + "?FAppId=" + fid + "&type=1006", 550, 400);
        }
    </script>
</head>
<body>
    <form id="form1" runat="server">
        ...
        <table class="m_table" width="98%" align="center">
            <tr>
                <td class="t_r t_bg">工法关键技术名称：
                </td>
                <td colspan="3">
                    <asp:TextBox ID="t_JSMC" Width="350px" runat="server" CssClass="m_txt"></asp:TextBox>

                </td>
            </tr>
            <tr>
                <td class="t_r t_bg">评估单位：
                </td>
                <td>
                    <asp:TextBox ID="t_SDDW" Width="150px" runat="server" CssClass="m_txt"></asp:TextBox>

                </td>
                <td class="t_r t_bg">评估时间：
                </td>
                <td style="width: 200px;">
                    <asp:TextBox ID="t_SDSJ" runat="server" Width="150px" onfocus="WdatePicker()" CssClass="m_txt"></asp:TextBox>

                </td>
            </tr>
            <tr>
                <td class="t_r t_bg">关键技术评估意见
                </td>
                <td colspan="3">
            ...
            <tr>
                ...
                <td colspan="3">
                    <asp:TextBox ID="t_BZ" Width="350px" runat="server" CssClass="m_txt" Height="100px" TextMode="MultiLine"></asp:TextBox>
        ...
        <input id="t_JSID" runat="server" type="hidden" />
    </form>
</body>
</html>
