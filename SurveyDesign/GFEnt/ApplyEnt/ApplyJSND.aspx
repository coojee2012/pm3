<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ApplyJSND.aspx.cs" Inherits="GFEnt_ApplyEnt_ApplyJSND" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <table class="m_table" width="98%" align="center">
            <tr>
                <td class="t_r t_bg">技术水平和技术难度
                </td>
                <td style="height: 400px; width: 88%">
                    <asp:TextBox ID="t_JSSPHJSND" runat="server" CssClass="m_txt" Width="100%" Height="400px" TextMode="MultiLine"></asp:TextBox>
