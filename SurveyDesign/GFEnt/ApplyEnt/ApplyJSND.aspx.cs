...
public partial class GFEnt_ApplyEnt_ApplyJSND : System.Web.UI.Page
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        {
            sql = "update YW_GF_JS set JSSPHJSND='" + t_JSSPHJSND.Text + "',FTime=getdate() where FID='" + t_FID.Value + "'";
        }
        else
        {
            t_FID.Value = Guid.NewGuid().ToString();
            sql = string.Format(@"insert YW_GF_JS (FID,JSSPHJSND,FBaseInfoId,FSystemId,FCreateTime,FIsDeleted,FTime)
                    values ('" + t_FID.Value + "','" + t_JSSPHJSND.Text + "','" + t_FBaseInfoId.Value + "','"
    ...
    {
        btnSave.Enabled = false; t_JSSPHJSND.Enabled = false;
    }
}