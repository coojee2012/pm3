<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ApplyPatent.aspx.cs" Inherits="GFEnt_ApplyEnt_ApplyPatent" %>
    ...
    <form id="form1" runat="server">
        ...
        <table width="98%" align="center" class="m_bar">
            <tr>
                ...
                <td class="t_r" style="padding-right: 10px;">
                    <input id="Submit1" type="button" value="新增" onclick="showAddWindow('addPatent.aspx?', 550, 450);"
        ...
        <asp:DataGrid ID="DG_List" runat="server" HorizontalAlign="Center" Width="98%" CssClass="m_dg1"
            ...
            <Columns>
                ...
                <asp:BoundColumn DataField="ZLMC" HeaderText="专利名称" HeaderStyle-Width="300px">
                    <ItemStyle HorizontalAlign="Left" />
                </asp:BoundColumn>
                <asp:BoundColumn DataField="ZLH" HeaderText="专利号" HeaderStyle-Width="100px">
                    <ItemStyle CssClass="t_l" Wrap="false" />
                </asp:BoundColumn>
                <asp:BoundColumn DataField="ZLQR" HeaderText="专利权人" HeaderStyle-Width="90px">
                    <ItemStyle HorizontalAlign="Left" />
                </asp:BoundColumn>
