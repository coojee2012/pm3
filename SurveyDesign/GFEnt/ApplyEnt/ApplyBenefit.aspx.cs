...
public partial class GFEnt_ApplyEnt_ApplyBenefit : System.Web.UI.Page
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        {
            sql = "update YW_GF_JS set JJXYHSHXY='" + t_JJXYHSHXY.Text + "',FTime=getdate() where FID='" + t_FID.Value + "'";
        }
        else
        {
            t_FID.Value = Guid.NewGuid().ToString();
            sql = string.Format(@"insert YW_GF_JS (FID,JJXYHSHXY,FBaseInfoId,FSystemId,FCreateTime,FIsDeleted,FTime)
                    values ('" + t_FID.Value + "','" + t_JJXYHSHXY.Text + "','" + t_FBaseInfoId.Value + "','"
    ...
    {
        btnSave.Enabled = false; t_JJXYHSHXY.Enabled = false;
    }
