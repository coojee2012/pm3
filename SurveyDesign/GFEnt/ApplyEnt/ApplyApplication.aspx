<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ApplyApplication.aspx.cs" Inherits="GFEnt_ApplyEnt_ApplyApplication" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <table class="m_table" width="98%" align="center">
            <tr>
                <td class="t_r t_bg">应用情况及应用前景
                </td>
                <td style="height: 400px; width: 88%">
                    <asp:TextBox ID="t_GFYYQKJYYQJ" runat="server" CssClass="m_txt" Width="100%" Height="400px" TextMode="MultiLine"></asp:TextBox>
