<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AnPaiInfoList.aspx.cs" Inherits="KC_AppMain_PersonInfoList" %>
                ...
                <div style="width: 98%; margin: 0 auto;">
                    ...
                    <asp:GridView ID="DG_List" runat="server" CssClass="m_dg1" Width="100%" HorizontalAlign="Center"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField HeaderText="正在审查项目" DataField="FCount"></asp:BoundField>
                        </Columns>
                    </asp:GridView>
