<%@ Page Language="C#" AutoEventWireup="true" CodeFile="XMJZBGlist.aspx.cs" Inherits="JZDW_AppMain_XMJZBGlist" %>
        ...
        <tr>
            ...
            <td class="wxts_m" valign="top">
                    ...
                    <tr>
                        <td height="27" class="txt23" style="padding-left: 50px; margin-top: 6px;">
                            ...
                            &nbsp; 办理状态：<asp:DropDownList ID="ddlFState" runat="server">
                                ...
                                <asp:ListItem Value="2">打回</asp:ListItem>
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="操作">
                                ...
                                <ItemTemplate>
                                    ...
                                    <asp:LinkButton ID="btnBack" CommandName="Back" runat="server" Visible="false" Style="margin-left: 6px;
                ...
                <div style="width: 98%; margin: 4px auto;">
                    <tt>提示：未办理时点击“现在办理”办项目见证报告备案。</tt>
                </div>
            </td>
            <td class="wxts_r">
            </td>
