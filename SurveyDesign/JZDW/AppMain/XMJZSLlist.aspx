<%@ Page Language="C#" AutoEventWireup="true" CodeFile="XMJZSLlist.aspx.cs" Inherits="JZDW_AppMain_XMJZSLlist" %>
                ...
                <div style="width: 98%; margin: 0 auto;">
                    <asp:GridView ID="DG_List" runat="server" CssClass="m_dg1" Width="100%" HorizontalAlign="Center"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField HeaderText="提交见证时间" DataField="FReportDate" DataFormatString="{0:d}">
