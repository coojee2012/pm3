<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Baseinfo3.aspx.cs" Inherits="JZDW_Main_Baseinfo3" %>
...
<body>
    ...
    <table width="98%" align="center" class="m_bar">
        <tr>
            ...
            <td class="t_r">
                <asp:Button ID="btnsel" runat="server" Text="查询" CssClass="m_btn_w2" OnClick="btnsel_Click" />
            </td>
            <td class="m_bar_r">
            </td>
        </tr>
