                    ...
                    <asp:DataGrid ID="App_List" runat="server" AutoGenerateColumns="False" CssClass="m_dg1"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateColumn HeaderText="工程名称">
                                ...
                                <ItemTemplate>
                                    <asp:Literal ID="lit_TS" runat="server"></asp:Literal>
                                    <a id="a_PrjName" runat="server" href=''>
                                        <%#Eval("FPrjName")%>
                                    </a>
                            ...
                            <asp:TemplateColumn HeaderText="业务名称">
                                <ItemStyle CssClass="t_l" Wrap="false" />
                                <ItemTemplate>
                                    <asp:LinkButton ID="btnItemSee" CommandArgument='<%#Eval("FCmd")%>' runat="server"
                                        Text='<%#Eval("FName") %>' CommandName="See">
                            ...
                            <asp:TemplateColumn HeaderText="操作" Visible="false">
                                ...
                                <ItemTemplate>
                                    ...
                                    <asp:HiddenField ID="hfFLinkId" Value='<%#Eval("FLinkId")%>' runat="server" />
                                </ItemTemplate>
                            </asp:TemplateColumn>
                            <asp:BoundColumn DataField="FId" Visible="False"></asp:BoundColumn>
                        </Columns>
