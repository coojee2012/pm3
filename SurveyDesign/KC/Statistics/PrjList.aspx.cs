...
public partial class KcsjSgt_Statistics_PrjList : System.Web.UI.Page
{
    ...
    private void showInfo()
    {
        ...
        //确认过的项目
        var v = (from t in db.CF_App_List.Where(a => a.FToBaseinfoId == FBaseinfoId && a.FState > 1 && (a.FManageTypeId == 280))
                 ...
                 select new
                 {
                     ...
                     //项目勘察合同备案
                     a = (from a in g
                          where a.FPrjId == g.Key && a.FManageTypeId == 280
                          && a.FCreateTime == g.Where(g3 => g3.FManageTypeId == 280).Min(g3 => g3.FCreateTime)
