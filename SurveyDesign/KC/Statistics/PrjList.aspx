<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PrjList.aspx.cs" Inherits="KcsjSgt_Statistics_PrjList" %>
            ...
            <td class=" wxts_m">
                ...
                <asp:DataGrid ID="DG_List" runat="server" AutoGenerateColumns="False" CssClass="m_dg1"
                    ...
                    <Columns>
                        ...
                        <asp:ButtonColumn HeaderText="提交合同备案时间"></asp:ButtonColumn>
                        <asp:ButtonColumn HeaderText="受理结果"></asp:ButtonColumn>
                        <asp:TemplateColumn HeaderText="项目办理状态">
                            <ItemTemplate>
                                <a href='javascript:showAddWindow("../Statistics/all.aspx?FID=<%#Eval("FID") %>",800,700);'>
                                    查看详情</a>
                            </ItemTemplate>
                        </asp:TemplateColumn>
