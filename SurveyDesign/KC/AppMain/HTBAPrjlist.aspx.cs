...
public partial class KC_AppMain_HTBAPrjlist : System.Web.UI.Page
{
    ...
    private void showToDo()
    {
        ...
        var v = (from d in db.CF_Prj_Data
                 ...
                 where d.FIsDeleted == false && (a.FManageTypeId == fMType) && a.FIsDeleted == false
                    && ((db.CF_Prj_Ent.Count(t => t.FAppId == a.FId && (t.FEntType == 15501 || t.FEntType == 15502) && t.FBaseInfoId == FBaseinfoID) > 0))
