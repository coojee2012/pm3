<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AppInfoPrj2.aspx.cs" Inherits="KC_appmain_AppInfoPrj" %>
...
<body>
    ...
    <table width="98%" align="center" class="m_title">
        <tr>
            <th colspan="4">
                工程项目列表（<asp:Label ID="lTitle" runat="server" ForeColor="Red"></asp:Label>）
            </th>
        </tr>
        <tr>
    ...
    <asp:DataGrid ID="dg_List" runat="server" AutoGenerateColumns="False" CssClass="m_dg1"
        ...
        <Columns>
            ...
            <asp:BoundColumn DataField="FMoney" HeaderText="合同金额(万元)">
                <ItemStyle CssClass="t_r" Wrap="false" />
            </asp:BoundColumn>
        </Columns>
    </asp:DataGrid>
