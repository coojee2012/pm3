...
public partial class KC_AppMain_KCWTSLlist : System.Web.UI.Page
{
    ...
    private void showInfo()
    {
        ...
        var v = from t in db.CF_App_List
                ...
                where t.FToBaseinfoId == FBaseinfoID && t.FState >= 1 && t.FManageTypeId == 280
                ...
                select new
                {
                    ...
                    t.FPrjId,
                    d.FPrjName,
                    d.FPriItemId,//审查不合格业务的CF_Prj_Data.FID
                    t.FName,
                    t.FCount,
                    t.FCreateTime,
                    t.FState,
    ...
    protected void DG_List_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            //状态办理结果
            string s = "";
            string o = "<a href='javascript:showAddWindow(\"../ApplyKCXMWT/Report.aspx?FAppId=" + FID + "\",700,580);'>";
            string t = "";
            switch (FState)
            {
                case "1":
                ...
                case "6":
                    ...
                    o += "查看详情";
                    t += "<a href='" + ReportServer + "SLD-KCWT.cpt&FAppId=" + FID + "' target='_blank'>打印合同确认单</a>";
                    break;
                case "7":
            ...
            if (app != null)
            {
                ...
                {
                    s += "</br><font color='red'>（见证单位不予接受，业务终止）</font>";
                }
            }
