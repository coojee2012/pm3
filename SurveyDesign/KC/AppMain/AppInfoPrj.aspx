<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AppInfoPrj.aspx.cs" Inherits="KC_appmain_AppInfoPrj" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function doShow(fid) {
            showAddWindow("../ApplyKCXMWT/ApplyBaseInfo.aspx?FDataID=" + fid, 800, 700);
        }
    </script>
...
<body>
    ...
    <table width="98%" align="center" class="m_title">
        <tr>
            <th colspan="4">
                业务办理情况（<asp:Label ID="lTitle" runat="server" ForeColor="Red"></asp:Label>）
            </th>
        </tr>
        <tr>
    ...
    <asp:DataGrid ID="dg_List" runat="server" AutoGenerateColumns="False" CssClass="m_dg1"
        ...
        <Columns>
            ...
            <asp:TemplateColumn HeaderText="工程名称">
                ...
                <ItemTemplate>
                    <a href="javascript:doShow('<%#Eval("FLinkId") %>');">
                        <%#Eval("FPrjName")%>
                    </a>
                    <asp:Literal ID="lit_Count" runat="server"></asp:Literal>
                </ItemTemplate>
            </asp:TemplateColumn>
            <asp:BoundColumn DataField="MType" HeaderText="业务类型">
                <ItemStyle CssClass="t_c" Wrap="false" />
            </asp:BoundColumn>
            <asp:BoundColumn DataField="FJSEnt" HeaderText="建设单位"></asp:BoundColumn>
            <asp:BoundColumn DataField="FAppDate" HeaderText="办理时间" DataFormatString="{0:yyyy-MM-dd}">
            </asp:BoundColumn>
            <asp:BoundColumn DataField="FState" HeaderText="办理结果"></asp:BoundColumn>
        </Columns>
    </asp:DataGrid>
    <asp:DataGrid ID="dg_List2" runat="server" AutoGenerateColumns="False" CssClass="m_dg1"
        ...
        <Columns>
            ...
            <asp:TemplateColumn HeaderText="工程名称">
                <ItemStyle CssClass="t_l" Wrap="false" />
                <ItemTemplate>
                    <a href="javascript:doShow('<%#Eval("FLinkId") %>','<%#Eval("FUrl") %>');">
                        <%#Eval("FPrjName")%>
                    </a>
                    <asp:Literal ID="lit_Count" runat="server"></asp:Literal>
                </ItemTemplate>
            ...
            <asp:BoundColumn DataField="FJSEnt" HeaderText="建设单位"></asp:BoundColumn>
            <asp:BoundColumn DataField="FResult" HeaderText="编号"></asp:BoundColumn>
            <asp:BoundColumn DataField="FToBaseInfoId" HeaderText="打印时间"></asp:BoundColumn>
        </Columns>
    </asp:DataGrid>
