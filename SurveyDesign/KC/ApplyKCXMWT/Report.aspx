    ...
    <script type="text/javascript">
        ...
        function checkInfo() {
            ...
            if ($("#t_FInt1").val() == "6") {
                ...
                if (!getLength(document.getElementById("t_FTxt15"), 50, '“原因”')) {
                    return false;
                }
            }
        }
...
<body>
    ...
    <table id="tab_6" class="m_table" width="98%" align="center">
        ...
        <tr>
            ...
            <td colspan="1" class="m_txt_M" width="20%">
                <asp:TextBox ID="t_FTxt12" runat="server" CssClass="m_txt" Width="100px" MaxLength="10"></asp:TextBox>
                <tt>*</tt>
            </td>
            <td class="t_r t_bg">
                办理时间：
        ...
        <tr>
            ...
            <td colspan="3" class="m_txt_M">
                <asp:TextBox ID="t_FTxt19" runat="server" CssClass="m_txt" Width="400px" MaxLength="50"
    ...
    <table id="tab_2" class="m_table" width="98%" align="center">
        ...
        <tr>
            ...
            <td colspan="3" class="m_txt_M">
                <asp:TextBox ID="t_FDate7" runat="server" CssClass="m_txt" Width="100px" Enabled="false"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="t_r t_bg" width="20%">
    ...
    <table id="tab_7" class="m_table" width="98%" align="center">
        ...
        <tr>
            ...
            <td colspan="3" class="m_txt_M">
                <asp:TextBox ID="t_FDate8" runat="server" CssClass="m_txt" Width="100px" Enabled="false"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="t_r t_bg" width="20%">
            ...
            <td class="m_txt_M">
                <asp:TextBox ID="t_FTxt15" runat="server" CssClass="m_txt" Width="320px" MaxLength="50"
                    TextMode="MultiLine" Height="60"></asp:TextBox>
                <tt>* 50字。</tt>
            </td>
        </tr>
