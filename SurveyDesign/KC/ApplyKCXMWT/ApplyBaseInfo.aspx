...
<body>
    ...
    <table class="m_table" width="98%" align="center">
        ...
        <tr id="isUnite">
            ...
            <td colspan="3">
                <asp:CheckBox runat="server" ID="t_FInt3" />
            </td>
        </tr>
        <tr class="t_l t_bg" id="trKc" style="display: none;">
    ...
    <table runat="server" id="kcOther" class="m_table" width="98%" align="center" style="display: none;">
        <tr>
            <td class="t_l t_bg">
                其他勘察单位列表
            </td>
        ...
        <tr>
            <td align="center" style="padding: 2px;">
                <table class="m_table" width="100%" style="margin: 0px;">
                    <tr class="t_c t_bg">
                        <td>
                            序号
                        </td>
                    ...
                    <asp:Repeater runat="server" ID="repeaperDis" OnItemDataBound="repeaperDis_ItemDataBound">
                        <ItemTemplate>
                            <tr>
                                <td class="t_c">
