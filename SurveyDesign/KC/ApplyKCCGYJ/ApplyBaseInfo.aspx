...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function checkInfo() {
            ...
            if (!getLength(document.getElementById("d_FTxt21"), 100, '“勘察结论”')) {
                return false;
            }
        }
        function seePrj() {
            var fid = $('#FDataID').val();
            showAddWindow('../ApplyKCXMWT/ApplyBaseInfo.aspx?FDataID=' + fid, 900, 700);
        }    
    </script>
        ...
        <tr>
            ...
            <td class="t_r" style="padding-right: 10px;">
                <asp:Button ID="btnSave" runat="server" Text="保存" OnClick="btnSave_Click" class="m_btn_w4"
                    OnClientClick="return AutoCheckInfo();" />
                <asp:Button ID="btnReport" runat="server" Text="提交" OnClientClick="if(AutoCheckInfo()){return confirm('确定要提交吗，提交后将不所修改。');}else return false;"
    ...
    <table class="m_table" width="98%" align="center">
        <tr>
            ...
            <td colspan="3">
                ...
                <input type="hidden" id="FDataID" runat="server" />
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="e_FName" runat="server" CssClass="m_txt" ReadOnly="true" Width="200px"></asp:TextBox>
            </td>
            <td class="t_r t_bg">
                受理合同备案时间：
            </td>
        ...
        <tr>
            <td class="t_r t_bg" style="width: 120px;">
                计划开始时间：
            </td>
            <td>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="d_FDate3" runat="server" CssClass="m_txt" Width="90" onfocus="WdatePicker()"></asp:TextBox>
                <tt>*</tt>
            </td>
            <td class="t_r t_bg">
                实际结束时间：
        ...
        <tr>
            ...
            <td colspan="3">
                <asp:TextBox ID="d_FTxt9" runat="server" CssClass="m_txt" MaxLength="25" Width="250px"></asp:TextBox>
                <tt>*</tt>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="d_FTxt7" runat="server" CssClass="m_txt" Width="90" MaxLength="10"></asp:TextBox>
                <tt>*</tt>
            </td>
            <td class="t_r t_bg">
                办理时间：
