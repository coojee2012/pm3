...
public partial class KC_Main_zWXTS : System.Web.UI.Page
{
    ...
    protected void App_List_ItemDataBound(object sender, DataGridItemEventArgs e)
    {
        if (e.Item.ItemIndex > -1)
        {
            ...
            {
                Literal prj_Count = e.Item.FindControl("prj_Count") as Literal;
                if (prj_Count != null)
                {
                    prj_Count.Text = ("<br/>(第" + prjBG.FCount + "次变更：" + EConvert.ToShortDateString(prjBG.FBGTime) + ")");
                }
            }
            //状态
            string s = "", r = "";
            ...
            //如果不是备案业务
            if (FManageTypeId != "283" && FManageTypeId != "411" && FManageTypeId != "421")
            {
                ...
                {
                    case "280"://勘察项目合同备案
                        sUrl = "showAddWindow(\"../ApplyKCXMWT/Report.aspx?FAppId=" + FID + "\",700,580);";
                        break;
                    case "284"://勘察成果移交
                        sUrl = "showAddWindow(\"../ApplyKCCGYJ/ApplyBaseInfo.aspx?FAppId=" + FID + "\",700,700);";
                        break;
                }
            ...
            else if (FManageTypeId == "411" || FManageTypeId == "421")
            {
                //工程名称
            ...
            if (FManageTypeId == "283")//勘察信息备案
            {
                int FIsDeleted = EConvert.ToInt(DataBinder.Eval(e.Item.DataItem, "FIsDeleted"));
                if (FIsDeleted == 1)
                {
                    ((Literal)e.Item.FindControl("lit_TS")).Text += "<img title=\"已重新办理，本业务失效”\" src=\"../../image/info.jpg\" style=\"cursor:pointer;\"/>";

                    e.Item.Attributes["style"] = "background:#EEEEEE;color:#999999;";
                }
            }
            else if (FManageTypeId == "28301")//勘察人员意见
            {
