...
public partial class Admin_main_aLeft : System.Web.UI.Page
{
    ...
    private void showInfo()
    {
        ...
        if (CurrentEntUser.FHUid != null && CurrentEntUser.FHUid != "")
        {
            ...
            this.YDW.Text = "<div class='o_menu'><a isBack='1' id='a155' class='o_m01_1' href='" + sUrl + "' target='_top'><span>返回原单位</span></a></div>";
            ...
            this.dv8.Visible = false;
            this.dv9.Visible = false;
        }
