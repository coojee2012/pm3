...
<body>
    ...
    <div id="diva_3" style="display: none">
        <asp:DataGrid ID="dg_List1" runat="server" AutoGenerateColumns="False" CssClass="m_dg1"
    ...
    <div id="diva_4" style="display: none">
        <asp:DataGrid ID="dg_List" runat="server" AutoGenerateColumns="False" CssClass="m_dg1"
            HorizontalAlign="Center" OnItemDataBound="App_List1_ItemDataBound" Style="margin-top: 3px;
            margin-bottom: 1px;" Width="98%">
            <HeaderStyle CssClass="m_dg1_h" />
            <ItemStyle CssClass="m_dg1_i" />
            <Columns>
