...
public partial class KC_ApplySGTSCYJHF_SgtScyjHfList : System.Web.UI.Page
{
    ...
    private void ShowInfo()
    {
        ...
        var v = from a in db.CF_App_List
                ...
                where a.FManageTypeId == 28803 && a.FState > 0
                   && aa.FManageTypeId == 280 && aa.FState == 6 && aa.FToBaseinfoId == FBaseinfoId
                select new
                {
                    d.FId,
                    d.FPrjName,
    ...
    protected void DG_List_ItemDataBound(object sender, DataGridItemEventArgs e)
    {
        if (e.Item.ItemIndex > -1)
        {
            ...
            e.Item.Cells[4].Text = "<a title=\"点击查看勘察文件审查" + nn + "\" href=\"" + ReportServer + p + "&FAppId=" + FAppId + "&FBaseId=" + SGTFBaseinfoId + "&FPrjId=" + FPrjId + "&PrjId=" + FPrjId + "\" target=\"_blank\">" + s + "</a>";
