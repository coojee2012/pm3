...
<head>
    ...
    <script type="text/javascript">
        ...
        function Upload() {
            var flinkid = $("#hdFLinkID").val();
            if (flinkid != null && flinkid != "") {
                var sUrl = "FileUpload.aspx?FTypeID=" + $("#hdFTypeID").val() + "&FLinkID=" + flinkid + "&p=<%=SecurityEncryption.DesEncrypt(Session["FUserId"]+"|" + SecurityEncryption.ConvertDateTimeInt(DateTime.Now.AddHours(1)),"12345687")%>" + "&rd=" + Math.random();
                var width = "410";
                var height = "180";
                    ...
                    <table style="width: 100%; height: 430px; margin-bottom: 5px;">
                        ...
                        <tr>
                                    ...
                                    <table style="width: 100%; border-left: 0px; border-top: 0px; border-right: 0px;" border="0">
                                        ...
                                        <tr>
                                            <td colspan="2" style="text-align: right; padding-bottom: 5px;">
                                                <input id="btnFileAdd" class="m_btn_w4" type="button" value="附件上传" onclick="Upload();" runat="server" />
                                            </td>
                                        </tr>
                                                        ...
                                                        <asp:Repeater runat="server" ID="rptFileList">
                                                            <ItemTemplate>
                                                                <tr name="trBody" id="<%#DataBinder.Eval(Container.DataItem,"FID")%>" onmouseover="fnOpenImg('<%#DataBinder.Eval(Container.DataItem,"FFileUrl")%>')">
                                                                    ...
                                                                    <td><a href="<%#DataBinder.Eval(Container.DataItem,"FFileUrl")%>" target="_blank"><%#DataBinder.Eval(Container.DataItem,"FFileName")%></a></td>
                            ...
                            <td align="center" style="border: solid 1px #97D9F3;">
                                <img id="imgPrivew" alt="" src="../../Images/No.jpg" border="0" width="400" height="400" />
                            </td>
                        </tr>
                    </table>
                </td>
