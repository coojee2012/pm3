<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FileUpload.aspx.cs" Inherits="WYDW_Common_FileUpload" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        function SelectFiles() {
            var width = 600;
            var height = 400;
            sUrl = 'ajaxfilemanager/filemanager.aspx?type=file&iseditor=1&p=<%=SecurityEncryption.DesEncrypt("../../|"+Session["FUserId"]+"|" + SecurityEncryption.ConvertDateTimeInt(DateTime.Now.AddHours(1)),"12345687")%>';
        ...
        <table align="center" class="m_table" style="width: 98%">
            ...
            <tr>
                ...
                <td style="padding: 4px; line-height: 28px;">
                    ...
                    <input type="hidden" id="t_FFileUrl" runat="server" />
