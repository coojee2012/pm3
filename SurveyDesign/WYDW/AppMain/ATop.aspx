<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ATop.aspx.cs" Inherits="WYDW_AppMain_ATop" %>
...
<body>
    <form id="form1" runat="server">
        <div class="top_back02">
            <div id="div_BG" runat="server" class="top_backimgWY">
                <div class="top_r">
                    <div class="top_menu" id="adminTd1" runat="server">
                        <div runat="server" id="BackMain">
