<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Report.aspx.cs" Inherits="WYDW_AppMain_Report" %>
        ...
        <div>
            ...
            <table class="m_table" width="98%" align="center">
                ...
                <tr>
                    ...
                    <td colspan="3">
                        <asp:TextBox ID="t_XMMC" runat="server" CssClass="m_txt" Width="250px" Enabled="false"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td colspan="3" class="auto-style1">
                        <asp:DropDownList ID="t_FUpDeptName" Width="250px" CssClass="m_txt" runat="server" Enabled="false">
                        </asp:DropDownList><label id="notices" runat="server"></label><label id="notice2" runat="server"></label>
                    </td>
                </tr>
                <tr>
