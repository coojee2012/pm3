<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LSXMList.aspx.cs" Inherits="WYDW_LSXM_LSXMList" %>
    ...
    <form id="form1" runat="server">
        ...
        <asp:DataGrid ID="dg_List" runat="server" AutoGenerateColumns="False" CssClass="m_dg1"
            ...
            <Columns>
                ...
                <asp:BoundColumn HeaderText="项目属地" DataField="XMSD">
                    <ItemStyle Wrap="false" />
                </asp:BoundColumn>
                <asp:BoundColumn DataField="JSDW" HeaderText="建设单位">
                    <ItemStyle Wrap="false" HorizontalAlign="Left" />
                </asp:BoundColumn>
                <asp:BoundColumn HeaderText="项目类型" DataField="XMLX">
                    <ItemStyle Wrap="false" />
                </asp:BoundColumn>
                <asp:BoundColumn HeaderText="失去原因" DataField="SQYY">
                    <ItemStyle Wrap="false" HorizontalAlign="Left" />
                </asp:BoundColumn>
                <asp:BoundColumn DataField="XMBH" Visible="False"></asp:BoundColumn>
                <asp:BoundColumn DataField="XMMC" Visible="False"></asp:BoundColumn>
