...
public partial class WYDW_ApplyLPB_Lz_edit : WYPage
{
    pageTool tool = null;
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        //保存楼幢信息
        string strsql_insertLZ = " insert into YW_WY_XM_LZXX (FAppID,BuildId,BuildName,ZTS,ZJZMJ,XMBH,FBaseInfoID,FID) VALUES('" + (string)Session["FAppId"] + "','";
        strsql_insertLZ += buildid + "','" + hidBuildName.Value.ToString().Trim() + "','" + hidZTS.Value.ToString() + "','" + hidZJZMJ.Value.ToString() + "','" + (string)Session["XMBH"] + "','" + CurrentEntUser.EntId + "','" + Guid.NewGuid() + "')";
        ...
        if (rc.PExcute(strsql_insertLZ))
        {
            ...
            {
                string strsql_insertHouse = " insert into YW_WY_XM_FWXX (FAppID,BuildId,HouseId,FID,ZH,FH,DY,RHC,SH,JZMJ) VALUES(";
