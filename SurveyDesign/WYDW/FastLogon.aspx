        ...
        <div>
            <ul>
                <li>UerID：<asp:RadioButtonList runat="server" ID="rblUsers" AutoPostBack="true" RepeatDirection="Horizontal" RepeatLayout="Flow" OnSelectedIndexChanged="rblUsers_SelectedIndexChanged">
                    ...
                    <asp:ListItem Value="ad67d397-ef4f-4573-83fc-5f09b93ad6b2">四川宏德建设有限公司（物业）</asp:ListItem>
                    <asp:ListItem Value="a3085b36-9781-4f26-92d6-57e4ac98388e">成都天投地产开发有限公司（物业）</asp:ListItem>
                    ...
                    <asp:ListItem Value="0F03B17B-33B5-4D22-9396-913E77BBBF32">孔祥东（省用户）</asp:ListItem>
