                                    ...
                                    <table width="100%" id="Table1" runat="server">
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: right">
                                                <input class="m_btn_w6" runat="server" type="button" id="btnImpRY" onclick="ShowAppPage('../Common/RYListCheck.aspx?T=2', 1000, 450);" value="导入项目人员" />
                                                <input class="m_btn_w2" runat="server" type="button" id="btnZGRY" onclick="ShowAppPage('RYQKInfo.aspx?T=1', 900, 640);" value="新增" />
