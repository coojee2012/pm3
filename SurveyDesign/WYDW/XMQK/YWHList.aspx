<%@ Page Language="C#" AutoEventWireup="true" CodeFile="YWHList.aspx.cs" Inherits="WYDW_XMQK_YWHList" %>
            ...
            <div id="divSetup2" runat="server">
                <asp:DataGrid ID="dg_List" runat="server" AutoGenerateColumns="False" CssClass="m_dg1"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateColumn HeaderText="业委会名称">
                            <ItemTemplate>
                                <asp:LinkButton ID="YZWYHMC" runat="server" CommandName="See" Text='<%#Eval("YZWYHMC")%>'>
                                </asp:LinkButton>
                            </ItemTemplate>
                            <ItemStyle CssClass="t_l" />
                        </asp:TemplateColumn>
                        <asp:BoundColumn DataField="YZWYHCLSJ" HeaderText="成立时间">
                            <ItemStyle CssClass="t_l" />
                        </asp:BoundColumn>
                        <asp:BoundColumn DataField="YZWYHBGDZ" HeaderText="业主委员会办公地址">
