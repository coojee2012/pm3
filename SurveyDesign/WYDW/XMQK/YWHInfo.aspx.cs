...
public partial class WYDW_XMQK_YWHInfo : WYPage
{
    ...
    private void showBAInfo()
    {
        ...
        string sql = "select * from WY_XM_YZWYHBA where XMBH='" + (string)Session["XMBH"] + "' ";
    ...
    {
        string sql = "select * from WY_XM_YZWYHCY where XMBH='" + (string)Session["XMBH"] + "' order by FCreateTime desc";
