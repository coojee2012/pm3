<%@ Page Language="C#" AutoEventWireup="true" CodeFile="KZXXInfo.aspx.cs" Inherits="WYDW_ApplyKZXX_KZXXInfo" %>
                ...
                <table class="m_table" width="98%" align="center">
                   <tr>
                    ...
                    <tr>
                        ...
                        <td width="25%">
                            <asp:TextBox ID="t_JCND" onblur="isInt(this)" runat="server" CssClass="m_txt" MaxLength="10" Width="80px"></asp:TextBox>
                        </td>
                        <td colspan="1" width="10%"></td>
                        <td width="15%" class="t_r t_bg">是否属于整治区改造旧住宅小区：
                        </td>
                        <td width="25%">
                            <asp:DropDownList ID="t_IsZZXQ" runat="server" Width="80px" CssClass="m_txt">
                    ...
                    <tr>
                        ...
                        <td colspan="1">
                            <asp:TextBox ID="t_JMHS" onblur="isInt(this)" runat="server" CssClass="m_txt" MaxLength="10" Width="80px"></asp:TextBox>
                            <tt>*</tt>
                        </td>
                        <td colspan="1">户</td>
                        ...
                        <td colspan="1">
                            <asp:TextBox ID="t_FJMHS" onblur="isInt(this)" runat="server" CssClass="m_txt" MaxLength="10" Width="80px"></asp:TextBox>
                            <tt>*</tt>
                        </td>
                        <td colspan="1">户</td>
                    </tr>
                    <tr>
                        ...
                        <td colspan="1">
                            <asp:TextBox ID="t_JZRS" onblur="isInt(this)" runat="server" CssClass="m_txt" MaxLength="10" Width="80px"></asp:TextBox>
                            <tt>*</tt>
                        </td>
                        <td colspan="1">人</td>
                    </tr>
                    <tr>
                        ...
                        <td colspan="1">
                            <asp:TextBox ID="t_JGRQ" onfocus="WdatePicker()" runat="server" CssClass="m_txt"
                        ...
                        <td colspan="1">
                            <asp:TextBox ID="t_SCJGRQ" onfocus="WdatePicker()" runat="server" CssClass="m_txt"
                                MaxLength="20" Width="80px"></asp:TextBox><tt>*</tt>
                        </td>
                        <td colspan="1"></td>
                    </tr>
                    <tr>
                        ...
                        <td colspan="1">
                            <asp:TextBox ID="t_WYYFMJ" onblur="isFloat(this)" runat="server" CssClass="m_txt" MaxLength="10" Width="80px"></asp:TextBox>
                            <tt>*</tt>
                        </td>
                    ...
                    <tr>
                        ...
                        <td colspan="1">
                            <asp:TextBox ID="t_DC_MJ" onblur="isFloat(this)" runat="server" CssClass="m_txt" MaxLength="10" Width="80px"></asp:TextBox>
                        </td>
                        <td colspan="1">万平方米</td>
                    ...
                    <tr>
                        ...
                        <td colspan="1">
                            <asp:DropDownList ID="t_AFXT" runat="server" Width="80px" CssClass="m_txt">
                                <asp:ListItem Selected="True" Value="-1">--请选择--</asp:ListItem>
                                <asp:ListItem Value="1">是</asp:ListItem>
                                <asp:ListItem Value="0">否</asp:ListItem>
                            </asp:DropDownList>
                    ...
                    <tr>
                        ...
                        <td colspan="1">
                            <asp:TextBox ID="t_CRKGS" onblur="isInt(this)" runat="server" CssClass="m_txt"
                                MaxLength="20" Width="80px"></asp:TextBox>
                        </td>
                        <td colspan="1">个</td>
                        ...
                        <td colspan="1">
                            <asp:TextBox ID="t_JKXFSGS" onblur="isInt(this)" runat="server" CssClass="m_txt" MaxLength="10" Width="80px"></asp:TextBox>
                        </td>
                        <td colspan="1">个</td>
                    </tr>
                    <tr>
                        ...
                        <td colspan="1">
                            <asp:TextBox ID="t_DTGS" onblur="isInt(this)" runat="server" CssClass="m_txt"
                                MaxLength="20" Width="80px"></asp:TextBox>
                        </td>
                        <td colspan="1">部</td>
                        ...
                        <td colspan="1">
                            <asp:TextBox ID="t_PDFS" onblur="isInt(this)" runat="server" CssClass="m_txt" MaxLength="10" Width="80px"></asp:TextBox>
                        </td>
                        <td colspan="1">KVA</td>
                    </tr>
                    <tr>
                        ...
                        <td colspan="1">
                            <asp:TextBox ID="t_FDJS" onblur="isInt(this)" runat="server" CssClass="m_txt"
                                MaxLength="20" Width="80px"></asp:TextBox>
                        </td>
                        <td colspan="1">KVA</td>
                        ...
                        <td colspan="1">
                            <asp:TextBox ID="t_YGGDH" onblur="isInt(this)" runat="server" CssClass="m_txt" MaxLength="10" Width="80px"></asp:TextBox>
                        </td>
                        <td colspan="1">度</td>
                    </tr>
                    <tr>
                        ...
                        <td colspan="1">
                            <asp:TextBox ID="t_DJBPGS" onblur="isInt(this)" runat="server" CssClass="m_txt"
                                MaxLength="20" Width="80px"></asp:TextBox>
                        </td>
                        <td colspan="1">KVA</td>
                        ...
                        <td colspan="1">
                            <asp:TextBox ID="t_ECGSSXS" onblur="isInt(this)" runat="server" CssClass="m_txt" MaxLength="10" Width="80px"></asp:TextBox>
                        </td>
                        <td colspan="1">立方米</td>
                    </tr>
                    <tr>
                        ...
                        <td colspan="1">
                            <asp:TextBox ID="t_HFCS" onblur="isInt(this)" runat="server" CssClass="m_txt"
                                MaxLength="20" Width="80px"></asp:TextBox>
                        </td>
                        <td colspan="1">立方米</td>
                        ...
                        <td colspan="1">
                            <asp:TextBox ID="t_YGGSH" onblur="isInt(this)" runat="server" CssClass="m_txt" MaxLength="10" Width="80px"></asp:TextBox>
                        </td>
                        <td colspan="1">立方米</td>
                    </tr>
                    <tr>
                        ...
                        <td colspan="1">
                            <asp:TextBox ID="t_MJJKXTTS" onblur="isInt(this)" runat="server" CssClass="m_txt"
                                MaxLength="20" Width="80px"></asp:TextBox>
                        </td>
                        <td colspan="1">套</td>
                        ...
                        <td colspan="1">
                            <asp:TextBox ID="t_XFXTTS" onblur="isInt(this)" runat="server" CssClass="m_txt" MaxLength="10" Width="80px"></asp:TextBox>
                        </td>
                        <td colspan="1">套</td>
                    </tr>
                    <tr>
                        ...
                        <td colspan="1">
                            <asp:TextBox ID="t_TCGLXTTS" onblur="isInt(this)" runat="server" CssClass="m_txt"
                                MaxLength="20" Width="80px"></asp:TextBox>
                        </td>
                        <td colspan="1">套</td>
                        ...
                        <td colspan="1">
                            <asp:TextBox ID="t_SJMJ" onblur="isFloat(this)" runat="server" CssClass="m_txt" MaxLength="10" Width="80px"></asp:TextBox>
                        </td>
                        <td colspan="1">平方米</td>
                    </tr>
                    <tr>
