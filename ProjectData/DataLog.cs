...
namespace ProjectData
{
    public class DataLog
    {
                ...
                if (HttpContext.Current != null)
                {
                    ...
                    if (req != null)
                    {
                        ...
                        if (HttpContext.Current.Session != null)
                        {
                            ...
                            {
                                Operator = EConvert.ToString(HttpContext.Current.Session["FUserId"]);
                                Desc += "FUserId：" + Operator + ",";
                            }
                            if (EConvert.ToString(HttpContext.Current.Session["DeptUserId"]) != "")
                            {
                                Operator = EConvert.ToString(HttpContext.Current.Session["DeptUserId"]);
                                Desc += "CurrentDeptUser.DeptUserId：" + Operator + ",";
                            }
                            if (EConvert.ToString(HttpContext.Current.Session["AdminUserId"]) != "")
                            {
                                Operator = EConvert.ToString(HttpContext.Current.Session["AdminUserId"]);
        ...
        public static void Write(LogType lt, LogSort Operation, string Title, string Description, string Operator)//写日志
        {
            try
            {
                ProjectDB pdb = new ProjectDB();
                ...
                if (HttpContext.Current != null)
                {
                    ...
                    if (req != null)
                    {
                        ...
                        if (HttpContext.Current.Session != null)
                        {
                            if (EConvert.ToString(HttpContext.Current.Session["DeptUserId"]) != "")
                            {
                                Desc += "CurrentDeptUser.DeptUserId：" + EConvert.ToString(HttpContext.Current.Session["DeptUserId"]);
                            }
                            if (EConvert.ToString(HttpContext.Current.Session["AdminUserId"]) != "")
                            {
                                Desc += "CurrentAdminUser.AdminUserId：" + EConvert.ToString(HttpContext.Current.Session["AdminUserId"]);
                            }
                            Desc = "\n " + Desc;
                        }
                        if (req.Browser != null)
