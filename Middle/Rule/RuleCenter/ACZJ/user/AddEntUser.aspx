<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddEntUser.aspx.cs" Inherits="GFEnt_user_AddEntUser" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function acountDetail(FID) {
            ...
            showAddWindow("DetailAccount.aspx?FId=" + FId, 800, 700);
        }

        //分配权限
        function fnFQQX() {
            var sUserC, sPERID;
            sUserC = document.all["t_FName"].value;
            sPERID = document.all["t_Fid"].value;
            if (sPERID == null || sPERID == "" || sPERID == undefined) {
                alert("请先保存企业基本信息!");
                return;
            }
            showAddWindow("UserQXFB.aspx?PERID=" + sPERID, 880, 700, sUserC);
            // OpenQueryWindow("XM_QXFP.aspx?PERID=" + sPERID, 750, 560, sUserC);
        }
    </script>
</head>
<body>
    <form id="form1" runat="server">
        ...
        <table width="98%" align="center" class="m_bar">
            <tr>
                ...
                <td class="m_bar_m t_r">
                    <asp:Button ID="btnSelectEnt" Visible="false" runat="server" CssClass="m_btn_w6" Text="从未发卡库选取" OnClientClick="if(!SelectEntFK(this)){return false;}"
                    ...
                    &nbsp;<asp:Button ID="btnPass" runat="server" CssClass="m_btn_w4" Text="初始化密码" OnClick="btnPass_Click" />
                    &nbsp;<input id="btnFPQX" style="display: none;" class="cBtn3" onclick="fnFQQX();" type="button" value="分配" />
                </td>
                <td class="m_bar_r"></td>
            </tr>
        </table>
        <table class="m_table" width="98%" align="center">
            ...
            <tr style="display: none;">
                ...
                <td>
                    <asp:TextBox ID="txtFPassWord" Width="150px" runat="server" CssClass="m_txt" ReadOnly="True"></asp:TextBox>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <asp:TextBox ID="t_FLockNumber" Width="150px" runat="server" CssClass="m_txt" ReadOnly="True"></asp:TextBox>
