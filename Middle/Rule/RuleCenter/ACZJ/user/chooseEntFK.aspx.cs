...
public partial class GFEnt_user_chooseEntFK : System.Web.UI.Page
{
    ...
    public void bindEnt()
    {
        string sql = string.Format(@"select u.* from LINKER_95.dbCenterSC.dbo.cf_sys_user u where isnull(u.FBaseInfoId,'')='' 
                            and not exists (select 1 from LINKER_95.dbCenterSC.dbo.CF_Sys_UserRight where FUserId=u.FID)");
