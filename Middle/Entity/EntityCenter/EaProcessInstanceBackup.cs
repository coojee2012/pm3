...
{ 
    [Serializable]
    public class EaProcessInstanceBackup : EEnterpriseBase
    {
        public EaProcessInstanceBackup()
            : base()
        {
            m_EntityType = EntityTypeEnum.EaProcessInstanceBackup;
        }

        public EaProcessInstanceBackup(IDictionary iDictionary)
            : base(iDictionary)
        {
            m_EntityType = EntityTypeEnum.EaProcessInstanceBackup;
        }
        ...
        public EaProcessInstanceBackup(DataRow dr)
            : base(dr)
        {
            m_EntityType = EntityTypeEnum.EaProcessInstanceBackup;
        }

        public EaProcessInstanceBackup(DataRow dr, IDictionary rel)
            : base(dr, rel)
        {
            m_EntityType = EntityTypeEnum.EaProcessInstanceBackup;
        }
        ...
        public int FIsPrime
        {
            get { return EConvert.ToInt(base.GetProperty("FIsPrime")); }
            set { base.SetProperty("FIsPrime", value); }
        }
